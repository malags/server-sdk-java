...
@JsonDeserialize(builder = CreateGoHighLevelCalendarEventCreateToolDto.Builder.class)
public final class CreateGoHighLevelCalendarEventCreateToolDto {
    private final Optional<List<CreateGoHighLevelCalendarEventCreateToolDtoMessagesItem>> messages;

    private final Optional<OpenAiFunction> function;

    private final Map<String, Object> additionalProperties;

    private CreateGoHighLevelCalendarEventCreateToolDto(
            Optional<List<CreateGoHighLevelCalendarEventCreateToolDtoMessagesItem>> messages,
    ...
    public Optional<List<CreateGoHighLevelCalendarEventCreateToolDtoMessagesItem>> getMessages() {
        return messages;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateGoHighLevelCalendarEventCreateToolDto
                && equalTo((CreateGoHighLevelCalendarEventCreateToolDto) other);
    }
    ...
    private boolean equalTo(CreateGoHighLevelCalendarEventCreateToolDto other) {
    ...
    public static final class Builder {
        private Optional<List<CreateGoHighLevelCalendarEventCreateToolDtoMessagesItem>> messages = Optional.empty();
        ...
        public Builder from(CreateGoHighLevelCalendarEventCreateToolDto other) {
        ...
        public Builder messages(Optional<List<CreateGoHighLevelCalendarEventCreateToolDtoMessagesItem>> messages) {
            this.messages = messages;
            return this;
        }

        public Builder messages(List<CreateGoHighLevelCalendarEventCreateToolDtoMessagesItem> messages) {
        ...
        public CreateGoHighLevelCalendarEventCreateToolDto build() {
            return new CreateGoHighLevelCalendarEventCreateToolDto(messages, function, additionalProperties);
        }
    }
}

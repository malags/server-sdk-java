...
public final class CreateGoHighLevelCalendarEventCreateToolDtoMessagesItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private CreateGoHighLevelCalendarEventCreateToolDtoMessagesItem(Value value) {
        this.value = value;
    }
    ...
    public static CreateGoHighLevelCalendarEventCreateToolDtoMessagesItem requestStart(ToolMessageStart value) {
        return new CreateGoHighLevelCalendarEventCreateToolDtoMessagesItem(new RequestStartValue(value));
    }

    public static CreateGoHighLevelCalendarEventCreateToolDtoMessagesItem requestComplete(ToolMessageComplete value) {
        return new CreateGoHighLevelCalendarEventCreateToolDtoMessagesItem(new RequestCompleteValue(value));
    }

    public static CreateGoHighLevelCalendarEventCreateToolDtoMessagesItem requestFailed(ToolMessageFailed value) {
        return new CreateGoHighLevelCalendarEventCreateToolDtoMessagesItem(new RequestFailedValue(value));
    }

    public static CreateGoHighLevelCalendarEventCreateToolDtoMessagesItem requestResponseDelayed(
            ToolMessageDelayed value) {
        return new CreateGoHighLevelCalendarEventCreateToolDtoMessagesItem(new RequestResponseDelayedValue(value));
    }
    ...
    private static final class RequestStartValue implements Value {
        ...
        public String toString() {
            return "CreateGoHighLevelCalendarEventCreateToolDtoMessagesItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "CreateGoHighLevelCalendarEventCreateToolDtoMessagesItem{" + "type: " + type + ", value: " + value
                    + "}";
        }
    }
}

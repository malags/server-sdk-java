...
public class RawToolsClient {
    ...
    public VapiHttpResponse<List<ToolsListResponseItem>> list() {
        return list(ToolsListRequest.builder().build());
    }

    public VapiHttpResponse<List<ToolsListResponseItem>> list(ToolsListRequest request) {
        return list(request, null);
    }

    public VapiHttpResponse<List<ToolsListResponseItem>> list(ToolsListRequest request, RequestOptions requestOptions) {
    ...
    public VapiHttpResponse<ToolsCreateResponse> create(ToolsCreateRequest request) {
        return create(request, null);
    }

    public VapiHttpResponse<ToolsCreateResponse> create(ToolsCreateRequest request, RequestOptions requestOptions) {
    ...
    public VapiHttpResponse<ToolsGetResponse> get(String id) {
        return get(id, null);
    }

    public VapiHttpResponse<ToolsGetResponse> get(String id, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("tool")
                .addPathSegment(id)
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new VapiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), ToolsGetResponse.class), response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            throw new VapiApiException(
                    "Error with status code " + response.code(),
    ...
    public VapiHttpResponse<ToolsDeleteResponse> delete(String id) {
        return delete(id, null);
    }

    public VapiHttpResponse<ToolsDeleteResponse> delete(String id, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("tool")
                .addPathSegment(id)
    ...
    public VapiHttpResponse<ToolsUpdateResponse> update(String id, ToolsUpdateRequest request) {
        return update(id, request, null);
    }

    public VapiHttpResponse<ToolsUpdateResponse> update(

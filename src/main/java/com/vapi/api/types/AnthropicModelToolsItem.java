...
public final class AnthropicModelToolsItem {
    ...
    public static AnthropicModelToolsItem apiRequest(CreateApiRequestToolDto value) {
        return new AnthropicModelToolsItem(new ApiRequestValue(value));
    }

    public static AnthropicModelToolsItem bash(CreateBashToolDto value) {
        return new AnthropicModelToolsItem(new BashValue(value));
    }

    public static AnthropicModelToolsItem computer(CreateComputerToolDto value) {
        return new AnthropicModelToolsItem(new ComputerValue(value));
    }
    ...
    public static AnthropicModelToolsItem gohighlevelCalendarAvailabilityCheck(
            CreateGoHighLevelCalendarAvailabilityToolDto value) {
        return new AnthropicModelToolsItem(new GohighlevelCalendarAvailabilityCheckValue(value));
    }

    public static AnthropicModelToolsItem gohighlevelCalendarEventCreate(
            CreateGoHighLevelCalendarEventCreateToolDto value) {
        return new AnthropicModelToolsItem(new GohighlevelCalendarEventCreateValue(value));
    }

    public static AnthropicModelToolsItem gohighlevelContactCreate(CreateGoHighLevelContactCreateToolDto value) {
        return new AnthropicModelToolsItem(new GohighlevelContactCreateValue(value));
    }

    public static AnthropicModelToolsItem gohighlevelContactGet(CreateGoHighLevelContactGetToolDto value) {
        return new AnthropicModelToolsItem(new GohighlevelContactGetValue(value));
    }

    public static AnthropicModelToolsItem googleCalendarAvailabilityCheck(
            CreateGoogleCalendarCheckAvailabilityToolDto value) {
        return new AnthropicModelToolsItem(new GoogleCalendarAvailabilityCheckValue(value));
    }

    public static AnthropicModelToolsItem googleCalendarEventCreate(CreateGoogleCalendarCreateEventToolDto value) {
        return new AnthropicModelToolsItem(new GoogleCalendarEventCreateValue(value));
    }

    public static AnthropicModelToolsItem googleSheetsRowAppend(CreateGoogleSheetsRowAppendToolDto value) {
        return new AnthropicModelToolsItem(new GoogleSheetsRowAppendValue(value));
    }

    public static AnthropicModelToolsItem mcp(CreateMcpToolDto value) {
        return new AnthropicModelToolsItem(new McpValue(value));
    }

    public static AnthropicModelToolsItem query(CreateQueryToolDto value) {
        return new AnthropicModelToolsItem(new QueryValue(value));
    }

    public static AnthropicModelToolsItem slackMessageSend(CreateSlackSendMessageToolDto value) {
        return new AnthropicModelToolsItem(new SlackMessageSendValue(value));
    }

    public static AnthropicModelToolsItem sms(CreateSmsToolDto value) {
        return new AnthropicModelToolsItem(new SmsValue(value));
    }

    public static AnthropicModelToolsItem textEditor(CreateTextEditorToolDto value) {
        return new AnthropicModelToolsItem(new TextEditorValue(value));
    }

...
public final class BlocksGetResponse {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private BlocksGetResponse(Value value) {
        this.value = value;
    }
    ...
    public static BlocksGetResponse conversation(ConversationBlock value) {
        return new BlocksGetResponse(new ConversationValue(value));
    }

    public static BlocksGetResponse toolCall(ToolCallBlock value) {
        return new BlocksGetResponse(new ToolCallValue(value));
    }

    public static BlocksGetResponse workflow(WorkflowBlock value) {
        return new BlocksGetResponse(new WorkflowValue(value));
    }
    ...
    private static final class ConversationValue implements Value {
        ...
        public String toString() {
            return "BlocksGetResponse{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "BlocksGetResponse{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

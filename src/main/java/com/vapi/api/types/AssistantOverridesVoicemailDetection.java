...
public final class AssistantOverridesVoicemailDetection {
    ...
    public static AssistantOverridesVoicemailDetection vapi(VapiVoicemailDetectionPlan value) {
        return new AssistantOverridesVoicemailDetection(new VapiValue(value));
    }

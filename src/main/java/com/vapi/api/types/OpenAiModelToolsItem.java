...
public final class OpenAiModelToolsItem {
    ...
    public static OpenAiModelToolsItem voicemail(CreateVoicemailToolDto value) {
        return new OpenAiModelToolsItem(new VoicemailValue(value));
    }
    ...
    public static OpenAiModelToolsItem ghl(CreateGhlToolDto value) {
        return new OpenAiModelToolsItem(new GhlValue(value));
    }

    public static OpenAiModelToolsItem make(CreateMakeToolDto value) {
        return new OpenAiModelToolsItem(new MakeValue(value));
    }

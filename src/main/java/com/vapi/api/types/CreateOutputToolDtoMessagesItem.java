...
public final class CreateOutputToolDtoMessagesItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private CreateOutputToolDtoMessagesItem(Value value) {
        this.value = value;
    }
    ...
    public static CreateOutputToolDtoMessagesItem requestStart(ToolMessageStart value) {
        return new CreateOutputToolDtoMessagesItem(new RequestStartValue(value));
    }

    public static CreateOutputToolDtoMessagesItem requestComplete(ToolMessageComplete value) {
        return new CreateOutputToolDtoMessagesItem(new RequestCompleteValue(value));
    }

    public static CreateOutputToolDtoMessagesItem requestFailed(ToolMessageFailed value) {
        return new CreateOutputToolDtoMessagesItem(new RequestFailedValue(value));
    }

    public static CreateOutputToolDtoMessagesItem requestResponseDelayed(ToolMessageDelayed value) {
        return new CreateOutputToolDtoMessagesItem(new RequestResponseDelayedValue(value));
    }
    ...
    private static final class RequestStartValue implements Value {
        ...
        public String toString() {
            return "CreateOutputToolDtoMessagesItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "CreateOutputToolDtoMessagesItem{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

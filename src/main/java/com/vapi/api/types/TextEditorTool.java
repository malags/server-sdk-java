...
@JsonDeserialize(builder = TextEditorTool.Builder.class)
public final class TextEditorTool {
    private final Optional<List<TextEditorToolMessagesItem>> messages;
    ...
    private TextEditorTool(
            Optional<List<TextEditorToolMessagesItem>> messages,
    ...
    public Optional<List<TextEditorToolMessagesItem>> getMessages() {
        return messages;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof TextEditorTool && equalTo((TextEditorTool) other);
    }
    ...
    private boolean equalTo(TextEditorTool other) {
    ...
    public interface IdStage {
        ...
        Builder from(TextEditorTool other);
    }
    ...
    public interface _FinalStage {
        TextEditorTool build();

        /**
         * <p>These are the messages that will be spoken to the user as the tool is running.</p>
         * <p>For some tools, this is auto-filled based on special fields like <code>tool.destinations</code>. For others like the function tool, these can be custom configured.</p>
         */
        _FinalStage messages(Optional<List<TextEditorToolMessagesItem>> messages);

        _FinalStage messages(List<TextEditorToolMessagesItem> messages);
    ...
    public static final class Builder implements IdStage, OrgIdStage, CreatedAtStage, UpdatedAtStage, _FinalStage {
        ...
        private Optional<List<TextEditorToolMessagesItem>> messages = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(TextEditorTool other) {
         ...
         */
        @java.lang.Override
        public _FinalStage messages(List<TextEditorToolMessagesItem> messages) {
        ...
        public _FinalStage messages(Optional<List<TextEditorToolMessagesItem>> messages) {
            this.messages = messages;
            return this;
        }

        @java.lang.Override
        public TextEditorTool build() {
            return new TextEditorTool(
                    messages, server, id, orgId, createdAt, updatedAt, function, additionalProperties);
        }
    }
}

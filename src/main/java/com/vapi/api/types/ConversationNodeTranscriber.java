...
public final class ConversationNodeTranscriber {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private ConversationNodeTranscriber(Value value) {
        this.value = value;
    }
    ...
    public static ConversationNodeTranscriber assemblyAi(AssemblyAiTranscriber value) {
        return new ConversationNodeTranscriber(new AssemblyAiValue(value));
    }

    public static ConversationNodeTranscriber azure(AzureSpeechTranscriber value) {
        return new ConversationNodeTranscriber(new AzureValue(value));
    }

    public static ConversationNodeTranscriber customTranscriber(CustomTranscriber value) {
        return new ConversationNodeTranscriber(new CustomTranscriberValue(value));
    }

    public static ConversationNodeTranscriber deepgram(DeepgramTranscriber value) {
        return new ConversationNodeTranscriber(new DeepgramValue(value));
    }

    public static ConversationNodeTranscriber _11Labs(ElevenLabsTranscriber value) {
        return new ConversationNodeTranscriber(new _11LabsValue(value));
    }

    public static ConversationNodeTranscriber gladia(GladiaTranscriber value) {
        return new ConversationNodeTranscriber(new GladiaValue(value));
    }

    public static ConversationNodeTranscriber google(GoogleTranscriber value) {
        return new ConversationNodeTranscriber(new GoogleValue(value));
    }

    public static ConversationNodeTranscriber speechmatics(SpeechmaticsTranscriber value) {
        return new ConversationNodeTranscriber(new SpeechmaticsValue(value));
    }

    public static ConversationNodeTranscriber talkscriber(TalkscriberTranscriber value) {
        return new ConversationNodeTranscriber(new TalkscriberValue(value));
    }

    public static ConversationNodeTranscriber openai(OpenAiTranscriber value) {
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "ConversationNodeTranscriber{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

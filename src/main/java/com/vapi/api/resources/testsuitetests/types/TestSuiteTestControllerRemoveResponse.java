...
public final class TestSuiteTestControllerRemoveResponse {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private TestSuiteTestControllerRemoveResponse(Value value) {
        this.value = value;
    }
    ...
    public static TestSuiteTestControllerRemoveResponse voice(TestSuiteTestVoice value) {
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "TestSuiteTestControllerRemoveResponse{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

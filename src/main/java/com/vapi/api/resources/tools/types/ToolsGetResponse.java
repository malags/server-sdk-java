...
public final class ToolsGetResponse {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private ToolsGetResponse(Value value) {
        this.value = value;
    }
    ...
    public static ToolsGetResponse apiRequest(ApiRequestTool value) {
        return new ToolsGetResponse(new ApiRequestValue(value));
    }

    public static ToolsGetResponse dtmf(DtmfTool value) {
        return new ToolsGetResponse(new DtmfValue(value));
    }

    public static ToolsGetResponse endCall(EndCallTool value) {
        return new ToolsGetResponse(new EndCallValue(value));
    }

    public static ToolsGetResponse function(FunctionTool value) {
        return new ToolsGetResponse(new FunctionValue(value));
    }

    public static ToolsGetResponse ghl(GhlTool value) {
        return new ToolsGetResponse(new GhlValue(value));
    }

    public static ToolsGetResponse make(MakeTool value) {
        return new ToolsGetResponse(new MakeValue(value));
    }

    public static ToolsGetResponse transferCall(TransferCallTool value) {
        return new ToolsGetResponse(new TransferCallValue(value));
    }

    public static ToolsGetResponse output(OutputTool value) {
        return new ToolsGetResponse(new OutputValue(value));
    }

    public static ToolsGetResponse bash(BashTool value) {
        return new ToolsGetResponse(new BashValue(value));
    }

    public static ToolsGetResponse computer(ComputerTool value) {
        return new ToolsGetResponse(new ComputerValue(value));
    }

    public static ToolsGetResponse textEditor(TextEditorTool value) {
        return new ToolsGetResponse(new TextEditorValue(value));
    }

    public static ToolsGetResponse query(QueryTool value) {
        return new ToolsGetResponse(new QueryValue(value));
    }

    public static ToolsGetResponse googleCalendarEventCreate(GoogleCalendarCreateEventTool value) {
        return new ToolsGetResponse(new GoogleCalendarEventCreateValue(value));
    }

    public static ToolsGetResponse googleSheetsRowAppend(GoogleSheetsRowAppendTool value) {
        return new ToolsGetResponse(new GoogleSheetsRowAppendValue(value));
    }

    public static ToolsGetResponse googleCalendarAvailabilityCheck(GoogleCalendarCheckAvailabilityTool value) {
        return new ToolsGetResponse(new GoogleCalendarAvailabilityCheckValue(value));
    }

    public static ToolsGetResponse slackMessageSend(SlackSendMessageTool value) {
        return new ToolsGetResponse(new SlackMessageSendValue(value));
    }

    public static ToolsGetResponse sms(SmsTool value) {
        return new ToolsGetResponse(new SmsValue(value));
    }

    public static ToolsGetResponse mcp(McpTool value) {
        return new ToolsGetResponse(new McpValue(value));
    }

    public static ToolsGetResponse gohighlevelCalendarAvailabilityCheck(GoHighLevelCalendarAvailabilityTool value) {
        return new ToolsGetResponse(new GohighlevelCalendarAvailabilityCheckValue(value));
    }

    public static ToolsGetResponse gohighlevelCalendarEventCreate(GoHighLevelCalendarEventCreateTool value) {
        return new ToolsGetResponse(new GohighlevelCalendarEventCreateValue(value));
    }

    public static ToolsGetResponse gohighlevelContactCreate(GoHighLevelContactCreateTool value) {
        return new ToolsGetResponse(new GohighlevelContactCreateValue(value));
    }

    public static ToolsGetResponse gohighlevelContactGet(GoHighLevelContactGetTool value) {
        return new ToolsGetResponse(new GohighlevelContactGetValue(value));
    }
    ...
    private static final class ApiRequestValue implements Value {
        ...
        public String toString() {
            return "ToolsGetResponse{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "ToolsGetResponse{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

...
public final class OpenRouterModelToolsItem {
    ...
    public static OpenRouterModelToolsItem voicemail(CreateVoicemailToolDto value) {
        return new OpenRouterModelToolsItem(new VoicemailValue(value));
    }
    ...
    public static OpenRouterModelToolsItem ghl(CreateGhlToolDto value) {
        return new OpenRouterModelToolsItem(new GhlValue(value));
    }

    public static OpenRouterModelToolsItem make(CreateMakeToolDto value) {
        return new OpenRouterModelToolsItem(new MakeValue(value));
    }

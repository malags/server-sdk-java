...
@JsonDeserialize(builder = CreateWebCustomerDto.Builder.class)
public final class CreateWebCustomerDto {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateWebCustomerDto && equalTo((CreateWebCustomerDto) other);
    }
    ...
    private boolean equalTo(CreateWebCustomerDto other) {
    ...
    public static final class Builder {
        ...
        public Builder from(CreateWebCustomerDto other) {
        ...
        public Builder assistantOverrides(Optional<ChatAssistantOverrides> assistantOverrides) {
            this.assistantOverrides = assistantOverrides;
            return this;
        }

        public Builder assistantOverrides(ChatAssistantOverrides assistantOverrides) {
        ...
        public CreateWebCustomerDto build() {
            return new CreateWebCustomerDto(

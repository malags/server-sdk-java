...
@JsonDeserialize(builder = DtmfTool.Builder.class)
public final class DtmfTool {
    private final Optional<List<DtmfToolMessagesItem>> messages;
    ...
    private DtmfTool(
            Optional<List<DtmfToolMessagesItem>> messages,
            String id,
            String orgId,
    ...
    public Optional<List<DtmfToolMessagesItem>> getMessages() {
        return messages;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof DtmfTool && equalTo((DtmfTool) other);
    }
    ...
    private boolean equalTo(DtmfTool other) {
    ...
    public interface _FinalStage {
         ...
         * <p>For some tools, this is auto-filled based on special fields like <code>tool.destinations</code>. For others like the function tool, these can be custom configured.</p>
         */
        _FinalStage messages(Optional<List<DtmfToolMessagesItem>> messages);

        _FinalStage messages(List<DtmfToolMessagesItem> messages);
    ...
    public static final class Builder implements IdStage, OrgIdStage, CreatedAtStage, UpdatedAtStage, _FinalStage {
        ...
        private Optional<List<DtmfToolMessagesItem>> messages = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(DtmfTool other) {
         ...
         */
        @java.lang.Override
        public _FinalStage messages(List<DtmfToolMessagesItem> messages) {
        ...
        public _FinalStage messages(Optional<List<DtmfToolMessagesItem>> messages) {
            this.messages = messages;
            return this;
        }

        @java.lang.Override
        public DtmfTool build() {
            return new DtmfTool(messages, id, orgId, createdAt, updatedAt, function, additionalProperties);
        }
    }
}

...
@JsonDeserialize(builder = UpdateSlackSendMessageToolDto.Builder.class)
public final class UpdateSlackSendMessageToolDto {
    private final Optional<List<UpdateSlackSendMessageToolDtoMessagesItem>> messages;

    private final Optional<OpenAiFunction> function;

    private final Map<String, Object> additionalProperties;

    private UpdateSlackSendMessageToolDto(
            Optional<List<UpdateSlackSendMessageToolDtoMessagesItem>> messages,
    ...
    public Optional<List<UpdateSlackSendMessageToolDtoMessagesItem>> getMessages() {
        return messages;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateSlackSendMessageToolDto && equalTo((UpdateSlackSendMessageToolDto) other);
    }
    ...
    private boolean equalTo(UpdateSlackSendMessageToolDto other) {
    ...
    public static final class Builder {
        private Optional<List<UpdateSlackSendMessageToolDtoMessagesItem>> messages = Optional.empty();
        ...
        public Builder from(UpdateSlackSendMessageToolDto other) {
        ...
        public Builder messages(Optional<List<UpdateSlackSendMessageToolDtoMessagesItem>> messages) {
            this.messages = messages;
            return this;
        }

        public Builder messages(List<UpdateSlackSendMessageToolDtoMessagesItem> messages) {
        ...
        public UpdateSlackSendMessageToolDto build() {
            return new UpdateSlackSendMessageToolDto(messages, function, additionalProperties);
        }
    }
}

...
@JsonDeserialize(builder = CreateSlackSendMessageToolDto.Builder.class)
public final class CreateSlackSendMessageToolDto {
    private final Optional<List<CreateSlackSendMessageToolDtoMessagesItem>> messages;

    private final Optional<OpenAiFunction> function;

    private final Map<String, Object> additionalProperties;

    private CreateSlackSendMessageToolDto(
            Optional<List<CreateSlackSendMessageToolDtoMessagesItem>> messages,
    ...
    public Optional<List<CreateSlackSendMessageToolDtoMessagesItem>> getMessages() {
        return messages;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateSlackSendMessageToolDto && equalTo((CreateSlackSendMessageToolDto) other);
    }
    ...
    private boolean equalTo(CreateSlackSendMessageToolDto other) {
    ...
    public static final class Builder {
        private Optional<List<CreateSlackSendMessageToolDtoMessagesItem>> messages = Optional.empty();
        ...
        public Builder from(CreateSlackSendMessageToolDto other) {
        ...
        public Builder messages(Optional<List<CreateSlackSendMessageToolDtoMessagesItem>> messages) {
            this.messages = messages;
            return this;
        }

        public Builder messages(List<CreateSlackSendMessageToolDtoMessagesItem> messages) {
        ...
        public CreateSlackSendMessageToolDto build() {
            return new CreateSlackSendMessageToolDto(messages, function, additionalProperties);
        }
    }
}

...
public final class SmsToolMessagesItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private SmsToolMessagesItem(Value value) {
        this.value = value;
    }
    ...
    public static SmsToolMessagesItem requestStart(ToolMessageStart value) {
        return new SmsToolMessagesItem(new RequestStartValue(value));
    }

    public static SmsToolMessagesItem requestComplete(ToolMessageComplete value) {
        return new SmsToolMessagesItem(new RequestCompleteValue(value));
    }

    public static SmsToolMessagesItem requestFailed(ToolMessageFailed value) {
        return new SmsToolMessagesItem(new RequestFailedValue(value));
    }

    public static SmsToolMessagesItem requestResponseDelayed(ToolMessageDelayed value) {
        return new SmsToolMessagesItem(new RequestResponseDelayedValue(value));
    }
    ...
    private static final class RequestStartValue implements Value {
        ...
        public String toString() {
            return "SmsToolMessagesItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "SmsToolMessagesItem{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

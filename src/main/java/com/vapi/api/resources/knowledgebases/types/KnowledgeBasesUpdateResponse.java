...
public final class KnowledgeBasesUpdateResponse {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private KnowledgeBasesUpdateResponse(Value value) {
        this.value = value;
    }
    ...
    public static KnowledgeBasesUpdateResponse trieve(TrieveKnowledgeBase value) {
        return new KnowledgeBasesUpdateResponse(new TrieveValue(value));
    }

    public static KnowledgeBasesUpdateResponse customKnowledgeBase(CustomKnowledgeBase value) {
        return new KnowledgeBasesUpdateResponse(new CustomKnowledgeBaseValue(value));
    }
    ...
    private static final class TrieveValue implements Value {
        ...
        public String toString() {
            return "KnowledgeBasesUpdateResponse{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "KnowledgeBasesUpdateResponse{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

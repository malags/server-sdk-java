...
@JsonDeserialize(builder = SlackSendMessageTool.Builder.class)
public final class SlackSendMessageTool {
    private final Optional<List<SlackSendMessageToolMessagesItem>> messages;
    ...
    private SlackSendMessageTool(
            Optional<List<SlackSendMessageToolMessagesItem>> messages,
            String id,
            String orgId,
    ...
    public Optional<List<SlackSendMessageToolMessagesItem>> getMessages() {
        return messages;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof SlackSendMessageTool && equalTo((SlackSendMessageTool) other);
    }
    ...
    private boolean equalTo(SlackSendMessageTool other) {
    ...
    public interface IdStage {
        ...
        Builder from(SlackSendMessageTool other);
    }
    ...
    public interface _FinalStage {
        SlackSendMessageTool build();

        /**
         * <p>These are the messages that will be spoken to the user as the tool is running.</p>
         * <p>For some tools, this is auto-filled based on special fields like <code>tool.destinations</code>. For others like the function tool, these can be custom configured.</p>
         */
        _FinalStage messages(Optional<List<SlackSendMessageToolMessagesItem>> messages);

        _FinalStage messages(List<SlackSendMessageToolMessagesItem> messages);
    ...
    public static final class Builder implements IdStage, OrgIdStage, CreatedAtStage, UpdatedAtStage, _FinalStage {
        ...
        private Optional<List<SlackSendMessageToolMessagesItem>> messages = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(SlackSendMessageTool other) {
         ...
         */
        @java.lang.Override
        public _FinalStage messages(List<SlackSendMessageToolMessagesItem> messages) {
        ...
        public _FinalStage messages(Optional<List<SlackSendMessageToolMessagesItem>> messages) {
            this.messages = messages;
            return this;
        }

        @java.lang.Override
        public SlackSendMessageTool build() {
            return new SlackSendMessageTool(messages, id, orgId, createdAt, updatedAt, function, additionalProperties);
        }
    }
}

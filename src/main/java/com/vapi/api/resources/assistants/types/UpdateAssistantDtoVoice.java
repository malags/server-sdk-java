...
import com.vapi.api.types.NeetsVoice;
...
public final class UpdateAssistantDtoVoice {
    ...
    public static UpdateAssistantDtoVoice neets(NeetsVoice value) {
        return new UpdateAssistantDtoVoice(new NeetsValue(value));
    }

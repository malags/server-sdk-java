...
public final class TemplateDetails {
    ...
    public static TemplateDetails voicemail(CreateVoicemailToolDto value) {
        return new TemplateDetails(new VoicemailValue(value));
    }
    ...
    public static TemplateDetails ghl(CreateGhlToolDto value) {
        return new TemplateDetails(new GhlValue(value));
    }

    public static TemplateDetails make(CreateMakeToolDto value) {
        return new TemplateDetails(new MakeValue(value));
    }

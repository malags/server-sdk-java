...
@JsonDeserialize(builder = ImportVonagePhoneNumberDto.Builder.class)
public final class ImportVonagePhoneNumberDto {
    private final Optional<ImportVonagePhoneNumberDtoFallbackDestination> fallbackDestination;

    private final String vonagePhoneNumber;
    ...
    private ImportVonagePhoneNumberDto(
            Optional<ImportVonagePhoneNumberDtoFallbackDestination> fallbackDestination,
    ...
    public Optional<ImportVonagePhoneNumberDtoFallbackDestination> getFallbackDestination() {
    ...
    public String getVonagePhoneNumber() {
     ...
     * <p>You can add the Vonage Credential in the Provider Credentials page on the dashboard to get the credentialId.</p>
     */
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ImportVonagePhoneNumberDto && equalTo((ImportVonagePhoneNumberDto) other);
    }
    ...
    private boolean equalTo(ImportVonagePhoneNumberDto other) {
        return fallbackDestination.equals(other.fallbackDestination)
                && vonagePhoneNumber.equals(other.vonagePhoneNumber)
    ...
    public static VonagePhoneNumberStage builder() {
        return new Builder();
    }
    ...
    public static final class Builder implements VonagePhoneNumberStage, CredentialIdStage, _FinalStage {
        private String vonagePhoneNumber;
        ...
        private Optional<ImportVonagePhoneNumberDtoFallbackDestination> fallbackDestination = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(ImportVonagePhoneNumberDto other) {
            fallbackDestination(other.getFallbackDestination());
            vonagePhoneNumber(other.getVonagePhoneNumber());
         ...
         */
        @java.lang.Override
        @JsonSetter("vonagePhoneNumber")
        public CredentialIdStage vonagePhoneNumber(@NotNull String vonagePhoneNumber) {
            this.vonagePhoneNumber = Objects.requireNonNull(vonagePhoneNumber, "vonagePhoneNumber must not be null");
            return this;
        }
         ...
         */
        @java.lang.Override
        public _FinalStage fallbackDestination(ImportVonagePhoneNumberDtoFallbackDestination fallbackDestination) {
        ...
        @java.lang.Override
        public ImportVonagePhoneNumberDto build() {
            return new ImportVonagePhoneNumberDto(
                    fallbackDestination,
                    vonagePhoneNumber,
                    credentialId,
                    name,

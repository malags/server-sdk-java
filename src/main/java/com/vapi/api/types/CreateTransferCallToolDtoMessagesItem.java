...
public final class CreateTransferCallToolDtoMessagesItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private CreateTransferCallToolDtoMessagesItem(Value value) {
        this.value = value;
    }
    ...
    public static CreateTransferCallToolDtoMessagesItem requestStart(ToolMessageStart value) {
        return new CreateTransferCallToolDtoMessagesItem(new RequestStartValue(value));
    }

    public static CreateTransferCallToolDtoMessagesItem requestComplete(ToolMessageComplete value) {
        return new CreateTransferCallToolDtoMessagesItem(new RequestCompleteValue(value));
    }

    public static CreateTransferCallToolDtoMessagesItem requestFailed(ToolMessageFailed value) {
        return new CreateTransferCallToolDtoMessagesItem(new RequestFailedValue(value));
    }

    public static CreateTransferCallToolDtoMessagesItem requestResponseDelayed(ToolMessageDelayed value) {
        return new CreateTransferCallToolDtoMessagesItem(new RequestResponseDelayedValue(value));
    }
    ...
    private static final class RequestStartValue implements Value {
        ...
        public String toString() {
            return "CreateTransferCallToolDtoMessagesItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "CreateTransferCallToolDtoMessagesItem{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

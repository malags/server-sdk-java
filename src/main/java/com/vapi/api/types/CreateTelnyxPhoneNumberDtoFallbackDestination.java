...
public final class CreateTelnyxPhoneNumberDtoFallbackDestination {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private CreateTelnyxPhoneNumberDtoFallbackDestination(Value value) {
        this.value = value;
    }
    ...
    public static CreateTelnyxPhoneNumberDtoFallbackDestination number(TransferDestinationNumber value) {
        return new CreateTelnyxPhoneNumberDtoFallbackDestination(new NumberValue(value));
    }

    public static CreateTelnyxPhoneNumberDtoFallbackDestination sip(TransferDestinationSip value) {
        return new CreateTelnyxPhoneNumberDtoFallbackDestination(new SipValue(value));
    }
    ...
    private static final class NumberValue implements Value {
        ...
        public String toString() {
            return "CreateTelnyxPhoneNumberDtoFallbackDestination{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "CreateTelnyxPhoneNumberDtoFallbackDestination{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

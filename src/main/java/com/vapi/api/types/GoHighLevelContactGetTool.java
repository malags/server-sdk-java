...
@JsonDeserialize(builder = GoHighLevelContactGetTool.Builder.class)
public final class GoHighLevelContactGetTool {
    private final Optional<Boolean> async;

    private final Optional<List<GoHighLevelContactGetToolMessagesItem>> messages;
    ...
    private GoHighLevelContactGetTool(
            Optional<Boolean> async,
            Optional<List<GoHighLevelContactGetToolMessagesItem>> messages,
            String id,
            String orgId,
    ...
    public Optional<List<GoHighLevelContactGetToolMessagesItem>> getMessages() {
        return messages;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GoHighLevelContactGetTool && equalTo((GoHighLevelContactGetTool) other);
    }
    ...
    private boolean equalTo(GoHighLevelContactGetTool other) {
    ...
    public interface IdStage {
        ...
        Builder from(GoHighLevelContactGetTool other);
    }
    ...
    public interface _FinalStage {
        GoHighLevelContactGetTool build();

        _FinalStage async(Optional<Boolean> async);

        _FinalStage async(Boolean async);

        _FinalStage messages(Optional<List<GoHighLevelContactGetToolMessagesItem>> messages);

        _FinalStage messages(List<GoHighLevelContactGetToolMessagesItem> messages);
    ...
    public static final class Builder implements IdStage, OrgIdStage, CreatedAtStage, UpdatedAtStage, _FinalStage {
        ...
        private Optional<List<GoHighLevelContactGetToolMessagesItem>> messages = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(GoHighLevelContactGetTool other) {
         ...
         */
        @java.lang.Override
        public _FinalStage messages(List<GoHighLevelContactGetToolMessagesItem> messages) {
        ...
        public _FinalStage messages(Optional<List<GoHighLevelContactGetToolMessagesItem>> messages) {
            this.messages = messages;
            return this;
        }
        ...
        @java.lang.Override
        public GoHighLevelContactGetTool build() {
            return new GoHighLevelContactGetTool(

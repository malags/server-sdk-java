...
import com.vapi.api.types.ToolMessageComplete;
import com.vapi.api.types.ToolMessageDelayed;
import com.vapi.api.types.ToolMessageFailed;
import com.vapi.api.types.ToolMessageStart;
import java.util.Objects;
import java.util.Optional;

public final class UpdateToolDtoMessagesItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private UpdateToolDtoMessagesItem(Value value) {
        this.value = value;
    }
    ...
    public static UpdateToolDtoMessagesItem requestStart(ToolMessageStart value) {
        return new UpdateToolDtoMessagesItem(new RequestStartValue(value));
    }

    public static UpdateToolDtoMessagesItem requestComplete(ToolMessageComplete value) {
        return new UpdateToolDtoMessagesItem(new RequestCompleteValue(value));
    }

    public static UpdateToolDtoMessagesItem requestFailed(ToolMessageFailed value) {
        return new UpdateToolDtoMessagesItem(new RequestFailedValue(value));
    }

    public static UpdateToolDtoMessagesItem requestResponseDelayed(ToolMessageDelayed value) {
        return new UpdateToolDtoMessagesItem(new RequestResponseDelayedValue(value));
    }
    ...
    private static final class RequestStartValue implements Value {
        ...
        public String toString() {
            return "UpdateToolDtoMessagesItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "UpdateToolDtoMessagesItem{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

...
public final class AssistantHooksItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private AssistantHooksItem(Value value) {
        this.value = value;
    }
    ...
    public static AssistantHooksItem callEnding(AssistantHookCallEnding value) {
        return new AssistantHooksItem(new CallEndingValue(value));
    }

    public static AssistantHooksItem assistantSpeechInterrupted(AssistantHookAssistantSpeechInterrupted value) {
        return new AssistantHooksItem(new AssistantSpeechInterruptedValue(value));
    }

    public static AssistantHooksItem customerSpeechInterrupted(AssistantHookCustomerSpeechInterrupted value) {
        return new AssistantHooksItem(new CustomerSpeechInterruptedValue(value));
    }
    ...
    private static final class CallEndingValue implements Value {
        ...
        public String toString() {
            return "AssistantHooksItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "AssistantHooksItem{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

...
public final class EndCallToolMessagesItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private EndCallToolMessagesItem(Value value) {
        this.value = value;
    }
    ...
    public static EndCallToolMessagesItem requestStart(ToolMessageStart value) {
        return new EndCallToolMessagesItem(new RequestStartValue(value));
    }

    public static EndCallToolMessagesItem requestComplete(ToolMessageComplete value) {
        return new EndCallToolMessagesItem(new RequestCompleteValue(value));
    }

    public static EndCallToolMessagesItem requestFailed(ToolMessageFailed value) {
        return new EndCallToolMessagesItem(new RequestFailedValue(value));
    }

    public static EndCallToolMessagesItem requestResponseDelayed(ToolMessageDelayed value) {
        return new EndCallToolMessagesItem(new RequestResponseDelayedValue(value));
    }
    ...
    private static final class RequestStartValue implements Value {
        ...
        public String toString() {
            return "EndCallToolMessagesItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "EndCallToolMessagesItem{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

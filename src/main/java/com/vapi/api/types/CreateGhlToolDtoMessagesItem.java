...
public final class CreateGhlToolDtoMessagesItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private CreateGhlToolDtoMessagesItem(Value value) {
        this.value = value;
    }
    ...
    public static CreateGhlToolDtoMessagesItem requestStart(ToolMessageStart value) {
        return new CreateGhlToolDtoMessagesItem(new RequestStartValue(value));
    }

    public static CreateGhlToolDtoMessagesItem requestComplete(ToolMessageComplete value) {
        return new CreateGhlToolDtoMessagesItem(new RequestCompleteValue(value));
    }

    public static CreateGhlToolDtoMessagesItem requestFailed(ToolMessageFailed value) {
        return new CreateGhlToolDtoMessagesItem(new RequestFailedValue(value));
    }

    public static CreateGhlToolDtoMessagesItem requestResponseDelayed(ToolMessageDelayed value) {
        return new CreateGhlToolDtoMessagesItem(new RequestResponseDelayedValue(value));
    }
    ...
    private static final class RequestStartValue implements Value {
        ...
        public String toString() {
            return "CreateGhlToolDtoMessagesItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "CreateGhlToolDtoMessagesItem{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

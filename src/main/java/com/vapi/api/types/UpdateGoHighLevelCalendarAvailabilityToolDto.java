...
@JsonDeserialize(builder = UpdateGoHighLevelCalendarAvailabilityToolDto.Builder.class)
public final class UpdateGoHighLevelCalendarAvailabilityToolDto {
    private final Optional<List<UpdateGoHighLevelCalendarAvailabilityToolDtoMessagesItem>> messages;

    private final Optional<OpenAiFunction> function;

    private final Map<String, Object> additionalProperties;

    private UpdateGoHighLevelCalendarAvailabilityToolDto(
            Optional<List<UpdateGoHighLevelCalendarAvailabilityToolDtoMessagesItem>> messages,
    ...
    public Optional<List<UpdateGoHighLevelCalendarAvailabilityToolDtoMessagesItem>> getMessages() {
        return messages;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateGoHighLevelCalendarAvailabilityToolDto
                && equalTo((UpdateGoHighLevelCalendarAvailabilityToolDto) other);
    }
    ...
    private boolean equalTo(UpdateGoHighLevelCalendarAvailabilityToolDto other) {
    ...
    public static final class Builder {
        private Optional<List<UpdateGoHighLevelCalendarAvailabilityToolDtoMessagesItem>> messages = Optional.empty();
        ...
        public Builder from(UpdateGoHighLevelCalendarAvailabilityToolDto other) {
        ...
        public Builder messages(Optional<List<UpdateGoHighLevelCalendarAvailabilityToolDtoMessagesItem>> messages) {
            this.messages = messages;
            return this;
        }

        public Builder messages(List<UpdateGoHighLevelCalendarAvailabilityToolDtoMessagesItem> messages) {
        ...
        public UpdateGoHighLevelCalendarAvailabilityToolDto build() {
            return new UpdateGoHighLevelCalendarAvailabilityToolDto(messages, function, additionalProperties);
        }
    }
}

...
public final class TransferCallToolDestinationsItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private TransferCallToolDestinationsItem(Value value) {
        this.value = value;
    }
    ...
    public static TransferCallToolDestinationsItem assistant(TransferDestinationAssistant value) {
        return new TransferCallToolDestinationsItem(new AssistantValue(value));
    }

    public static TransferCallToolDestinationsItem step(TransferDestinationStep value) {
        return new TransferCallToolDestinationsItem(new StepValue(value));
    }

    public static TransferCallToolDestinationsItem number(TransferDestinationNumber value) {
        return new TransferCallToolDestinationsItem(new NumberValue(value));
    }

    public static TransferCallToolDestinationsItem sip(TransferDestinationSip value) {
        return new TransferCallToolDestinationsItem(new SipValue(value));
    }
    ...
    private static final class AssistantValue implements Value {
        ...
        public String toString() {
            return "TransferCallToolDestinationsItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "TransferCallToolDestinationsItem{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

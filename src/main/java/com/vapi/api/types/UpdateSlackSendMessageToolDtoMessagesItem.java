...
public final class UpdateSlackSendMessageToolDtoMessagesItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private UpdateSlackSendMessageToolDtoMessagesItem(Value value) {
        this.value = value;
    }
    ...
    public static UpdateSlackSendMessageToolDtoMessagesItem requestStart(ToolMessageStart value) {
        return new UpdateSlackSendMessageToolDtoMessagesItem(new RequestStartValue(value));
    }

    public static UpdateSlackSendMessageToolDtoMessagesItem requestComplete(ToolMessageComplete value) {
        return new UpdateSlackSendMessageToolDtoMessagesItem(new RequestCompleteValue(value));
    }

    public static UpdateSlackSendMessageToolDtoMessagesItem requestFailed(ToolMessageFailed value) {
        return new UpdateSlackSendMessageToolDtoMessagesItem(new RequestFailedValue(value));
    }

    public static UpdateSlackSendMessageToolDtoMessagesItem requestResponseDelayed(ToolMessageDelayed value) {
        return new UpdateSlackSendMessageToolDtoMessagesItem(new RequestResponseDelayedValue(value));
    }
    ...
    private static final class RequestStartValue implements Value {
        ...
        public String toString() {
            return "UpdateSlackSendMessageToolDtoMessagesItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "UpdateSlackSendMessageToolDtoMessagesItem{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

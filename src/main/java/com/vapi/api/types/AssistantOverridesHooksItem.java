...
public final class AssistantOverridesHooksItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private AssistantOverridesHooksItem(Value value) {
        this.value = value;
    }
    ...
    public static AssistantOverridesHooksItem callEnding(AssistantHookCallEnding value) {
        return new AssistantOverridesHooksItem(new CallEndingValue(value));
    }

    public static AssistantOverridesHooksItem assistantSpeechInterrupted(
            AssistantHookAssistantSpeechInterrupted value) {
        return new AssistantOverridesHooksItem(new AssistantSpeechInterruptedValue(value));
    }

    public static AssistantOverridesHooksItem customerSpeechInterrupted(AssistantHookCustomerSpeechInterrupted value) {
        return new AssistantOverridesHooksItem(new CustomerSpeechInterruptedValue(value));
    }
    ...
    private static final class CallEndingValue implements Value {
        ...
        public String toString() {
            return "AssistantOverridesHooksItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "AssistantOverridesHooksItem{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

...
import com.vapi.api.types.ConversationNode;
import com.vapi.api.types.ToolNode;
...
public final class UpdateWorkflowDtoNodesItem {
    ...
    public static UpdateWorkflowDtoNodesItem conversation(ConversationNode value) {
        return new UpdateWorkflowDtoNodesItem(new ConversationValue(value));
    }

    public static UpdateWorkflowDtoNodesItem tool(ToolNode value) {
        return new UpdateWorkflowDtoNodesItem(new ToolValue(value));
    }

...
@JsonDeserialize(builder = GoogleCalendarCreateEventToolWithToolCall.Builder.class)
public final class GoogleCalendarCreateEventToolWithToolCall {
    private final Optional<List<GoogleCalendarCreateEventToolWithToolCallMessagesItem>> messages;
    ...
    private GoogleCalendarCreateEventToolWithToolCall(
            Optional<List<GoogleCalendarCreateEventToolWithToolCallMessagesItem>> messages,
            ToolCall toolCall,
    ...
    public Optional<List<GoogleCalendarCreateEventToolWithToolCallMessagesItem>> getMessages() {
        return messages;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GoogleCalendarCreateEventToolWithToolCall
                && equalTo((GoogleCalendarCreateEventToolWithToolCall) other);
    }
    ...
    private boolean equalTo(GoogleCalendarCreateEventToolWithToolCall other) {
    ...
    public interface ToolCallStage {
        ...
        Builder from(GoogleCalendarCreateEventToolWithToolCall other);
    }

    public interface _FinalStage {
        GoogleCalendarCreateEventToolWithToolCall build();

        /**
         * <p>These are the messages that will be spoken to the user as the tool is running.</p>
         * <p>For some tools, this is auto-filled based on special fields like <code>tool.destinations</code>. For others like the function tool, these can be custom configured.</p>
         */
        _FinalStage messages(Optional<List<GoogleCalendarCreateEventToolWithToolCallMessagesItem>> messages);

        _FinalStage messages(List<GoogleCalendarCreateEventToolWithToolCallMessagesItem> messages);
    ...
    public static final class Builder implements ToolCallStage, _FinalStage {
        ...
        private Optional<List<GoogleCalendarCreateEventToolWithToolCallMessagesItem>> messages = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(GoogleCalendarCreateEventToolWithToolCall other) {
         ...
         */
        @java.lang.Override
        public _FinalStage messages(List<GoogleCalendarCreateEventToolWithToolCallMessagesItem> messages) {
        ...
        public _FinalStage messages(Optional<List<GoogleCalendarCreateEventToolWithToolCallMessagesItem>> messages) {
            this.messages = messages;
            return this;
        }

        @java.lang.Override
        public GoogleCalendarCreateEventToolWithToolCall build() {
            return new GoogleCalendarCreateEventToolWithToolCall(messages, toolCall, function, additionalProperties);
        }
    }
}

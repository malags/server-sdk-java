...
public final class CreateWorkflowDtoVoice {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private CreateWorkflowDtoVoice(Value value) {
        this.value = value;
    }
    ...
    public static CreateWorkflowDtoVoice azure(AzureVoice value) {
        return new CreateWorkflowDtoVoice(new AzureValue(value));
    }

    public static CreateWorkflowDtoVoice cartesia(CartesiaVoice value) {
        return new CreateWorkflowDtoVoice(new CartesiaValue(value));
    }

    public static CreateWorkflowDtoVoice customVoice(CustomVoice value) {
        return new CreateWorkflowDtoVoice(new CustomVoiceValue(value));
    }

    public static CreateWorkflowDtoVoice deepgram(DeepgramVoice value) {
        return new CreateWorkflowDtoVoice(new DeepgramValue(value));
    }

    public static CreateWorkflowDtoVoice _11Labs(ElevenLabsVoice value) {
        return new CreateWorkflowDtoVoice(new _11LabsValue(value));
    }

    public static CreateWorkflowDtoVoice hume(HumeVoice value) {
        return new CreateWorkflowDtoVoice(new HumeValue(value));
    }

    public static CreateWorkflowDtoVoice lmnt(LmntVoice value) {
        return new CreateWorkflowDtoVoice(new LmntValue(value));
    }

    public static CreateWorkflowDtoVoice neuphonic(NeuphonicVoice value) {
        return new CreateWorkflowDtoVoice(new NeuphonicValue(value));
    }

    public static CreateWorkflowDtoVoice openai(OpenAiVoice value) {
        return new CreateWorkflowDtoVoice(new OpenaiValue(value));
    }

    public static CreateWorkflowDtoVoice playht(PlayHtVoice value) {
        return new CreateWorkflowDtoVoice(new PlayhtValue(value));
    }

    public static CreateWorkflowDtoVoice rimeAi(RimeAiVoice value) {
        return new CreateWorkflowDtoVoice(new RimeAiValue(value));
    }

    public static CreateWorkflowDtoVoice smallestAi(SmallestAiVoice value) {
        return new CreateWorkflowDtoVoice(new SmallestAiValue(value));
    }

    public static CreateWorkflowDtoVoice tavus(TavusVoice value) {
        return new CreateWorkflowDtoVoice(new TavusValue(value));
    }

    public static CreateWorkflowDtoVoice vapi(VapiVoice value) {
        return new CreateWorkflowDtoVoice(new VapiValue(value));
    }

    public static CreateWorkflowDtoVoice sesame(SesameVoice value) {
        return new CreateWorkflowDtoVoice(new SesameValue(value));
    }

    public static CreateWorkflowDtoVoice inworld(InworldVoice value) {
        return new CreateWorkflowDtoVoice(new InworldValue(value));
    }
    ...
    private static final class AzureValue implements Value {
        ...
        public String toString() {
            return "CreateWorkflowDtoVoice{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "CreateWorkflowDtoVoice{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

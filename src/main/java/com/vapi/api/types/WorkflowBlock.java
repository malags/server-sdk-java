...
@JsonDeserialize(builder = WorkflowBlock.Builder.class)
public final class WorkflowBlock {
    private final Optional<List<WorkflowBlockMessagesItem>> messages;

    private final Optional<JsonSchema> inputSchema;

    private final Optional<JsonSchema> outputSchema;

    private final Optional<List<WorkflowBlockStepsItem>> steps;
    ...
    private WorkflowBlock(
            Optional<List<WorkflowBlockMessagesItem>> messages,
            Optional<JsonSchema> inputSchema,
            Optional<JsonSchema> outputSchema,
            Optional<List<WorkflowBlockStepsItem>> steps,
            String id,
            String orgId,
    ...
    public Optional<List<WorkflowBlockMessagesItem>> getMessages() {
        return messages;
    }
     ...
     */
    @JsonProperty("steps")
    public Optional<List<WorkflowBlockStepsItem>> getSteps() {
        return steps;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof WorkflowBlock && equalTo((WorkflowBlock) other);
    }
    ...
    private boolean equalTo(WorkflowBlock other) {
    ...
    public interface IdStage {
        ...
        Builder from(WorkflowBlock other);
    }
    ...
    public interface _FinalStage {
        ...
        _FinalStage messages(Optional<List<WorkflowBlockMessagesItem>> messages);

        _FinalStage messages(List<WorkflowBlockMessagesItem> messages);
        ...
        _FinalStage steps(Optional<List<WorkflowBlockStepsItem>> steps);

        _FinalStage steps(List<WorkflowBlockStepsItem> steps);
    ...
    public static final class Builder implements IdStage, OrgIdStage, CreatedAtStage, UpdatedAtStage, _FinalStage {
        ...
        private Optional<List<WorkflowBlockStepsItem>> steps = Optional.empty();

        private Optional<JsonSchema> outputSchema = Optional.empty();

        private Optional<JsonSchema> inputSchema = Optional.empty();

        private Optional<List<WorkflowBlockMessagesItem>> messages = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(WorkflowBlock other) {
        ...
        /**
         * <p>These are the steps in the workflow.</p>
         * @return Reference to {@code this} so that method calls can be chained together.
         */
        @java.lang.Override
        public _FinalStage steps(List<WorkflowBlockStepsItem> steps) {
        ...
        public _FinalStage steps(Optional<List<WorkflowBlockStepsItem>> steps) {
            this.steps = steps;
            return this;
        }
         ...
         */
        @java.lang.Override
        public _FinalStage messages(List<WorkflowBlockMessagesItem> messages) {
        ...
        public _FinalStage messages(Optional<List<WorkflowBlockMessagesItem>> messages) {
            this.messages = messages;
            return this;
        }

        @java.lang.Override
        public WorkflowBlock build() {

...
public final class ToolsDeleteResponse {
    ...
    public static ToolsDeleteResponse apiRequest(ApiRequestTool value) {
        return new ToolsDeleteResponse(new ApiRequestValue(value));
    }
    ...
    public static ToolsDeleteResponse bash(BashTool value) {
        return new ToolsDeleteResponse(new BashValue(value));
    }

    public static ToolsDeleteResponse computer(ComputerTool value) {
        return new ToolsDeleteResponse(new ComputerValue(value));
    }

    public static ToolsDeleteResponse textEditor(TextEditorTool value) {
        return new ToolsDeleteResponse(new TextEditorValue(value));
    }

    public static ToolsDeleteResponse query(QueryTool value) {
        return new ToolsDeleteResponse(new QueryValue(value));
    }

    public static ToolsDeleteResponse googleCalendarEventCreate(GoogleCalendarCreateEventTool value) {
        return new ToolsDeleteResponse(new GoogleCalendarEventCreateValue(value));
    }

    public static ToolsDeleteResponse googleSheetsRowAppend(GoogleSheetsRowAppendTool value) {
        return new ToolsDeleteResponse(new GoogleSheetsRowAppendValue(value));
    }

    public static ToolsDeleteResponse googleCalendarAvailabilityCheck(GoogleCalendarCheckAvailabilityTool value) {
        return new ToolsDeleteResponse(new GoogleCalendarAvailabilityCheckValue(value));
    }

    public static ToolsDeleteResponse slackMessageSend(SlackSendMessageTool value) {
        return new ToolsDeleteResponse(new SlackMessageSendValue(value));
    }

    public static ToolsDeleteResponse sms(SmsTool value) {
        return new ToolsDeleteResponse(new SmsValue(value));
    }

    public static ToolsDeleteResponse mcp(McpTool value) {
        return new ToolsDeleteResponse(new McpValue(value));
    }

    public static ToolsDeleteResponse gohighlevelCalendarAvailabilityCheck(GoHighLevelCalendarAvailabilityTool value) {
        return new ToolsDeleteResponse(new GohighlevelCalendarAvailabilityCheckValue(value));
    }

    public static ToolsDeleteResponse gohighlevelCalendarEventCreate(GoHighLevelCalendarEventCreateTool value) {
        return new ToolsDeleteResponse(new GohighlevelCalendarEventCreateValue(value));
    }

    public static ToolsDeleteResponse gohighlevelContactCreate(GoHighLevelContactCreateTool value) {
        return new ToolsDeleteResponse(new GohighlevelContactCreateValue(value));
    }

    public static ToolsDeleteResponse gohighlevelContactGet(GoHighLevelContactGetTool value) {
        return new ToolsDeleteResponse(new GohighlevelContactGetValue(value));
    }

...
public final class CreateToolTemplateDtoProviderDetails {
    ...
    public static CreateToolTemplateDtoProviderDetails googleCalendarEventCreate(
            GoogleCalendarCreateEventToolProviderDetails value) {
        return new CreateToolTemplateDtoProviderDetails(new GoogleCalendarEventCreateValue(value));
    }

    public static CreateToolTemplateDtoProviderDetails googleSheetsRowAppend(
            GoogleSheetsRowAppendToolProviderDetails value) {
        return new CreateToolTemplateDtoProviderDetails(new GoogleSheetsRowAppendValue(value));
    }

    public static CreateToolTemplateDtoProviderDetails gohighlevelCalendarAvailabilityCheck(
            GoHighLevelCalendarAvailabilityToolProviderDetails value) {
        return new CreateToolTemplateDtoProviderDetails(new GohighlevelCalendarAvailabilityCheckValue(value));
    }

    public static CreateToolTemplateDtoProviderDetails gohighlevelCalendarEventCreate(
            GoHighLevelCalendarEventCreateToolProviderDetails value) {
        return new CreateToolTemplateDtoProviderDetails(new GohighlevelCalendarEventCreateValue(value));
    }

    public static CreateToolTemplateDtoProviderDetails gohighlevelContactCreate(
            GoHighLevelContactCreateToolProviderDetails value) {
        return new CreateToolTemplateDtoProviderDetails(new GohighlevelContactCreateValue(value));
    }

    public static CreateToolTemplateDtoProviderDetails gohighlevelContactGet(
            GoHighLevelContactGetToolProviderDetails value) {
        return new CreateToolTemplateDtoProviderDetails(new GohighlevelContactGetValue(value));
    }

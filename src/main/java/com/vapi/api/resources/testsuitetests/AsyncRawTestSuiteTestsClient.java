...
public class AsyncRawTestSuiteTestsClient {
    protected final ClientOptions clientOptions;

    public AsyncRawTestSuiteTestsClient(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
    }

    public CompletableFuture<VapiHttpResponse<TestSuiteTestsPaginatedResponse>> testSuiteTestControllerFindAllPaginated(
            String testSuiteId) {
    ...
    public CompletableFuture<VapiHttpResponse<TestSuiteTestsPaginatedResponse>> testSuiteTestControllerFindAllPaginated(
        ...
        CompletableFuture<VapiHttpResponse<TestSuiteTestsPaginatedResponse>> future = new CompletableFuture<>();
    ...
    public CompletableFuture<VapiHttpResponse<TestSuiteTestControllerCreateResponse>> testSuiteTestControllerCreate(
    ...
    public CompletableFuture<VapiHttpResponse<TestSuiteTestControllerCreateResponse>> testSuiteTestControllerCreate(
        ...
        CompletableFuture<VapiHttpResponse<TestSuiteTestControllerCreateResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
    ...
    public CompletableFuture<VapiHttpResponse<TestSuiteTestControllerFindOneResponse>> testSuiteTestControllerFindOne(
    ...
    public CompletableFuture<VapiHttpResponse<TestSuiteTestControllerFindOneResponse>> testSuiteTestControllerFindOne(
        ...
        CompletableFuture<VapiHttpResponse<TestSuiteTestControllerFindOneResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
    ...
    public CompletableFuture<VapiHttpResponse<TestSuiteTestControllerRemoveResponse>> testSuiteTestControllerRemove(
            String testSuiteId, String id) {
    ...
    public CompletableFuture<VapiHttpResponse<TestSuiteTestControllerRemoveResponse>> testSuiteTestControllerRemove(
        ...
        CompletableFuture<VapiHttpResponse<TestSuiteTestControllerRemoveResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
    ...
    public CompletableFuture<VapiHttpResponse<TestSuiteTestControllerUpdateResponse>> testSuiteTestControllerUpdate(
    ...
    public CompletableFuture<VapiHttpResponse<TestSuiteTestControllerUpdateResponse>> testSuiteTestControllerUpdate(
        ...
        CompletableFuture<VapiHttpResponse<TestSuiteTestControllerUpdateResponse>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {

...
public class RawSessionsClient {
    ...
    public VapiHttpResponse<SessionPaginatedResponse> list() {
        return list(SessionsListRequest.builder().build());
    }

    public VapiHttpResponse<SessionPaginatedResponse> list(SessionsListRequest request) {
        return list(request, null);
    }

    public VapiHttpResponse<SessionPaginatedResponse> list(SessionsListRequest request, RequestOptions requestOptions) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new VapiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), SessionPaginatedResponse.class),
                        response);
            }
    ...
    public VapiHttpResponse<Session> create() {
        return create(CreateSessionDto.builder().build());
    }

    public VapiHttpResponse<Session> create(CreateSessionDto request) {
        return create(request, null);
    }

    public VapiHttpResponse<Session> create(CreateSessionDto request, RequestOptions requestOptions) {
    ...
    public VapiHttpResponse<Session> get(String id) {
        return get(id, null);
    }

    public VapiHttpResponse<Session> get(String id, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("session")
                .addPathSegment(id)
    ...
    public VapiHttpResponse<Session> delete(String id) {
        return delete(id, null);
    }

    public VapiHttpResponse<Session> delete(String id, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("session")
                .addPathSegment(id)
    ...
    public VapiHttpResponse<Session> update(String id) {
        return update(id, UpdateSessionDto.builder().build());
    }

    public VapiHttpResponse<Session> update(String id, UpdateSessionDto request) {
        return update(id, request, null);
    }

    public VapiHttpResponse<Session> update(String id, UpdateSessionDto request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("session")
                .addPathSegment(id)

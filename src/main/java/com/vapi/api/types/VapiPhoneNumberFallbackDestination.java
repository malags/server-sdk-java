...
public final class VapiPhoneNumberFallbackDestination {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private VapiPhoneNumberFallbackDestination(Value value) {
        this.value = value;
    }
    ...
    public static VapiPhoneNumberFallbackDestination number(TransferDestinationNumber value) {
        return new VapiPhoneNumberFallbackDestination(new NumberValue(value));
    }

    public static VapiPhoneNumberFallbackDestination sip(TransferDestinationSip value) {
        return new VapiPhoneNumberFallbackDestination(new SipValue(value));
    }
    ...
    private static final class NumberValue implements Value {
        ...
        public String toString() {
            return "VapiPhoneNumberFallbackDestination{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "VapiPhoneNumberFallbackDestination{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

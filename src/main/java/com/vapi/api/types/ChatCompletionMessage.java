...
public final class ChatCompletionMessage {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ChatCompletionMessage && equalTo((ChatCompletionMessage) other);
    }
    ...
    private boolean equalTo(ChatCompletionMessage other) {
    ...
    public static final class Builder {
        ...
        public Builder from(ChatCompletionMessage other) {
            role(other.getRole());
        ...
        public ChatCompletionMessage build() {
            return new ChatCompletionMessage(role, content, metadata, additionalProperties);
        }
    }
}

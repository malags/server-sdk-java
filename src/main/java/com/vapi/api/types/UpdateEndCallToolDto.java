...
@JsonDeserialize(builder = UpdateEndCallToolDto.Builder.class)
public final class UpdateEndCallToolDto {
    private final Optional<List<UpdateEndCallToolDtoMessagesItem>> messages;

    private final Optional<OpenAiFunction> function;

    private final Map<String, Object> additionalProperties;

    private UpdateEndCallToolDto(
            Optional<List<UpdateEndCallToolDtoMessagesItem>> messages,
    ...
    public Optional<List<UpdateEndCallToolDtoMessagesItem>> getMessages() {
        return messages;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateEndCallToolDto && equalTo((UpdateEndCallToolDto) other);
    }
    ...
    private boolean equalTo(UpdateEndCallToolDto other) {
    ...
    public static final class Builder {
        private Optional<List<UpdateEndCallToolDtoMessagesItem>> messages = Optional.empty();
        ...
        public Builder from(UpdateEndCallToolDto other) {
        ...
        public Builder messages(Optional<List<UpdateEndCallToolDtoMessagesItem>> messages) {
            this.messages = messages;
            return this;
        }

        public Builder messages(List<UpdateEndCallToolDtoMessagesItem> messages) {
        ...
        public UpdateEndCallToolDto build() {
            return new UpdateEndCallToolDto(messages, function, additionalProperties);
        }
    }
}

...
public final class XaiModelToolsItem {
    ...
    public static XaiModelToolsItem voicemail(CreateVoicemailToolDto value) {
        return new XaiModelToolsItem(new VoicemailValue(value));
    }
    ...
    public static XaiModelToolsItem ghl(CreateGhlToolDto value) {
        return new XaiModelToolsItem(new GhlValue(value));
    }

    public static XaiModelToolsItem make(CreateMakeToolDto value) {
        return new XaiModelToolsItem(new MakeValue(value));
    }

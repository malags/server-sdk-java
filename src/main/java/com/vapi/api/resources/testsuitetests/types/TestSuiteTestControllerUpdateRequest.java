...
public final class TestSuiteTestControllerUpdateRequest {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private TestSuiteTestControllerUpdateRequest(Value value) {
        this.value = value;
    }
    ...
    public static TestSuiteTestControllerUpdateRequest voice(UpdateTestSuiteTestVoiceDto value) {
    ...
    private static final class VoiceValue implements Value {
        @JsonUnwrapped
        private UpdateTestSuiteTestVoiceDto value;

        @JsonCreator(mode = JsonCreator.Mode.PROPERTIES)
        private VoiceValue() {}

        private VoiceValue(UpdateTestSuiteTestVoiceDto value) {
            this.value = value;
        }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "TestSuiteTestControllerUpdateRequest{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

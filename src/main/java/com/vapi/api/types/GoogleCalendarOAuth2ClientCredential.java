...
@JsonDeserialize(builder = GoogleCalendarOAuth2ClientCredential.Builder.class)
public final class GoogleCalendarOAuth2ClientCredential {
    ...
    private GoogleCalendarOAuth2ClientCredential(
            String id,
            String orgId,
    ...
    public String getProvider() {
        return "google.calendar.oauth2-client";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GoogleCalendarOAuth2ClientCredential
                && equalTo((GoogleCalendarOAuth2ClientCredential) other);
    }
    ...
    private boolean equalTo(GoogleCalendarOAuth2ClientCredential other) {
    ...
    @java.lang.Override
    public int hashCode() {
        return Objects.hash(this.id, this.orgId, this.createdAt, this.updatedAt, this.name);
    }
    ...
    public interface IdStage {
        ...
        Builder from(GoogleCalendarOAuth2ClientCredential other);
    }
    ...
    public interface _FinalStage {
        GoogleCalendarOAuth2ClientCredential build();
    ...
    public static final class Builder implements IdStage, OrgIdStage, CreatedAtStage, UpdatedAtStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(GoogleCalendarOAuth2ClientCredential other) {
            id(other.getId());
        ...
        @java.lang.Override
        public GoogleCalendarOAuth2ClientCredential build() {
            return new GoogleCalendarOAuth2ClientCredential(
                    id, orgId, createdAt, updatedAt, name, additionalProperties);
        }
    }
}

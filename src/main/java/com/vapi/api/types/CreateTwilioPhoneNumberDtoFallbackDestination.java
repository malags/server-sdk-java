...
public final class CreateTwilioPhoneNumberDtoFallbackDestination {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private CreateTwilioPhoneNumberDtoFallbackDestination(Value value) {
        this.value = value;
    }
    ...
    public static CreateTwilioPhoneNumberDtoFallbackDestination number(TransferDestinationNumber value) {
        return new CreateTwilioPhoneNumberDtoFallbackDestination(new NumberValue(value));
    }

    public static CreateTwilioPhoneNumberDtoFallbackDestination sip(TransferDestinationSip value) {
        return new CreateTwilioPhoneNumberDtoFallbackDestination(new SipValue(value));
    }
    ...
    private static final class NumberValue implements Value {
        ...
        public String toString() {
            return "CreateTwilioPhoneNumberDtoFallbackDestination{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "CreateTwilioPhoneNumberDtoFallbackDestination{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

...
public final class WorkflowUserEditable {
    ...
    private final Optional<WorkflowUserEditableTranscriber> transcriber;

    private final Optional<WorkflowUserEditableVoice> voice;

    private final Optional<LangfuseObservabilityPlan> observabilityPlan;

    private final Optional<WorkflowUserEditableBackgroundSound> backgroundSound;

    private final Optional<List<WorkflowUserEditableCredentialsItem>> credentials;
    ...
    private WorkflowUserEditable(
            ...
            Optional<WorkflowUserEditableTranscriber> transcriber,
            Optional<WorkflowUserEditableVoice> voice,
            Optional<LangfuseObservabilityPlan> observabilityPlan,
            Optional<WorkflowUserEditableBackgroundSound> backgroundSound,
            Optional<List<WorkflowUserEditableCredentialsItem>> credentials,
            String name,
            List<Edge> edges,
    ...
    public Optional<WorkflowUserEditableTranscriber> getTranscriber() {
        return transcriber;
    }
     ...
     */
    @JsonProperty("voice")
    public Optional<WorkflowUserEditableVoice> getVoice() {
        return voice;
    }
    ...
    public Optional<WorkflowUserEditableBackgroundSound> getBackgroundSound() {
    ...
    public Optional<List<WorkflowUserEditableCredentialsItem>> getCredentials() {
        return credentials;
    }
    ...
    public interface _FinalStage {
         ...
         * <p>This can be overridden at node level using <code>nodes[n].transcriber</code>.</p>
         */
        _FinalStage transcriber(Optional<WorkflowUserEditableTranscriber> transcriber);

        _FinalStage transcriber(WorkflowUserEditableTranscriber transcriber);

        /**
         * <p>This is the voice for the workflow.</p>
         * <p>This can be overridden at node level using <code>nodes[n].voice</code>.</p>
         */
        _FinalStage voice(Optional<WorkflowUserEditableVoice> voice);

        _FinalStage voice(WorkflowUserEditableVoice voice);
         ...
         */
        _FinalStage backgroundSound(Optional<WorkflowUserEditableBackgroundSound> backgroundSound);

        _FinalStage backgroundSound(WorkflowUserEditableBackgroundSound backgroundSound);
         ...
         */
        _FinalStage credentials(Optional<List<WorkflowUserEditableCredentialsItem>> credentials);

        _FinalStage credentials(List<WorkflowUserEditableCredentialsItem> credentials);
    ...
    public static final class Builder implements NameStage, _FinalStage {
        ...
        private Optional<List<WorkflowUserEditableCredentialsItem>> credentials = Optional.empty();

        private Optional<WorkflowUserEditableBackgroundSound> backgroundSound = Optional.empty();

        private Optional<LangfuseObservabilityPlan> observabilityPlan = Optional.empty();

        private Optional<WorkflowUserEditableVoice> voice = Optional.empty();

        private Optional<WorkflowUserEditableTranscriber> transcriber = Optional.empty();
         ...
         */
        @java.lang.Override
        public _FinalStage credentials(List<WorkflowUserEditableCredentialsItem> credentials) {
        ...
        public _FinalStage credentials(Optional<List<WorkflowUserEditableCredentialsItem>> credentials) {
            this.credentials = credentials;
            return this;
        }
         ...
         */
        @java.lang.Override
        public _FinalStage backgroundSound(WorkflowUserEditableBackgroundSound backgroundSound) {
        ...
        public _FinalStage backgroundSound(Optional<WorkflowUserEditableBackgroundSound> backgroundSound) {
            this.backgroundSound = backgroundSound;
            return this;
        }
         ...
         */
        @java.lang.Override
        public _FinalStage voice(WorkflowUserEditableVoice voice) {
        ...
        public _FinalStage voice(Optional<WorkflowUserEditableVoice> voice) {
            this.voice = voice;
            return this;
        }
         ...
         */
        @java.lang.Override
        public _FinalStage transcriber(WorkflowUserEditableTranscriber transcriber) {
        ...
        public _FinalStage transcriber(Optional<WorkflowUserEditableTranscriber> transcriber) {
            this.transcriber = transcriber;
            return this;
        }
        ...
        public WorkflowUserEditable build() {
            return new WorkflowUserEditable(
                    nodes,
                    transcriber,
                    voice,
                    observabilityPlan,

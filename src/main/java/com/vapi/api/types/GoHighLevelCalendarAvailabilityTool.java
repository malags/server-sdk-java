...
@JsonDeserialize(builder = GoHighLevelCalendarAvailabilityTool.Builder.class)
public final class GoHighLevelCalendarAvailabilityTool {
    private final Optional<List<GoHighLevelCalendarAvailabilityToolMessagesItem>> messages;
    ...
    private GoHighLevelCalendarAvailabilityTool(
            Optional<List<GoHighLevelCalendarAvailabilityToolMessagesItem>> messages,
            String id,
            String orgId,
    ...
    public Optional<List<GoHighLevelCalendarAvailabilityToolMessagesItem>> getMessages() {
        return messages;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GoHighLevelCalendarAvailabilityTool
                && equalTo((GoHighLevelCalendarAvailabilityTool) other);
    }
    ...
    private boolean equalTo(GoHighLevelCalendarAvailabilityTool other) {
    ...
    public interface IdStage {
        ...
        Builder from(GoHighLevelCalendarAvailabilityTool other);
    }
    ...
    public interface _FinalStage {
        GoHighLevelCalendarAvailabilityTool build();

        /**
         * <p>These are the messages that will be spoken to the user as the tool is running.</p>
         * <p>For some tools, this is auto-filled based on special fields like <code>tool.destinations</code>. For others like the function tool, these can be custom configured.</p>
         */
        _FinalStage messages(Optional<List<GoHighLevelCalendarAvailabilityToolMessagesItem>> messages);

        _FinalStage messages(List<GoHighLevelCalendarAvailabilityToolMessagesItem> messages);
    ...
    public static final class Builder implements IdStage, OrgIdStage, CreatedAtStage, UpdatedAtStage, _FinalStage {
        ...
        private Optional<List<GoHighLevelCalendarAvailabilityToolMessagesItem>> messages = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(GoHighLevelCalendarAvailabilityTool other) {
         ...
         */
        @java.lang.Override
        public _FinalStage messages(List<GoHighLevelCalendarAvailabilityToolMessagesItem> messages) {
        ...
        public _FinalStage messages(Optional<List<GoHighLevelCalendarAvailabilityToolMessagesItem>> messages) {
            this.messages = messages;
            return this;
        }

        @java.lang.Override
        public GoHighLevelCalendarAvailabilityTool build() {
            return new GoHighLevelCalendarAvailabilityTool(

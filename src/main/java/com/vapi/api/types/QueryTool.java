...
@JsonDeserialize(builder = QueryTool.Builder.class)
public final class QueryTool {
    private final Optional<List<QueryToolMessagesItem>> messages;
    ...
    private QueryTool(
            Optional<List<QueryToolMessagesItem>> messages,
    ...
    public Optional<List<QueryToolMessagesItem>> getMessages() {
        return messages;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof QueryTool && equalTo((QueryTool) other);
    }
    ...
    private boolean equalTo(QueryTool other) {
    ...
    public int hashCode() {
        return Objects.hash(
                this.messages, this.knowledgeBases, this.id, this.orgId, this.createdAt, this.updatedAt, this.function);
    }
    ...
    public interface _FinalStage {
         ...
         * <p>For some tools, this is auto-filled based on special fields like <code>tool.destinations</code>. For others like the function tool, these can be custom configured.</p>
         */
        _FinalStage messages(Optional<List<QueryToolMessagesItem>> messages);

        _FinalStage messages(List<QueryToolMessagesItem> messages);

        /**
         * <p>The knowledge bases to query</p>
         */
        _FinalStage knowledgeBases(Optional<List<KnowledgeBase>> knowledgeBases);

        _FinalStage knowledgeBases(List<KnowledgeBase> knowledgeBases);
    ...
    public static final class Builder implements IdStage, OrgIdStage, CreatedAtStage, UpdatedAtStage, _FinalStage {
        ...
        private Optional<List<QueryToolMessagesItem>> messages = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(QueryTool other) {
         ...
         */
        @java.lang.Override
        public _FinalStage knowledgeBases(List<KnowledgeBase> knowledgeBases) {
        ...
        public _FinalStage knowledgeBases(Optional<List<KnowledgeBase>> knowledgeBases) {
            this.knowledgeBases = knowledgeBases;
            return this;
        }
         ...
         */
        @java.lang.Override
        public _FinalStage messages(List<QueryToolMessagesItem> messages) {
        ...
        public _FinalStage messages(Optional<List<QueryToolMessagesItem>> messages) {
            this.messages = messages;
            return this;
        }

        @java.lang.Override
        public QueryTool build() {
            return new QueryTool(
                    messages, knowledgeBases, id, orgId, createdAt, updatedAt, function, additionalProperties);
        }
    }
}

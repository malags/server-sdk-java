...
public final class UpdateGoHighLevelCalendarAvailabilityToolDtoMessagesItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private UpdateGoHighLevelCalendarAvailabilityToolDtoMessagesItem(Value value) {
        this.value = value;
    }
    ...
    public static UpdateGoHighLevelCalendarAvailabilityToolDtoMessagesItem requestStart(ToolMessageStart value) {
        return new UpdateGoHighLevelCalendarAvailabilityToolDtoMessagesItem(new RequestStartValue(value));
    }

    public static UpdateGoHighLevelCalendarAvailabilityToolDtoMessagesItem requestComplete(ToolMessageComplete value) {
        return new UpdateGoHighLevelCalendarAvailabilityToolDtoMessagesItem(new RequestCompleteValue(value));
    }

    public static UpdateGoHighLevelCalendarAvailabilityToolDtoMessagesItem requestFailed(ToolMessageFailed value) {
        return new UpdateGoHighLevelCalendarAvailabilityToolDtoMessagesItem(new RequestFailedValue(value));
    }

    public static UpdateGoHighLevelCalendarAvailabilityToolDtoMessagesItem requestResponseDelayed(
            ToolMessageDelayed value) {
        return new UpdateGoHighLevelCalendarAvailabilityToolDtoMessagesItem(new RequestResponseDelayedValue(value));
    }
    ...
    private static final class RequestStartValue implements Value {
        ...
        public String toString() {
            return "UpdateGoHighLevelCalendarAvailabilityToolDtoMessagesItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "UpdateGoHighLevelCalendarAvailabilityToolDtoMessagesItem{" + "type: " + type + ", value: " + value
                    + "}";
        }
    }
}

...
public final class CreateAssistantDtoHooksItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private CreateAssistantDtoHooksItem(Value value) {
        this.value = value;
    }
    ...
    public static CreateAssistantDtoHooksItem callEnding(AssistantHookCallEnding value) {
        return new CreateAssistantDtoHooksItem(new CallEndingValue(value));
    }

    public static CreateAssistantDtoHooksItem assistantSpeechInterrupted(
            AssistantHookAssistantSpeechInterrupted value) {
        return new CreateAssistantDtoHooksItem(new AssistantSpeechInterruptedValue(value));
    }

    public static CreateAssistantDtoHooksItem customerSpeechInterrupted(AssistantHookCustomerSpeechInterrupted value) {
        return new CreateAssistantDtoHooksItem(new CustomerSpeechInterruptedValue(value));
    }
    ...
    private static final class CallEndingValue implements Value {
        ...
        public String toString() {
            return "CreateAssistantDtoHooksItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "CreateAssistantDtoHooksItem{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

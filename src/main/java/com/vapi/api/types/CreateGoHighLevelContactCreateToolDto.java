...
@JsonDeserialize(builder = CreateGoHighLevelContactCreateToolDto.Builder.class)
public final class CreateGoHighLevelContactCreateToolDto {
    private final Optional<List<CreateGoHighLevelContactCreateToolDtoMessagesItem>> messages;

    private final Optional<OpenAiFunction> function;

    private final Map<String, Object> additionalProperties;

    private CreateGoHighLevelContactCreateToolDto(
            Optional<List<CreateGoHighLevelContactCreateToolDtoMessagesItem>> messages,
    ...
    public Optional<List<CreateGoHighLevelContactCreateToolDtoMessagesItem>> getMessages() {
        return messages;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateGoHighLevelContactCreateToolDto
                && equalTo((CreateGoHighLevelContactCreateToolDto) other);
    }
    ...
    private boolean equalTo(CreateGoHighLevelContactCreateToolDto other) {
    ...
    public static final class Builder {
        private Optional<List<CreateGoHighLevelContactCreateToolDtoMessagesItem>> messages = Optional.empty();
        ...
        public Builder from(CreateGoHighLevelContactCreateToolDto other) {
        ...
        public Builder messages(Optional<List<CreateGoHighLevelContactCreateToolDtoMessagesItem>> messages) {
            this.messages = messages;
            return this;
        }

        public Builder messages(List<CreateGoHighLevelContactCreateToolDtoMessagesItem> messages) {
        ...
        public CreateGoHighLevelContactCreateToolDto build() {
            return new CreateGoHighLevelContactCreateToolDto(messages, function, additionalProperties);
        }
    }
}

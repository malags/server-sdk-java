...
public final class UpdateTwilioCredentialDto {
    ...
    private UpdateTwilioCredentialDto(String authToken, String accountSid, Map<String, Object> additionalProperties) {
    ...
    public static final class Builder implements AuthTokenStage, AccountSidStage, _FinalStage {
        ...
        public UpdateTwilioCredentialDto build() {
            return new UpdateTwilioCredentialDto(authToken, accountSid, additionalProperties);
        }
    }
}

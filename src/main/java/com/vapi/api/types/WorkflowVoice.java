...
public final class WorkflowVoice {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private WorkflowVoice(Value value) {
        this.value = value;
    }
    ...
    public static WorkflowVoice azure(AzureVoice value) {
        return new WorkflowVoice(new AzureValue(value));
    }

    public static WorkflowVoice cartesia(CartesiaVoice value) {
        return new WorkflowVoice(new CartesiaValue(value));
    }

    public static WorkflowVoice customVoice(CustomVoice value) {
        return new WorkflowVoice(new CustomVoiceValue(value));
    }

    public static WorkflowVoice deepgram(DeepgramVoice value) {
        return new WorkflowVoice(new DeepgramValue(value));
    }

    public static WorkflowVoice _11Labs(ElevenLabsVoice value) {
        return new WorkflowVoice(new _11LabsValue(value));
    }

    public static WorkflowVoice hume(HumeVoice value) {
        return new WorkflowVoice(new HumeValue(value));
    }

    public static WorkflowVoice lmnt(LmntVoice value) {
        return new WorkflowVoice(new LmntValue(value));
    }

    public static WorkflowVoice neuphonic(NeuphonicVoice value) {
        return new WorkflowVoice(new NeuphonicValue(value));
    }

    public static WorkflowVoice openai(OpenAiVoice value) {
        return new WorkflowVoice(new OpenaiValue(value));
    }

    public static WorkflowVoice playht(PlayHtVoice value) {
        return new WorkflowVoice(new PlayhtValue(value));
    }

    public static WorkflowVoice rimeAi(RimeAiVoice value) {
        return new WorkflowVoice(new RimeAiValue(value));
    }

    public static WorkflowVoice smallestAi(SmallestAiVoice value) {
        return new WorkflowVoice(new SmallestAiValue(value));
    }

    public static WorkflowVoice tavus(TavusVoice value) {
        return new WorkflowVoice(new TavusValue(value));
    }

    public static WorkflowVoice vapi(VapiVoice value) {
        return new WorkflowVoice(new VapiValue(value));
    }

    public static WorkflowVoice sesame(SesameVoice value) {
        return new WorkflowVoice(new SesameValue(value));
    }

    public static WorkflowVoice inworld(InworldVoice value) {
        return new WorkflowVoice(new InworldValue(value));
    }
    ...
    private static final class AzureValue implements Value {
        ...
        public String toString() {
            return "WorkflowVoice{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "WorkflowVoice{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

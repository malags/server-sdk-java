...
@JsonDeserialize(builder = UpdateGoogleCredentialDto.Builder.class)
public final class UpdateGoogleCredentialDto {
    ...
    private UpdateGoogleCredentialDto(String apiKey, Optional<String> name, Map<String, Object> additionalProperties) {
        this.apiKey = apiKey;
        this.name = name;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateGoogleCredentialDto && equalTo((UpdateGoogleCredentialDto) other);
    }
    ...
    private boolean equalTo(UpdateGoogleCredentialDto other) {
    ...
    public interface ApiKeyStage {
        ...
        Builder from(UpdateGoogleCredentialDto other);
    }

    public interface _FinalStage {
        UpdateGoogleCredentialDto build();
    ...
    public static final class Builder implements ApiKeyStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(UpdateGoogleCredentialDto other) {
        ...
        public UpdateGoogleCredentialDto build() {
            return new UpdateGoogleCredentialDto(apiKey, name, additionalProperties);
        }
    }
}

...
@JsonDeserialize(builder = UpdateGoogleCalendarCheckAvailabilityToolDto.Builder.class)
public final class UpdateGoogleCalendarCheckAvailabilityToolDto {
    private final Optional<List<UpdateGoogleCalendarCheckAvailabilityToolDtoMessagesItem>> messages;

    private final Optional<OpenAiFunction> function;

    private final Map<String, Object> additionalProperties;

    private UpdateGoogleCalendarCheckAvailabilityToolDto(
            Optional<List<UpdateGoogleCalendarCheckAvailabilityToolDtoMessagesItem>> messages,
    ...
    public Optional<List<UpdateGoogleCalendarCheckAvailabilityToolDtoMessagesItem>> getMessages() {
        return messages;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateGoogleCalendarCheckAvailabilityToolDto
                && equalTo((UpdateGoogleCalendarCheckAvailabilityToolDto) other);
    }
    ...
    private boolean equalTo(UpdateGoogleCalendarCheckAvailabilityToolDto other) {
    ...
    public static final class Builder {
        private Optional<List<UpdateGoogleCalendarCheckAvailabilityToolDtoMessagesItem>> messages = Optional.empty();
        ...
        public Builder from(UpdateGoogleCalendarCheckAvailabilityToolDto other) {
        ...
        public Builder messages(Optional<List<UpdateGoogleCalendarCheckAvailabilityToolDtoMessagesItem>> messages) {
            this.messages = messages;
            return this;
        }

        public Builder messages(List<UpdateGoogleCalendarCheckAvailabilityToolDtoMessagesItem> messages) {
        ...
        public UpdateGoogleCalendarCheckAvailabilityToolDto build() {
            return new UpdateGoogleCalendarCheckAvailabilityToolDto(messages, function, additionalProperties);
        }
    }
}

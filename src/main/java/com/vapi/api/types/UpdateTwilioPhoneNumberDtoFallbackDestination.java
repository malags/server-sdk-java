...
public final class UpdateTwilioPhoneNumberDtoFallbackDestination {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private UpdateTwilioPhoneNumberDtoFallbackDestination(Value value) {
        this.value = value;
    }
    ...
    public static UpdateTwilioPhoneNumberDtoFallbackDestination number(TransferDestinationNumber value) {
        return new UpdateTwilioPhoneNumberDtoFallbackDestination(new NumberValue(value));
    }

    public static UpdateTwilioPhoneNumberDtoFallbackDestination sip(TransferDestinationSip value) {
        return new UpdateTwilioPhoneNumberDtoFallbackDestination(new SipValue(value));
    }
    ...
    private static final class NumberValue implements Value {
        ...
        public String toString() {
            return "UpdateTwilioPhoneNumberDtoFallbackDestination{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "UpdateTwilioPhoneNumberDtoFallbackDestination{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

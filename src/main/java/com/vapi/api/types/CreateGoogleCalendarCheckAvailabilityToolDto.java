...
@JsonDeserialize(builder = CreateGoogleCalendarCheckAvailabilityToolDto.Builder.class)
public final class CreateGoogleCalendarCheckAvailabilityToolDto {
    private final Optional<List<CreateGoogleCalendarCheckAvailabilityToolDtoMessagesItem>> messages;

    private final Optional<OpenAiFunction> function;

    private final Map<String, Object> additionalProperties;

    private CreateGoogleCalendarCheckAvailabilityToolDto(
            Optional<List<CreateGoogleCalendarCheckAvailabilityToolDtoMessagesItem>> messages,
    ...
    public Optional<List<CreateGoogleCalendarCheckAvailabilityToolDtoMessagesItem>> getMessages() {
        return messages;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateGoogleCalendarCheckAvailabilityToolDto
                && equalTo((CreateGoogleCalendarCheckAvailabilityToolDto) other);
    }
    ...
    private boolean equalTo(CreateGoogleCalendarCheckAvailabilityToolDto other) {
    ...
    public static final class Builder {
        private Optional<List<CreateGoogleCalendarCheckAvailabilityToolDtoMessagesItem>> messages = Optional.empty();
        ...
        public Builder from(CreateGoogleCalendarCheckAvailabilityToolDto other) {
        ...
        public Builder messages(Optional<List<CreateGoogleCalendarCheckAvailabilityToolDtoMessagesItem>> messages) {
            this.messages = messages;
            return this;
        }

        public Builder messages(List<CreateGoogleCalendarCheckAvailabilityToolDtoMessagesItem> messages) {
        ...
        public CreateGoogleCalendarCheckAvailabilityToolDto build() {
            return new CreateGoogleCalendarCheckAvailabilityToolDto(messages, function, additionalProperties);
        }
    }
}

...
@JsonDeserialize(builder = UpdateGoHighLevelCalendarEventCreateToolDto.Builder.class)
public final class UpdateGoHighLevelCalendarEventCreateToolDto {
    private final Optional<List<UpdateGoHighLevelCalendarEventCreateToolDtoMessagesItem>> messages;

    private final Optional<OpenAiFunction> function;

    private final Map<String, Object> additionalProperties;

    private UpdateGoHighLevelCalendarEventCreateToolDto(
            Optional<List<UpdateGoHighLevelCalendarEventCreateToolDtoMessagesItem>> messages,
    ...
    public Optional<List<UpdateGoHighLevelCalendarEventCreateToolDtoMessagesItem>> getMessages() {
        return messages;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateGoHighLevelCalendarEventCreateToolDto
                && equalTo((UpdateGoHighLevelCalendarEventCreateToolDto) other);
    }
    ...
    private boolean equalTo(UpdateGoHighLevelCalendarEventCreateToolDto other) {
    ...
    public static final class Builder {
        private Optional<List<UpdateGoHighLevelCalendarEventCreateToolDtoMessagesItem>> messages = Optional.empty();
        ...
        public Builder from(UpdateGoHighLevelCalendarEventCreateToolDto other) {
        ...
        public Builder messages(Optional<List<UpdateGoHighLevelCalendarEventCreateToolDtoMessagesItem>> messages) {
            this.messages = messages;
            return this;
        }

        public Builder messages(List<UpdateGoHighLevelCalendarEventCreateToolDtoMessagesItem> messages) {
        ...
        public UpdateGoHighLevelCalendarEventCreateToolDto build() {
            return new UpdateGoHighLevelCalendarEventCreateToolDto(messages, function, additionalProperties);
        }
    }
}

...
import com.vapi.api.resources.sessions.types.SessionsListRequestSortOrder;
...
@JsonDeserialize(builder = SessionsListRequest.Builder.class)
public final class SessionsListRequest {
    ...
    private final Optional<SessionsListRequestSortOrder> sortOrder;
    ...
    private SessionsListRequest(
            Optional<String> name,
            Optional<String> assistantId,
            Optional<String> workflowId,
            Optional<Double> page,
            Optional<SessionsListRequestSortOrder> sortOrder,
    ...
    /**
     * @return This is the name of the session to filter by.
     */
    @JsonIgnore
    ...
    /**
     * @return This is the ID of the assistant to filter sessions by.
     */
    @JsonIgnore
    ...
    /**
     * @return This is the ID of the workflow to filter sessions by.
     */
    @JsonIgnore
     ...
     */
    @JsonIgnore
    public Optional<SessionsListRequestSortOrder> getSortOrder() {
        if (sortOrder == null) {
            return Optional.empty();
        }
        return sortOrder;
    ...
    private Optional<String> _getWorkflowId() {
        return workflowId;
    }
    ...
    private Optional<SessionsListRequestSortOrder> _getSortOrder() {
        return sortOrder;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof SessionsListRequest && equalTo((SessionsListRequest) other);
    }
    ...
    private boolean equalTo(SessionsListRequest other) {
    ...
    public static final class Builder {
        ...
        private Optional<SessionsListRequestSortOrder> sortOrder = Optional.empty();
        ...
        public Builder from(SessionsListRequest other) {
            name(other.getName());
        ...
        /**
         * <p>This is the name of the session to filter by.</p>
         */
        ...
        /**
         * <p>This is the ID of the assistant to filter sessions by.</p>
         */
        ...
        /**
         * <p>This is the ID of the workflow to filter sessions by.</p>
         */
        ...
        public Builder workflowId(Nullable<String> workflowId) {
            ...
            } else if (workflowId.isEmpty()) {
                this.workflowId = Optional.empty();
            } else {
                this.workflowId = Optional.of(workflowId.get());
            }
            return this;
        }
        ...
        public Builder sortOrder(Optional<SessionsListRequestSortOrder> sortOrder) {
            this.sortOrder = sortOrder;
            return this;
        }

        public Builder sortOrder(SessionsListRequestSortOrder sortOrder) {
            this.sortOrder = Optional.ofNullable(sortOrder);
            return this;
        }

        public Builder sortOrder(Nullable<SessionsListRequestSortOrder> sortOrder) {
            if (sortOrder.isNull()) {
                this.sortOrder = null;
        ...
        public SessionsListRequest build() {
            return new SessionsListRequest(
                    name,
                    assistantId,
                    workflowId,
                    page,

...
public final class WorkflowUserEditableTranscriber {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private WorkflowUserEditableTranscriber(Value value) {
        this.value = value;
    }
    ...
    public static WorkflowUserEditableTranscriber assemblyAi(AssemblyAiTranscriber value) {
        return new WorkflowUserEditableTranscriber(new AssemblyAiValue(value));
    }

    public static WorkflowUserEditableTranscriber azure(AzureSpeechTranscriber value) {
        return new WorkflowUserEditableTranscriber(new AzureValue(value));
    }

    public static WorkflowUserEditableTranscriber customTranscriber(CustomTranscriber value) {
        return new WorkflowUserEditableTranscriber(new CustomTranscriberValue(value));
    }

    public static WorkflowUserEditableTranscriber deepgram(DeepgramTranscriber value) {
        return new WorkflowUserEditableTranscriber(new DeepgramValue(value));
    }

    public static WorkflowUserEditableTranscriber _11Labs(ElevenLabsTranscriber value) {
        return new WorkflowUserEditableTranscriber(new _11LabsValue(value));
    }

    public static WorkflowUserEditableTranscriber gladia(GladiaTranscriber value) {
        return new WorkflowUserEditableTranscriber(new GladiaValue(value));
    }

    public static WorkflowUserEditableTranscriber google(GoogleTranscriber value) {
        return new WorkflowUserEditableTranscriber(new GoogleValue(value));
    }

    public static WorkflowUserEditableTranscriber speechmatics(SpeechmaticsTranscriber value) {
        return new WorkflowUserEditableTranscriber(new SpeechmaticsValue(value));
    }

    public static WorkflowUserEditableTranscriber talkscriber(TalkscriberTranscriber value) {
        return new WorkflowUserEditableTranscriber(new TalkscriberValue(value));
    }

    public static WorkflowUserEditableTranscriber openai(OpenAiTranscriber value) {
        return new WorkflowUserEditableTranscriber(new OpenaiValue(value));
    }

    public static WorkflowUserEditableTranscriber cartesia(CartesiaTranscriber value) {
        return new WorkflowUserEditableTranscriber(new CartesiaValue(value));
    }
    ...
    private static final class AssemblyAiValue implements Value {
        ...
        public String toString() {
            return "WorkflowUserEditableTranscriber{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "WorkflowUserEditableTranscriber{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

...
public final class ApiRequestToolMessagesItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private ApiRequestToolMessagesItem(Value value) {
        this.value = value;
    }
    ...
    public static ApiRequestToolMessagesItem requestStart(ToolMessageStart value) {
        return new ApiRequestToolMessagesItem(new RequestStartValue(value));
    }

    public static ApiRequestToolMessagesItem requestComplete(ToolMessageComplete value) {
        return new ApiRequestToolMessagesItem(new RequestCompleteValue(value));
    }

    public static ApiRequestToolMessagesItem requestFailed(ToolMessageFailed value) {
        return new ApiRequestToolMessagesItem(new RequestFailedValue(value));
    }

    public static ApiRequestToolMessagesItem requestResponseDelayed(ToolMessageDelayed value) {
        return new ApiRequestToolMessagesItem(new RequestResponseDelayedValue(value));
    }
    ...
    private static final class RequestStartValue implements Value {
        ...
        public String toString() {
            return "ApiRequestToolMessagesItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "ApiRequestToolMessagesItem{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

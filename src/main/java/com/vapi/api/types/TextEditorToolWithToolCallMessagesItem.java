...
public final class TextEditorToolWithToolCallMessagesItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private TextEditorToolWithToolCallMessagesItem(Value value) {
        this.value = value;
    }
    ...
    public static TextEditorToolWithToolCallMessagesItem requestStart(ToolMessageStart value) {
        return new TextEditorToolWithToolCallMessagesItem(new RequestStartValue(value));
    }

    public static TextEditorToolWithToolCallMessagesItem requestComplete(ToolMessageComplete value) {
        return new TextEditorToolWithToolCallMessagesItem(new RequestCompleteValue(value));
    }

    public static TextEditorToolWithToolCallMessagesItem requestFailed(ToolMessageFailed value) {
        return new TextEditorToolWithToolCallMessagesItem(new RequestFailedValue(value));
    }

    public static TextEditorToolWithToolCallMessagesItem requestResponseDelayed(ToolMessageDelayed value) {
        return new TextEditorToolWithToolCallMessagesItem(new RequestResponseDelayedValue(value));
    }
    ...
    private static final class RequestStartValue implements Value {
        ...
        public String toString() {
            return "TextEditorToolWithToolCallMessagesItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "TextEditorToolWithToolCallMessagesItem{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

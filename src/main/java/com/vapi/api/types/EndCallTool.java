...
@JsonDeserialize(builder = EndCallTool.Builder.class)
public final class EndCallTool {
    private final Optional<List<EndCallToolMessagesItem>> messages;
    ...
    private EndCallTool(
            Optional<List<EndCallToolMessagesItem>> messages,
            String id,
            String orgId,
    ...
    public Optional<List<EndCallToolMessagesItem>> getMessages() {
        return messages;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof EndCallTool && equalTo((EndCallTool) other);
    }
    ...
    private boolean equalTo(EndCallTool other) {
    ...
    public interface IdStage {
        ...
        Builder from(EndCallTool other);
    }
    ...
    public interface _FinalStage {
         ...
         * <p>For some tools, this is auto-filled based on special fields like <code>tool.destinations</code>. For others like the function tool, these can be custom configured.</p>
         */
        _FinalStage messages(Optional<List<EndCallToolMessagesItem>> messages);

        _FinalStage messages(List<EndCallToolMessagesItem> messages);
    ...
    public static final class Builder implements IdStage, OrgIdStage, CreatedAtStage, UpdatedAtStage, _FinalStage {
        ...
        private Optional<List<EndCallToolMessagesItem>> messages = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(EndCallTool other) {
         ...
         */
        @java.lang.Override
        public _FinalStage messages(List<EndCallToolMessagesItem> messages) {
        ...
        public _FinalStage messages(Optional<List<EndCallToolMessagesItem>> messages) {
            this.messages = messages;
            return this;
        }

        @java.lang.Override
        public EndCallTool build() {
            return new EndCallTool(messages, id, orgId, createdAt, updatedAt, function, additionalProperties);
        }
    }
}

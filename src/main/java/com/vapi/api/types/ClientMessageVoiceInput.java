...
public final class ClientMessageVoiceInput {
    private final Optional<ClientMessageVoiceInputPhoneNumber> phoneNumber;
    ...
    private ClientMessageVoiceInput(
            Optional<ClientMessageVoiceInputPhoneNumber> phoneNumber,
    ...
    public Optional<ClientMessageVoiceInputPhoneNumber> getPhoneNumber() {
        return phoneNumber;
    }
    ...
    @java.lang.Override
    public int hashCode() {
        return Objects.hash(this.phoneNumber, this.timestamp, this.call, this.customer, this.assistant, this.input);
    }
    ...
    public interface _FinalStage {
        ...
        _FinalStage phoneNumber(Optional<ClientMessageVoiceInputPhoneNumber> phoneNumber);

        _FinalStage phoneNumber(ClientMessageVoiceInputPhoneNumber phoneNumber);
    ...
    public static final class Builder implements InputStage, _FinalStage {
        ...
        private Optional<ClientMessageVoiceInputPhoneNumber> phoneNumber = Optional.empty();
         ...
         */
        @java.lang.Override
        public _FinalStage phoneNumber(ClientMessageVoiceInputPhoneNumber phoneNumber) {
        ...
        public _FinalStage phoneNumber(Optional<ClientMessageVoiceInputPhoneNumber> phoneNumber) {
            this.phoneNumber = phoneNumber;
            return this;
        }
        ...
        public ClientMessageVoiceInput build() {
            return new ClientMessageVoiceInput(
                    phoneNumber, timestamp, call, customer, assistant, input, additionalProperties);
        }
    }
}

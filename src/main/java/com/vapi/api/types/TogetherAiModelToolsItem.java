...
public final class TogetherAiModelToolsItem {
    ...
    public static TogetherAiModelToolsItem voicemail(CreateVoicemailToolDto value) {
        return new TogetherAiModelToolsItem(new VoicemailValue(value));
    }
    ...
    public static TogetherAiModelToolsItem ghl(CreateGhlToolDto value) {
        return new TogetherAiModelToolsItem(new GhlValue(value));
    }

    public static TogetherAiModelToolsItem make(CreateMakeToolDto value) {
        return new TogetherAiModelToolsItem(new MakeValue(value));
    }

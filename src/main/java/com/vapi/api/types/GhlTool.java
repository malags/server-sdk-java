...
@JsonDeserialize(builder = GhlTool.Builder.class)
public final class GhlTool {
    private final Optional<List<GhlToolMessagesItem>> messages;
    ...
    private GhlTool(
            Optional<List<GhlToolMessagesItem>> messages,
            String id,
            String orgId,
    ...
    public Optional<List<GhlToolMessagesItem>> getMessages() {
        return messages;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GhlTool && equalTo((GhlTool) other);
    }
    ...
    private boolean equalTo(GhlTool other) {
    ...
    public interface _FinalStage {
         ...
         * <p>For some tools, this is auto-filled based on special fields like <code>tool.destinations</code>. For others like the function tool, these can be custom configured.</p>
         */
        _FinalStage messages(Optional<List<GhlToolMessagesItem>> messages);

        _FinalStage messages(List<GhlToolMessagesItem> messages);
    ...
    public static final class Builder
        ...
        private Optional<List<GhlToolMessagesItem>> messages = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(GhlTool other) {
         ...
         */
        @java.lang.Override
        public _FinalStage messages(List<GhlToolMessagesItem> messages) {
        ...
        public _FinalStage messages(Optional<List<GhlToolMessagesItem>> messages) {
            this.messages = messages;
            return this;
        }

        @java.lang.Override
        public GhlTool build() {
            return new GhlTool(messages, id, orgId, createdAt, updatedAt, function, metadata, additionalProperties);
        }
    }
}

...
public final class StepDestinationConditionsItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private StepDestinationConditionsItem(Value value) {
        this.value = value;
    }
    ...
    public static StepDestinationConditionsItem modelBased(ModelBasedCondition value) {
        return new StepDestinationConditionsItem(new ModelBasedValue(value));
    }

    public static StepDestinationConditionsItem ruleBased(RuleBasedCondition value) {
        return new StepDestinationConditionsItem(new RuleBasedValue(value));
    }
    ...
    private static final class ModelBasedValue implements Value {
        ...
        public String toString() {
            return "StepDestinationConditionsItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "StepDestinationConditionsItem{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

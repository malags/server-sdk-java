...
@JsonDeserialize(builder = CreateVoicemailToolDto.Builder.class)
public final class CreateVoicemailToolDto {
    private final Optional<List<CreateVoicemailToolDtoMessagesItem>> messages;

    private final Optional<OpenAiFunction> function;

    private final Map<String, Object> additionalProperties;

    private CreateVoicemailToolDto(
            Optional<List<CreateVoicemailToolDtoMessagesItem>> messages,
    ...
    public Optional<List<CreateVoicemailToolDtoMessagesItem>> getMessages() {
        return messages;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateVoicemailToolDto && equalTo((CreateVoicemailToolDto) other);
    }
    ...
    private boolean equalTo(CreateVoicemailToolDto other) {
    ...
    public static final class Builder {
        private Optional<List<CreateVoicemailToolDtoMessagesItem>> messages = Optional.empty();
        ...
        public Builder from(CreateVoicemailToolDto other) {
        ...
        public Builder messages(Optional<List<CreateVoicemailToolDtoMessagesItem>> messages) {
            this.messages = messages;
            return this;
        }

        public Builder messages(List<CreateVoicemailToolDtoMessagesItem> messages) {
        ...
        public CreateVoicemailToolDto build() {
            return new CreateVoicemailToolDto(messages, function, additionalProperties);
        }
    }
}

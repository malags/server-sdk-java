...
@JsonDeserialize(builder = GoogleTranscriber.Builder.class)
public final class GoogleTranscriber {
    private final Optional<GoogleTranscriberModel> model;

    private final Optional<GoogleTranscriberLanguage> language;

    private final Optional<FallbackTranscriberPlan> fallbackPlan;

    private final Map<String, Object> additionalProperties;

    private GoogleTranscriber(
            Optional<GoogleTranscriberModel> model,
            Optional<GoogleTranscriberLanguage> language,
     ...
     */
    @JsonProperty("model")
    public Optional<GoogleTranscriberModel> getModel() {
        return model;
    }
    ...
    public Optional<GoogleTranscriberLanguage> getLanguage() {
        return language;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GoogleTranscriber && equalTo((GoogleTranscriber) other);
    }
    ...
    private boolean equalTo(GoogleTranscriber other) {
    ...
    public static final class Builder {
        private Optional<GoogleTranscriberModel> model = Optional.empty();

        private Optional<GoogleTranscriberLanguage> language = Optional.empty();
        ...
        public Builder from(GoogleTranscriber other) {
        ...
        public Builder model(GoogleTranscriberModel model) {
        ...
        public Builder language(GoogleTranscriberLanguage language) {
        ...
        public GoogleTranscriber build() {
            return new GoogleTranscriber(model, language, fallbackPlan, additionalProperties);
        }
    }
}

...
@JsonDeserialize(builder = CreateWebChatDto.Builder.class)
public final class CreateWebChatDto {
     ...
     */
    @JsonProperty("input")
    public CreateWebChatDtoInput getInput() {
        return input;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateWebChatDto && equalTo((CreateWebChatDto) other);
    }
    ...
    private boolean equalTo(CreateWebChatDto other) {
    ...
    public interface AssistantIdStage {
        ...
        Builder from(CreateWebChatDto other);
    }
    ...
    public interface InputStage {
         ...
         */
        _FinalStage input(@NotNull CreateWebChatDtoInput input);
    }

    public interface _FinalStage {
        CreateWebChatDto build();
    ...
    public static final class Builder implements AssistantIdStage, InputStage, _FinalStage {
        ...
        private CreateWebChatDtoInput input;
        ...
        @java.lang.Override
        public Builder from(CreateWebChatDto other) {
        ...
        @java.lang.Override
        @JsonSetter("input")
        public _FinalStage input(@NotNull CreateWebChatDtoInput input) {
        ...
        @java.lang.Override
        public CreateWebChatDto build() {
            return new CreateWebChatDto(

...
public final class CreatePlayHtCredentialDto {
    ...
    private CreatePlayHtCredentialDto(String apiKey, String userId, Map<String, Object> additionalProperties) {
        this.apiKey = apiKey;
        this.userId = userId;
    ...
    private boolean equalTo(CreatePlayHtCredentialDto other) {
        return apiKey.equals(other.apiKey) && userId.equals(other.userId);
    }
    ...
    public static final class Builder implements ApiKeyStage, UserIdStage, _FinalStage {
        ...
        public CreatePlayHtCredentialDto build() {
            return new CreatePlayHtCredentialDto(apiKey, userId, additionalProperties);
        }
    }
}

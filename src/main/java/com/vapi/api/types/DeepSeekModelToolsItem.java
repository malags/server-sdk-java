...
public final class DeepSeekModelToolsItem {
    ...
    public static DeepSeekModelToolsItem voicemail(CreateVoicemailToolDto value) {
        return new DeepSeekModelToolsItem(new VoicemailValue(value));
    }
    ...
    public static DeepSeekModelToolsItem ghl(CreateGhlToolDto value) {
        return new DeepSeekModelToolsItem(new GhlValue(value));
    }

    public static DeepSeekModelToolsItem make(CreateMakeToolDto value) {
        return new DeepSeekModelToolsItem(new MakeValue(value));
    }

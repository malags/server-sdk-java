...
public final class UpdateVonageCredentialDto {
    ...
    private UpdateVonageCredentialDto(String apiSecret, String apiKey, Map<String, Object> additionalProperties) {
    ...
    public static final class Builder implements ApiSecretStage, ApiKeyStage, _FinalStage {
        ...
        public UpdateVonageCredentialDto build() {
            return new UpdateVonageCredentialDto(apiSecret, apiKey, additionalProperties);
        }
    }
}

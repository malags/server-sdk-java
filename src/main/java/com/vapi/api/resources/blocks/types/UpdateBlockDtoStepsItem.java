...
import com.vapi.api.types.CallbackStep;
import com.vapi.api.types.HandoffStep;
import java.util.Objects;
import java.util.Optional;

public final class UpdateBlockDtoStepsItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private UpdateBlockDtoStepsItem(Value value) {
        this.value = value;
    }
    ...
    public static UpdateBlockDtoStepsItem handoff(HandoffStep value) {
        return new UpdateBlockDtoStepsItem(new HandoffValue(value));
    }

    public static UpdateBlockDtoStepsItem callback(CallbackStep value) {
        return new UpdateBlockDtoStepsItem(new CallbackValue(value));
    }
    ...
    private static final class HandoffValue implements Value {
        ...
        public String toString() {
            return "UpdateBlockDtoStepsItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "UpdateBlockDtoStepsItem{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

...
public final class CreateGoHighLevelCalendarAvailabilityToolDtoMessagesItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private CreateGoHighLevelCalendarAvailabilityToolDtoMessagesItem(Value value) {
        this.value = value;
    }
    ...
    public static CreateGoHighLevelCalendarAvailabilityToolDtoMessagesItem requestStart(ToolMessageStart value) {
        return new CreateGoHighLevelCalendarAvailabilityToolDtoMessagesItem(new RequestStartValue(value));
    }

    public static CreateGoHighLevelCalendarAvailabilityToolDtoMessagesItem requestComplete(ToolMessageComplete value) {
        return new CreateGoHighLevelCalendarAvailabilityToolDtoMessagesItem(new RequestCompleteValue(value));
    }

    public static CreateGoHighLevelCalendarAvailabilityToolDtoMessagesItem requestFailed(ToolMessageFailed value) {
        return new CreateGoHighLevelCalendarAvailabilityToolDtoMessagesItem(new RequestFailedValue(value));
    }

    public static CreateGoHighLevelCalendarAvailabilityToolDtoMessagesItem requestResponseDelayed(
            ToolMessageDelayed value) {
        return new CreateGoHighLevelCalendarAvailabilityToolDtoMessagesItem(new RequestResponseDelayedValue(value));
    }
    ...
    private static final class RequestStartValue implements Value {
        ...
        public String toString() {
            return "CreateGoHighLevelCalendarAvailabilityToolDtoMessagesItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "CreateGoHighLevelCalendarAvailabilityToolDtoMessagesItem{" + "type: " + type + ", value: " + value
                    + "}";
        }
    }
}

...
@JsonDeserialize(builder = UpdateGoogleSheetsRowAppendToolDto.Builder.class)
public final class UpdateGoogleSheetsRowAppendToolDto {
    private final Optional<List<UpdateGoogleSheetsRowAppendToolDtoMessagesItem>> messages;

    private final Optional<OpenAiFunction> function;

    private final Map<String, Object> additionalProperties;

    private UpdateGoogleSheetsRowAppendToolDto(
            Optional<List<UpdateGoogleSheetsRowAppendToolDtoMessagesItem>> messages,
    ...
    public Optional<List<UpdateGoogleSheetsRowAppendToolDtoMessagesItem>> getMessages() {
        return messages;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateGoogleSheetsRowAppendToolDto
                && equalTo((UpdateGoogleSheetsRowAppendToolDto) other);
    }
    ...
    private boolean equalTo(UpdateGoogleSheetsRowAppendToolDto other) {
    ...
    public static final class Builder {
        private Optional<List<UpdateGoogleSheetsRowAppendToolDtoMessagesItem>> messages = Optional.empty();
        ...
        public Builder from(UpdateGoogleSheetsRowAppendToolDto other) {
        ...
        public Builder messages(Optional<List<UpdateGoogleSheetsRowAppendToolDtoMessagesItem>> messages) {
            this.messages = messages;
            return this;
        }

        public Builder messages(List<UpdateGoogleSheetsRowAppendToolDtoMessagesItem> messages) {
        ...
        public UpdateGoogleSheetsRowAppendToolDto build() {
            return new UpdateGoogleSheetsRowAppendToolDto(messages, function, additionalProperties);
        }
    }
}

...
public final class TextEditorToolMessagesItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private TextEditorToolMessagesItem(Value value) {
        this.value = value;
    }
    ...
    public static TextEditorToolMessagesItem requestStart(ToolMessageStart value) {
        return new TextEditorToolMessagesItem(new RequestStartValue(value));
    }

    public static TextEditorToolMessagesItem requestComplete(ToolMessageComplete value) {
        return new TextEditorToolMessagesItem(new RequestCompleteValue(value));
    }

    public static TextEditorToolMessagesItem requestFailed(ToolMessageFailed value) {
        return new TextEditorToolMessagesItem(new RequestFailedValue(value));
    }

    public static TextEditorToolMessagesItem requestResponseDelayed(ToolMessageDelayed value) {
        return new TextEditorToolMessagesItem(new RequestResponseDelayedValue(value));
    }
    ...
    private static final class RequestStartValue implements Value {
        ...
        public String toString() {
            return "TextEditorToolMessagesItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "TextEditorToolMessagesItem{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

...
public final class WorkflowBlockStepsItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private WorkflowBlockStepsItem(Value value) {
        this.value = value;
    }
    ...
    public static WorkflowBlockStepsItem handoff(HandoffStep value) {
        return new WorkflowBlockStepsItem(new HandoffValue(value));
    }

    public static WorkflowBlockStepsItem callback(CallbackStep value) {
        return new WorkflowBlockStepsItem(new CallbackValue(value));
    }
    ...
    private static final class HandoffValue implements Value {
        ...
        public String toString() {
            return "WorkflowBlockStepsItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "WorkflowBlockStepsItem{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

...
@JsonDeserialize(builder = UpdateGoogleCalendarCreateEventToolDto.Builder.class)
public final class UpdateGoogleCalendarCreateEventToolDto {
    private final Optional<List<UpdateGoogleCalendarCreateEventToolDtoMessagesItem>> messages;

    private final Optional<OpenAiFunction> function;

    private final Map<String, Object> additionalProperties;

    private UpdateGoogleCalendarCreateEventToolDto(
            Optional<List<UpdateGoogleCalendarCreateEventToolDtoMessagesItem>> messages,
    ...
    public Optional<List<UpdateGoogleCalendarCreateEventToolDtoMessagesItem>> getMessages() {
        return messages;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateGoogleCalendarCreateEventToolDto
                && equalTo((UpdateGoogleCalendarCreateEventToolDto) other);
    }
    ...
    private boolean equalTo(UpdateGoogleCalendarCreateEventToolDto other) {
    ...
    public static final class Builder {
        private Optional<List<UpdateGoogleCalendarCreateEventToolDtoMessagesItem>> messages = Optional.empty();
        ...
        public Builder from(UpdateGoogleCalendarCreateEventToolDto other) {
        ...
        public Builder messages(Optional<List<UpdateGoogleCalendarCreateEventToolDtoMessagesItem>> messages) {
            this.messages = messages;
            return this;
        }

        public Builder messages(List<UpdateGoogleCalendarCreateEventToolDtoMessagesItem> messages) {
        ...
        public UpdateGoogleCalendarCreateEventToolDto build() {
            return new UpdateGoogleCalendarCreateEventToolDto(messages, function, additionalProperties);
        }
    }
}

...
public final class CallDestination {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private CallDestination(Value value) {
        this.value = value;
    }
    ...
    public static CallDestination number(TransferDestinationNumber value) {
        return new CallDestination(new NumberValue(value));
    }

    public static CallDestination sip(TransferDestinationSip value) {
        return new CallDestination(new SipValue(value));
    }
    ...
    private static final class NumberValue implements Value {
        ...
        public String toString() {
            return "CallDestination{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "CallDestination{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

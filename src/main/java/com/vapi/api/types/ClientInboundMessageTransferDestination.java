...
public final class ClientInboundMessageTransferDestination {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private ClientInboundMessageTransferDestination(Value value) {
        this.value = value;
    }
    ...
    public static ClientInboundMessageTransferDestination number(TransferDestinationNumber value) {
        return new ClientInboundMessageTransferDestination(new NumberValue(value));
    }

    public static ClientInboundMessageTransferDestination sip(TransferDestinationSip value) {
        return new ClientInboundMessageTransferDestination(new SipValue(value));
    }
    ...
    private static final class NumberValue implements Value {
        ...
        public String toString() {
            return "ClientInboundMessageTransferDestination{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "ClientInboundMessageTransferDestination{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

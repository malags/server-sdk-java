...
public class AsyncRawAssistantsClient {
    protected final ClientOptions clientOptions;

    public AsyncRawAssistantsClient(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
    }

    public CompletableFuture<VapiHttpResponse<List<Assistant>>> list() {
        return list(AssistantsListRequest.builder().build());
    }

    public CompletableFuture<VapiHttpResponse<List<Assistant>>> list(AssistantsListRequest request) {
        return list(request, null);
    }

    public CompletableFuture<VapiHttpResponse<List<Assistant>>> list(
            AssistantsListRequest request, RequestOptions requestOptions) {
        ...
        CompletableFuture<VapiHttpResponse<List<Assistant>>> future = new CompletableFuture<>();
    ...
    public CompletableFuture<VapiHttpResponse<Assistant>> create() {
        return create(CreateAssistantDto.builder().build());
    }

    public CompletableFuture<VapiHttpResponse<Assistant>> create(CreateAssistantDto request) {
        return create(request, null);
    }

    public CompletableFuture<VapiHttpResponse<Assistant>> create(
            CreateAssistantDto request, RequestOptions requestOptions) {
        ...
        CompletableFuture<VapiHttpResponse<Assistant>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
    ...
    public CompletableFuture<VapiHttpResponse<Assistant>> get(String id) {
        return get(id, null);
    }

    public CompletableFuture<VapiHttpResponse<Assistant>> get(String id, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("assistant")
                .addPathSegment(id)
    ...
    public CompletableFuture<VapiHttpResponse<Assistant>> delete(String id) {
        return delete(id, null);
    }

    public CompletableFuture<VapiHttpResponse<Assistant>> delete(String id, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("assistant")
                .addPathSegment(id)
    ...
    public CompletableFuture<VapiHttpResponse<Assistant>> update(String id) {
        return update(id, UpdateAssistantDto.builder().build());
    }

    public CompletableFuture<VapiHttpResponse<Assistant>> update(String id, UpdateAssistantDto request) {
        return update(id, request, null);
    }

    public CompletableFuture<VapiHttpResponse<Assistant>> update(
            String id, UpdateAssistantDto request, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("assistant")
                .addPathSegment(id)

...
@JsonDeserialize(builder = VapiModel.Builder.class)
public final class VapiModel {
    private final Optional<List<OpenAiMessage>> messages;

    private final Optional<List<VapiModelToolsItem>> tools;
     ...
     */
    @JsonProperty("tools")
    public Optional<List<VapiModelToolsItem>> getTools() {
        return tools;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof VapiModel && equalTo((VapiModel) other);
    }
    ...
    private boolean equalTo(VapiModel other) {
    ...
    public interface _FinalStage {
        ...
        _FinalStage tools(Optional<List<VapiModelToolsItem>> tools);

        _FinalStage tools(List<VapiModelToolsItem> tools);
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        private Optional<List<VapiModelToolsItem>> tools = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(VapiModel other) {
         ...
         */
        @java.lang.Override
        public _FinalStage tools(List<VapiModelToolsItem> tools) {
        ...
        public _FinalStage tools(Optional<List<VapiModelToolsItem>> tools) {
            this.tools = tools;
            return this;
        }
        ...
        @java.lang.Override
        public VapiModel build() {
            return new VapiModel(
                    messages,
                    tools,
                    toolIds,
                    knowledgeBase,

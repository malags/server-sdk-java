...
public final class SlackSendMessageToolMessagesItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private SlackSendMessageToolMessagesItem(Value value) {
        this.value = value;
    }
    ...
    public static SlackSendMessageToolMessagesItem requestStart(ToolMessageStart value) {
        return new SlackSendMessageToolMessagesItem(new RequestStartValue(value));
    }

    public static SlackSendMessageToolMessagesItem requestComplete(ToolMessageComplete value) {
        return new SlackSendMessageToolMessagesItem(new RequestCompleteValue(value));
    }

    public static SlackSendMessageToolMessagesItem requestFailed(ToolMessageFailed value) {
        return new SlackSendMessageToolMessagesItem(new RequestFailedValue(value));
    }

    public static SlackSendMessageToolMessagesItem requestResponseDelayed(ToolMessageDelayed value) {
        return new SlackSendMessageToolMessagesItem(new RequestResponseDelayedValue(value));
    }
    ...
    private static final class RequestStartValue implements Value {
        ...
        public String toString() {
            return "SlackSendMessageToolMessagesItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "SlackSendMessageToolMessagesItem{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

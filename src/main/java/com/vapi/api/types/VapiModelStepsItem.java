...
public final class VapiModelStepsItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private VapiModelStepsItem(Value value) {
        this.value = value;
    }
    ...
    public static VapiModelStepsItem handoff(HandoffStep value) {
        return new VapiModelStepsItem(new HandoffValue(value));
    }

    public static VapiModelStepsItem callback(CallbackStep value) {
        return new VapiModelStepsItem(new CallbackValue(value));
    }
    ...
    private static final class HandoffValue implements Value {
        ...
        public String toString() {
            return "VapiModelStepsItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "VapiModelStepsItem{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

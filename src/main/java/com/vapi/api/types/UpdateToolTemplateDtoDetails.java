...
public final class UpdateToolTemplateDtoDetails {
    ...
    public static UpdateToolTemplateDtoDetails voicemail(CreateVoicemailToolDto value) {
        return new UpdateToolTemplateDtoDetails(new VoicemailValue(value));
    }
    ...
    public static UpdateToolTemplateDtoDetails ghl(CreateGhlToolDto value) {
        return new UpdateToolTemplateDtoDetails(new GhlValue(value));
    }

    public static UpdateToolTemplateDtoDetails make(CreateMakeToolDto value) {
        return new UpdateToolTemplateDtoDetails(new MakeValue(value));
    }

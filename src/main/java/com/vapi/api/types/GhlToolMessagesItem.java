...
public final class GhlToolMessagesItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private GhlToolMessagesItem(Value value) {
        this.value = value;
    }
    ...
    public static GhlToolMessagesItem requestStart(ToolMessageStart value) {
        return new GhlToolMessagesItem(new RequestStartValue(value));
    }

    public static GhlToolMessagesItem requestComplete(ToolMessageComplete value) {
        return new GhlToolMessagesItem(new RequestCompleteValue(value));
    }

    public static GhlToolMessagesItem requestFailed(ToolMessageFailed value) {
        return new GhlToolMessagesItem(new RequestFailedValue(value));
    }

    public static GhlToolMessagesItem requestResponseDelayed(ToolMessageDelayed value) {
        return new GhlToolMessagesItem(new RequestResponseDelayedValue(value));
    }
    ...
    private static final class RequestStartValue implements Value {
        ...
        public String toString() {
            return "GhlToolMessagesItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "GhlToolMessagesItem{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

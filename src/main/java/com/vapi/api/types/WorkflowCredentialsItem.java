...
public final class WorkflowCredentialsItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private WorkflowCredentialsItem(Value value) {
        this.value = value;
    }
    ...
    public static WorkflowCredentialsItem _11Labs(CreateElevenLabsCredentialDto value) {
        return new WorkflowCredentialsItem(new _11LabsValue(value));
    }

    public static WorkflowCredentialsItem anthropic(CreateAnthropicCredentialDto value) {
        return new WorkflowCredentialsItem(new AnthropicValue(value));
    }

    public static WorkflowCredentialsItem anyscale(CreateAnyscaleCredentialDto value) {
        return new WorkflowCredentialsItem(new AnyscaleValue(value));
    }

    public static WorkflowCredentialsItem assemblyAi(CreateAssemblyAiCredentialDto value) {
        return new WorkflowCredentialsItem(new AssemblyAiValue(value));
    }

    public static WorkflowCredentialsItem azureOpenai(CreateAzureOpenAiCredentialDto value) {
        return new WorkflowCredentialsItem(new AzureOpenaiValue(value));
    }

    public static WorkflowCredentialsItem azure(CreateAzureCredentialDto value) {
        return new WorkflowCredentialsItem(new AzureValue(value));
    }

    public static WorkflowCredentialsItem byoSipTrunk(CreateByoSipTrunkCredentialDto value) {
        return new WorkflowCredentialsItem(new ByoSipTrunkValue(value));
    }

    public static WorkflowCredentialsItem cartesia(CreateCartesiaCredentialDto value) {
        return new WorkflowCredentialsItem(new CartesiaValue(value));
    }

    public static WorkflowCredentialsItem cerebras(CreateCerebrasCredentialDto value) {
        return new WorkflowCredentialsItem(new CerebrasValue(value));
    }

    public static WorkflowCredentialsItem cloudflare(CreateCloudflareCredentialDto value) {
        return new WorkflowCredentialsItem(new CloudflareValue(value));
    }

    public static WorkflowCredentialsItem customLlm(CreateCustomLlmCredentialDto value) {
        return new WorkflowCredentialsItem(new CustomLlmValue(value));
    }

    public static WorkflowCredentialsItem deepgram(CreateDeepgramCredentialDto value) {
        return new WorkflowCredentialsItem(new DeepgramValue(value));
    }

    public static WorkflowCredentialsItem deepinfra(CreateDeepInfraCredentialDto value) {
        return new WorkflowCredentialsItem(new DeepinfraValue(value));
    }

    public static WorkflowCredentialsItem deepSeek(CreateDeepSeekCredentialDto value) {
        return new WorkflowCredentialsItem(new DeepSeekValue(value));
    }

    public static WorkflowCredentialsItem gcp(CreateGcpCredentialDto value) {
        return new WorkflowCredentialsItem(new GcpValue(value));
    }

    public static WorkflowCredentialsItem gladia(CreateGladiaCredentialDto value) {
        return new WorkflowCredentialsItem(new GladiaValue(value));
    }

    public static WorkflowCredentialsItem gohighlevel(CreateGoHighLevelCredentialDto value) {
        return new WorkflowCredentialsItem(new GohighlevelValue(value));
    }

    public static WorkflowCredentialsItem google(CreateGoogleCredentialDto value) {
        return new WorkflowCredentialsItem(new GoogleValue(value));
    }

    public static WorkflowCredentialsItem groq(CreateGroqCredentialDto value) {
        return new WorkflowCredentialsItem(new GroqValue(value));
    }

    public static WorkflowCredentialsItem inflectionAi(CreateInflectionAiCredentialDto value) {
        return new WorkflowCredentialsItem(new InflectionAiValue(value));
    }

    public static WorkflowCredentialsItem langfuse(CreateLangfuseCredentialDto value) {
        return new WorkflowCredentialsItem(new LangfuseValue(value));
    }

    public static WorkflowCredentialsItem lmnt(CreateLmntCredentialDto value) {
        return new WorkflowCredentialsItem(new LmntValue(value));
    }

    public static WorkflowCredentialsItem make(CreateMakeCredentialDto value) {
        return new WorkflowCredentialsItem(new MakeValue(value));
    }

    public static WorkflowCredentialsItem openai(CreateOpenAiCredentialDto value) {
        return new WorkflowCredentialsItem(new OpenaiValue(value));
    }

    public static WorkflowCredentialsItem openrouter(CreateOpenRouterCredentialDto value) {
        return new WorkflowCredentialsItem(new OpenrouterValue(value));
    }

    public static WorkflowCredentialsItem perplexityAi(CreatePerplexityAiCredentialDto value) {
        return new WorkflowCredentialsItem(new PerplexityAiValue(value));
    }

    public static WorkflowCredentialsItem playht(CreatePlayHtCredentialDto value) {
        return new WorkflowCredentialsItem(new PlayhtValue(value));
    }

    public static WorkflowCredentialsItem rimeAi(CreateRimeAiCredentialDto value) {
        return new WorkflowCredentialsItem(new RimeAiValue(value));
    }

    public static WorkflowCredentialsItem runpod(CreateRunpodCredentialDto value) {
        return new WorkflowCredentialsItem(new RunpodValue(value));
    }

    public static WorkflowCredentialsItem s3(CreateS3CredentialDto value) {
        return new WorkflowCredentialsItem(new S3Value(value));
    }

    public static WorkflowCredentialsItem supabase(CreateSupabaseCredentialDto value) {
        return new WorkflowCredentialsItem(new SupabaseValue(value));
    }

    public static WorkflowCredentialsItem smallestAi(CreateSmallestAiCredentialDto value) {
        return new WorkflowCredentialsItem(new SmallestAiValue(value));
    }

    public static WorkflowCredentialsItem tavus(CreateTavusCredentialDto value) {
        return new WorkflowCredentialsItem(new TavusValue(value));
    }

    public static WorkflowCredentialsItem togetherAi(CreateTogetherAiCredentialDto value) {
        return new WorkflowCredentialsItem(new TogetherAiValue(value));
    }

    public static WorkflowCredentialsItem twilio(CreateTwilioCredentialDto value) {
        return new WorkflowCredentialsItem(new TwilioValue(value));
    }

    public static WorkflowCredentialsItem vonage(CreateVonageCredentialDto value) {
        return new WorkflowCredentialsItem(new VonageValue(value));
    }

    public static WorkflowCredentialsItem webhook(CreateWebhookCredentialDto value) {
        return new WorkflowCredentialsItem(new WebhookValue(value));
    }

    public static WorkflowCredentialsItem xai(CreateXAiCredentialDto value) {
        return new WorkflowCredentialsItem(new XaiValue(value));
    }

    public static WorkflowCredentialsItem neuphonic(CreateNeuphonicCredentialDto value) {
        return new WorkflowCredentialsItem(new NeuphonicValue(value));
    }

    public static WorkflowCredentialsItem hume(CreateHumeCredentialDto value) {
        return new WorkflowCredentialsItem(new HumeValue(value));
    }

    public static WorkflowCredentialsItem mistral(CreateMistralCredentialDto value) {
        return new WorkflowCredentialsItem(new MistralValue(value));
    }

    public static WorkflowCredentialsItem speechmatics(CreateSpeechmaticsCredentialDto value) {
        return new WorkflowCredentialsItem(new SpeechmaticsValue(value));
    }

    public static WorkflowCredentialsItem trieve(CreateTrieveCredentialDto value) {
        return new WorkflowCredentialsItem(new TrieveValue(value));
    }

    public static WorkflowCredentialsItem googleCalendarOauth2Client(
            CreateGoogleCalendarOAuth2ClientCredentialDto value) {
        return new WorkflowCredentialsItem(new GoogleCalendarOauth2ClientValue(value));
    }

    public static WorkflowCredentialsItem googleCalendarOauth2Authorization(
            CreateGoogleCalendarOAuth2AuthorizationCredentialDto value) {
        return new WorkflowCredentialsItem(new GoogleCalendarOauth2AuthorizationValue(value));
    }

    public static WorkflowCredentialsItem googleSheetsOauth2Authorization(
            CreateGoogleSheetsOAuth2AuthorizationCredentialDto value) {
        return new WorkflowCredentialsItem(new GoogleSheetsOauth2AuthorizationValue(value));
    }

    public static WorkflowCredentialsItem slackOauth2Authorization(CreateSlackOAuth2AuthorizationCredentialDto value) {
        return new WorkflowCredentialsItem(new SlackOauth2AuthorizationValue(value));
    }

    public static WorkflowCredentialsItem ghlOauth2Authorization(CreateGoHighLevelMcpCredentialDto value) {
        return new WorkflowCredentialsItem(new GhlOauth2AuthorizationValue(value));
    }

    public static WorkflowCredentialsItem inworld(Object value) {
        return new WorkflowCredentialsItem(new InworldValue(value));
    }
    ...
    private static final class _11LabsValue implements Value {
        ...
        public String toString() {
            return "WorkflowCredentialsItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "WorkflowCredentialsItem{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

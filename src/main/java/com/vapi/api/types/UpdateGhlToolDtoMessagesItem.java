...
public final class UpdateGhlToolDtoMessagesItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private UpdateGhlToolDtoMessagesItem(Value value) {
        this.value = value;
    }
    ...
    public static UpdateGhlToolDtoMessagesItem requestStart(ToolMessageStart value) {
        return new UpdateGhlToolDtoMessagesItem(new RequestStartValue(value));
    }

    public static UpdateGhlToolDtoMessagesItem requestComplete(ToolMessageComplete value) {
        return new UpdateGhlToolDtoMessagesItem(new RequestCompleteValue(value));
    }

    public static UpdateGhlToolDtoMessagesItem requestFailed(ToolMessageFailed value) {
        return new UpdateGhlToolDtoMessagesItem(new RequestFailedValue(value));
    }

    public static UpdateGhlToolDtoMessagesItem requestResponseDelayed(ToolMessageDelayed value) {
        return new UpdateGhlToolDtoMessagesItem(new RequestResponseDelayedValue(value));
    }
    ...
    private static final class RequestStartValue implements Value {
        ...
        public String toString() {
            return "UpdateGhlToolDtoMessagesItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "UpdateGhlToolDtoMessagesItem{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

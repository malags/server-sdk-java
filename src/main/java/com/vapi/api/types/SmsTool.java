...
@JsonDeserialize(builder = SmsTool.Builder.class)
public final class SmsTool {
    private final Optional<List<SmsToolMessagesItem>> messages;
    ...
    private SmsTool(
            Optional<List<SmsToolMessagesItem>> messages,
            String id,
            String orgId,
    ...
    public Optional<List<SmsToolMessagesItem>> getMessages() {
        return messages;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof SmsTool && equalTo((SmsTool) other);
    }
    ...
    private boolean equalTo(SmsTool other) {
    ...
    public interface _FinalStage {
         ...
         * <p>For some tools, this is auto-filled based on special fields like <code>tool.destinations</code>. For others like the function tool, these can be custom configured.</p>
         */
        _FinalStage messages(Optional<List<SmsToolMessagesItem>> messages);

        _FinalStage messages(List<SmsToolMessagesItem> messages);
    ...
    public static final class Builder implements IdStage, OrgIdStage, CreatedAtStage, UpdatedAtStage, _FinalStage {
        ...
        private Optional<List<SmsToolMessagesItem>> messages = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(SmsTool other) {
         ...
         */
        @java.lang.Override
        public _FinalStage messages(List<SmsToolMessagesItem> messages) {
        ...
        public _FinalStage messages(Optional<List<SmsToolMessagesItem>> messages) {
            this.messages = messages;
            return this;
        }

        @java.lang.Override
        public SmsTool build() {
            return new SmsTool(messages, id, orgId, createdAt, updatedAt, function, additionalProperties);
        }
    }
}

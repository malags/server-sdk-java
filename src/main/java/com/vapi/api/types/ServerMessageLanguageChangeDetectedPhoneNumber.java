...
public final class ServerMessageLanguageChangeDetectedPhoneNumber {
    ...
    public static ServerMessageLanguageChangeDetectedPhoneNumber telnyx(CreateTelnyxPhoneNumberDto value) {
        return new ServerMessageLanguageChangeDetectedPhoneNumber(new TelnyxValue(value));
    }

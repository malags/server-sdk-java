...
public final class FunctionToolMessagesItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private FunctionToolMessagesItem(Value value) {
        this.value = value;
    }
    ...
    public static FunctionToolMessagesItem requestStart(ToolMessageStart value) {
        return new FunctionToolMessagesItem(new RequestStartValue(value));
    }

    public static FunctionToolMessagesItem requestComplete(ToolMessageComplete value) {
        return new FunctionToolMessagesItem(new RequestCompleteValue(value));
    }

    public static FunctionToolMessagesItem requestFailed(ToolMessageFailed value) {
        return new FunctionToolMessagesItem(new RequestFailedValue(value));
    }

    public static FunctionToolMessagesItem requestResponseDelayed(ToolMessageDelayed value) {
        return new FunctionToolMessagesItem(new RequestResponseDelayedValue(value));
    }
    ...
    private static final class RequestStartValue implements Value {
        ...
        public String toString() {
            return "FunctionToolMessagesItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "FunctionToolMessagesItem{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

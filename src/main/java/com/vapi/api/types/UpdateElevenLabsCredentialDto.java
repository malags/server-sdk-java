...
public final class UpdateElevenLabsCredentialDto {
    ...
    private UpdateElevenLabsCredentialDto(String apiKey, Map<String, Object> additionalProperties) {
        this.apiKey = apiKey;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateElevenLabsCredentialDto && equalTo((UpdateElevenLabsCredentialDto) other);
    }
    ...
    public static final class Builder implements ApiKeyStage, _FinalStage {
        ...
        public UpdateElevenLabsCredentialDto build() {
            return new UpdateElevenLabsCredentialDto(apiKey, additionalProperties);
        }
    }
}

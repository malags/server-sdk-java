...
public final class TransferPhoneNumberHookActionDestination {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private TransferPhoneNumberHookActionDestination(Value value) {
        this.value = value;
    }
    ...
    public static TransferPhoneNumberHookActionDestination number(TransferDestinationNumber value) {
        return new TransferPhoneNumberHookActionDestination(new NumberValue(value));
    }

    public static TransferPhoneNumberHookActionDestination sip(TransferDestinationSip value) {
        return new TransferPhoneNumberHookActionDestination(new SipValue(value));
    }
    ...
    private static final class NumberValue implements Value {
        ...
        public String toString() {
            return "TransferPhoneNumberHookActionDestination{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "TransferPhoneNumberHookActionDestination{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

...
public final class UpdateCustomLlmCredentialDto {
    ...
    private UpdateCustomLlmCredentialDto(String apiKey, Map<String, Object> additionalProperties) {
        this.apiKey = apiKey;
    ...
    public static final class Builder implements ApiKeyStage, _FinalStage {
        ...
        public UpdateCustomLlmCredentialDto build() {
            return new UpdateCustomLlmCredentialDto(apiKey, additionalProperties);
        }
    }
}

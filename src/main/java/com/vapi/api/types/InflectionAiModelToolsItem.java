...
public final class InflectionAiModelToolsItem {
    ...
    public static InflectionAiModelToolsItem voicemail(CreateVoicemailToolDto value) {
        return new InflectionAiModelToolsItem(new VoicemailValue(value));
    }
    ...
    public static InflectionAiModelToolsItem ghl(CreateGhlToolDto value) {
        return new InflectionAiModelToolsItem(new GhlValue(value));
    }

    public static InflectionAiModelToolsItem make(CreateMakeToolDto value) {
        return new InflectionAiModelToolsItem(new MakeValue(value));
    }

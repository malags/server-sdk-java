...
public class AsyncRawTestSuitesClient {
    protected final ClientOptions clientOptions;

    public AsyncRawTestSuitesClient(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
    }

    public CompletableFuture<VapiHttpResponse<TestSuitesPaginatedResponse>> testSuiteControllerFindAllPaginated() {
    ...
    public CompletableFuture<VapiHttpResponse<TestSuitesPaginatedResponse>> testSuiteControllerFindAllPaginated(
        ...
        CompletableFuture<VapiHttpResponse<TestSuitesPaginatedResponse>> future = new CompletableFuture<>();
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new VapiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBody.string(), TestSuitesPaginatedResponse.class),
                                response));
                        return;
                    }
    ...
    public CompletableFuture<VapiHttpResponse<TestSuite>> testSuiteControllerCreate() {
        return testSuiteControllerCreate(CreateTestSuiteDto.builder().build());
    }

    public CompletableFuture<VapiHttpResponse<TestSuite>> testSuiteControllerCreate(CreateTestSuiteDto request) {
    ...
    public CompletableFuture<VapiHttpResponse<TestSuite>> testSuiteControllerCreate(
        ...
        CompletableFuture<VapiHttpResponse<TestSuite>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
    ...
    public CompletableFuture<VapiHttpResponse<TestSuite>> testSuiteControllerFindOne(String id) {
        return testSuiteControllerFindOne(id, null);
    }

    public CompletableFuture<VapiHttpResponse<TestSuite>> testSuiteControllerFindOne(
    ...
    public CompletableFuture<VapiHttpResponse<TestSuite>> testSuiteControllerRemove(String id) {
        return testSuiteControllerRemove(id, null);
    }

    public CompletableFuture<VapiHttpResponse<TestSuite>> testSuiteControllerRemove(
            String id, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("test-suite")
    ...
    public CompletableFuture<VapiHttpResponse<TestSuite>> testSuiteControllerUpdate(String id) {
        return testSuiteControllerUpdate(id, UpdateTestSuiteDto.builder().build());
    }

    public CompletableFuture<VapiHttpResponse<TestSuite>> testSuiteControllerUpdate(
            String id, UpdateTestSuiteDto request) {

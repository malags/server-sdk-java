...
public final class WorkflowUserEditableModel {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private WorkflowUserEditableModel(Value value) {
        this.value = value;
    }
    ...
    public static WorkflowUserEditableModel openai(WorkflowOpenAiModel value) {
        return new WorkflowUserEditableModel(new OpenaiValue(value));
    }

    public static WorkflowUserEditableModel anthropic(WorkflowAnthropicModel value) {
        return new WorkflowUserEditableModel(new AnthropicValue(value));
    }
    ...
    private static final class OpenaiValue implements Value {
        ...
        public String toString() {
            return "WorkflowUserEditableModel{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "WorkflowUserEditableModel{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

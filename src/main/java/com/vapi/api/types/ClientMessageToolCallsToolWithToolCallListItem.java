...
public final class ClientMessageToolCallsToolWithToolCallListItem {
    ...
    public static ClientMessageToolCallsToolWithToolCallListItem bash(BashToolWithToolCall value) {
        return new ClientMessageToolCallsToolWithToolCallListItem(new BashValue(value));
    }

    public static ClientMessageToolCallsToolWithToolCallListItem computer(ComputerToolWithToolCall value) {
        return new ClientMessageToolCallsToolWithToolCallListItem(new ComputerValue(value));
    }

    public static ClientMessageToolCallsToolWithToolCallListItem textEditor(TextEditorToolWithToolCall value) {

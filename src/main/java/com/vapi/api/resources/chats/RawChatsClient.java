...
public class RawChatsClient {
    ...
    public VapiHttpResponse<ChatPaginatedResponse> list() {
        return list(ChatsListRequest.builder().build());
    }

    public VapiHttpResponse<ChatPaginatedResponse> list(ChatsListRequest request) {
        return list(request, null);
    }

    public VapiHttpResponse<ChatPaginatedResponse> list(ChatsListRequest request, RequestOptions requestOptions) {
     ...
     */
    public VapiHttpResponse<ChatsCreateResponse> create(CreateChatDto request) {
     ...
     * Creates a new chat. Requires at least one of: assistantId/assistant, sessionId, or previousChatId. Note: sessionId and previousChatId are mutually exclusive.
     */
    public VapiHttpResponse<ChatsCreateResponse> create(CreateChatDto request, RequestOptions requestOptions) {
    ...
    public VapiHttpResponse<Chat> get(String id) {
        return get(id, null);
    }

    public VapiHttpResponse<Chat> get(String id, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("chat")
                .addPathSegment(id)
    ...
    public VapiHttpResponse<Chat> delete(String id) {
        return delete(id, null);
    }

    public VapiHttpResponse<Chat> delete(String id, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("chat")
                .addPathSegment(id)
    ...
    public VapiHttpResponse<ChatsCreateResponseResponse> createResponse(OpenAiResponsesRequest request) {
        return createResponse(request, null);
    }

    public VapiHttpResponse<ChatsCreateResponseResponse> createResponse(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new VapiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), ChatsCreateResponseResponse.class),
                        response);
            }
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            throw new VapiApiException(

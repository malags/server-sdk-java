...
@JsonDeserialize(builder = GoogleCalendarCreateEventTool.Builder.class)
public final class GoogleCalendarCreateEventTool {
    private final Optional<Boolean> async;

    private final Optional<List<GoogleCalendarCreateEventToolMessagesItem>> messages;
    ...
    private GoogleCalendarCreateEventTool(
            Optional<Boolean> async,
            Optional<List<GoogleCalendarCreateEventToolMessagesItem>> messages,
            String id,
            String orgId,
    ...
    public Optional<List<GoogleCalendarCreateEventToolMessagesItem>> getMessages() {
        return messages;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GoogleCalendarCreateEventTool && equalTo((GoogleCalendarCreateEventTool) other);
    }
    ...
    private boolean equalTo(GoogleCalendarCreateEventTool other) {
    ...
    public interface IdStage {
        ...
        Builder from(GoogleCalendarCreateEventTool other);
    }
    ...
    public interface _FinalStage {
        GoogleCalendarCreateEventTool build();

        _FinalStage async(Optional<Boolean> async);

        _FinalStage async(Boolean async);

        _FinalStage messages(Optional<List<GoogleCalendarCreateEventToolMessagesItem>> messages);

        _FinalStage messages(List<GoogleCalendarCreateEventToolMessagesItem> messages);
    ...
    public static final class Builder implements IdStage, OrgIdStage, CreatedAtStage, UpdatedAtStage, _FinalStage {
        ...
        private Optional<List<GoogleCalendarCreateEventToolMessagesItem>> messages = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(GoogleCalendarCreateEventTool other) {
         ...
         */
        @java.lang.Override
        public _FinalStage messages(List<GoogleCalendarCreateEventToolMessagesItem> messages) {
        ...
        public _FinalStage messages(Optional<List<GoogleCalendarCreateEventToolMessagesItem>> messages) {
            this.messages = messages;
            return this;
        }
        ...
        @java.lang.Override
        public GoogleCalendarCreateEventTool build() {
            return new GoogleCalendarCreateEventTool(

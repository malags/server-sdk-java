...
public final class OpenAiModelToolsItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private OpenAiModelToolsItem(Value value) {
        this.value = value;
    }
    ...
    public static OpenAiModelToolsItem apiRequest(CreateApiRequestToolDto value) {
        return new OpenAiModelToolsItem(new ApiRequestValue(value));
    }

    public static OpenAiModelToolsItem bash(CreateBashToolDto value) {
        return new OpenAiModelToolsItem(new BashValue(value));
    }

    public static OpenAiModelToolsItem computer(CreateComputerToolDto value) {
        return new OpenAiModelToolsItem(new ComputerValue(value));
    }

    public static OpenAiModelToolsItem dtmf(CreateDtmfToolDto value) {
        return new OpenAiModelToolsItem(new DtmfValue(value));
    }

    public static OpenAiModelToolsItem endCall(CreateEndCallToolDto value) {
        return new OpenAiModelToolsItem(new EndCallValue(value));
    }

    public static OpenAiModelToolsItem function(CreateFunctionToolDto value) {
        return new OpenAiModelToolsItem(new FunctionValue(value));
    }

    public static OpenAiModelToolsItem gohighlevelCalendarAvailabilityCheck(
            CreateGoHighLevelCalendarAvailabilityToolDto value) {
        return new OpenAiModelToolsItem(new GohighlevelCalendarAvailabilityCheckValue(value));
    }

    public static OpenAiModelToolsItem gohighlevelCalendarEventCreate(
            CreateGoHighLevelCalendarEventCreateToolDto value) {
        return new OpenAiModelToolsItem(new GohighlevelCalendarEventCreateValue(value));
    }

    public static OpenAiModelToolsItem gohighlevelContactCreate(CreateGoHighLevelContactCreateToolDto value) {
        return new OpenAiModelToolsItem(new GohighlevelContactCreateValue(value));
    }

    public static OpenAiModelToolsItem gohighlevelContactGet(CreateGoHighLevelContactGetToolDto value) {
        return new OpenAiModelToolsItem(new GohighlevelContactGetValue(value));
    }

    public static OpenAiModelToolsItem googleCalendarAvailabilityCheck(
            CreateGoogleCalendarCheckAvailabilityToolDto value) {
        return new OpenAiModelToolsItem(new GoogleCalendarAvailabilityCheckValue(value));
    }

    public static OpenAiModelToolsItem googleCalendarEventCreate(CreateGoogleCalendarCreateEventToolDto value) {
        return new OpenAiModelToolsItem(new GoogleCalendarEventCreateValue(value));
    }

    public static OpenAiModelToolsItem googleSheetsRowAppend(CreateGoogleSheetsRowAppendToolDto value) {
        return new OpenAiModelToolsItem(new GoogleSheetsRowAppendValue(value));
    }

    public static OpenAiModelToolsItem mcp(CreateMcpToolDto value) {
        return new OpenAiModelToolsItem(new McpValue(value));
    }

    public static OpenAiModelToolsItem query(CreateQueryToolDto value) {
        return new OpenAiModelToolsItem(new QueryValue(value));
    }

    public static OpenAiModelToolsItem slackMessageSend(CreateSlackSendMessageToolDto value) {
        return new OpenAiModelToolsItem(new SlackMessageSendValue(value));
    }

    public static OpenAiModelToolsItem sms(CreateSmsToolDto value) {
        return new OpenAiModelToolsItem(new SmsValue(value));
    }

    public static OpenAiModelToolsItem textEditor(CreateTextEditorToolDto value) {
        return new OpenAiModelToolsItem(new TextEditorValue(value));
    }

    public static OpenAiModelToolsItem transferCall(CreateTransferCallToolDto value) {
        return new OpenAiModelToolsItem(new TransferCallValue(value));
    }
    ...
    private static final class ApiRequestValue implements Value {
        ...
        public String toString() {
            return "OpenAiModelToolsItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "OpenAiModelToolsItem{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

...
@JsonDeserialize(builder = SquadsListRequest.Builder.class)
public final class SquadsListRequest {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof SquadsListRequest && equalTo((SquadsListRequest) other);
    }
    ...
    private boolean equalTo(SquadsListRequest other) {
    ...
    public static final class Builder {
        ...
        public Builder from(SquadsListRequest other) {
        ...
        public SquadsListRequest build() {
            return new SquadsListRequest(
                    limit,
                    createdAtGt,
                    createdAtLt,
                    createdAtGe,

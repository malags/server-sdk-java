...
@JsonDeserialize(builder = CreateRimeAiCredentialDto.Builder.class)
public final class CreateRimeAiCredentialDto {
    ...
    private CreateRimeAiCredentialDto(String apiKey, Optional<String> name, Map<String, Object> additionalProperties) {
        this.apiKey = apiKey;
        this.name = name;
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateRimeAiCredentialDto && equalTo((CreateRimeAiCredentialDto) other);
    }
    ...
    private boolean equalTo(CreateRimeAiCredentialDto other) {
    ...
    public static final class Builder implements ApiKeyStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(CreateRimeAiCredentialDto other) {
        ...
        @java.lang.Override
        public CreateRimeAiCredentialDto build() {
            return new CreateRimeAiCredentialDto(apiKey, name, additionalProperties);
        }
    }
}

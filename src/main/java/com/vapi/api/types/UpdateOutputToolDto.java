...
@JsonDeserialize(builder = UpdateOutputToolDto.Builder.class)
public final class UpdateOutputToolDto {
    private final Optional<List<UpdateOutputToolDtoMessagesItem>> messages;

    private final Optional<OpenAiFunction> function;

    private final Map<String, Object> additionalProperties;

    private UpdateOutputToolDto(
            Optional<List<UpdateOutputToolDtoMessagesItem>> messages,
    ...
    public Optional<List<UpdateOutputToolDtoMessagesItem>> getMessages() {
        return messages;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateOutputToolDto && equalTo((UpdateOutputToolDto) other);
    }
    ...
    private boolean equalTo(UpdateOutputToolDto other) {
    ...
    public static final class Builder {
        private Optional<List<UpdateOutputToolDtoMessagesItem>> messages = Optional.empty();
        ...
        public Builder from(UpdateOutputToolDto other) {
        ...
        public Builder messages(Optional<List<UpdateOutputToolDtoMessagesItem>> messages) {
            this.messages = messages;
            return this;
        }

        public Builder messages(List<UpdateOutputToolDtoMessagesItem> messages) {
        ...
        public UpdateOutputToolDto build() {
            return new UpdateOutputToolDto(messages, function, additionalProperties);
        }
    }
}

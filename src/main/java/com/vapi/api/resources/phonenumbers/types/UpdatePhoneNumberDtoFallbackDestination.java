...
import com.vapi.api.types.TransferDestinationNumber;
import com.vapi.api.types.TransferDestinationSip;
import java.util.Objects;
import java.util.Optional;

public final class UpdatePhoneNumberDtoFallbackDestination {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private UpdatePhoneNumberDtoFallbackDestination(Value value) {
        this.value = value;
    }
    ...
    public static UpdatePhoneNumberDtoFallbackDestination number(TransferDestinationNumber value) {
        return new UpdatePhoneNumberDtoFallbackDestination(new NumberValue(value));
    }

    public static UpdatePhoneNumberDtoFallbackDestination sip(TransferDestinationSip value) {
        return new UpdatePhoneNumberDtoFallbackDestination(new SipValue(value));
    }
    ...
    private static final class NumberValue implements Value {
        ...
        public String toString() {
            return "UpdatePhoneNumberDtoFallbackDestination{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "UpdatePhoneNumberDtoFallbackDestination{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

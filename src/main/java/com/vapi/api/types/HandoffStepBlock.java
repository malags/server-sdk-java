...
public final class HandoffStepBlock {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private HandoffStepBlock(Value value) {
        this.value = value;
    }
    ...
    public static HandoffStepBlock conversation(CreateConversationBlockDto value) {
        return new HandoffStepBlock(new ConversationValue(value));
    }

    public static HandoffStepBlock toolCall(CreateToolCallBlockDto value) {
        return new HandoffStepBlock(new ToolCallValue(value));
    }

    public static HandoffStepBlock workflow(CreateWorkflowBlockDto value) {
        return new HandoffStepBlock(new WorkflowValue(value));
    }
    ...
    private static final class ConversationValue implements Value {
        ...
        public String toString() {
            return "HandoffStepBlock{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "HandoffStepBlock{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

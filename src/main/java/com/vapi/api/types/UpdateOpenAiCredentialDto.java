...
public final class UpdateOpenAiCredentialDto {
    ...
    private UpdateOpenAiCredentialDto(String apiKey, Optional<String> name, Map<String, Object> additionalProperties) {
        this.apiKey = apiKey;
        this.name = name;
    ...
    public static final class Builder implements ApiKeyStage, _FinalStage {
        ...
        public UpdateOpenAiCredentialDto build() {
            return new UpdateOpenAiCredentialDto(apiKey, name, additionalProperties);
        }
    }
}

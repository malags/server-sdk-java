...
public final class ToolsCreateResponse {
    ...
    public static ToolsCreateResponse apiRequest(ApiRequestTool value) {
        return new ToolsCreateResponse(new ApiRequestValue(value));
    }
    ...
    public static ToolsCreateResponse query(QueryTool value) {
        return new ToolsCreateResponse(new QueryValue(value));
    }

    public static ToolsCreateResponse googleCalendarEventCreate(GoogleCalendarCreateEventTool value) {
        return new ToolsCreateResponse(new GoogleCalendarEventCreateValue(value));
    }

    public static ToolsCreateResponse googleSheetsRowAppend(GoogleSheetsRowAppendTool value) {
        return new ToolsCreateResponse(new GoogleSheetsRowAppendValue(value));
    }

    public static ToolsCreateResponse googleCalendarAvailabilityCheck(GoogleCalendarCheckAvailabilityTool value) {
        return new ToolsCreateResponse(new GoogleCalendarAvailabilityCheckValue(value));
    }

    public static ToolsCreateResponse slackMessageSend(SlackSendMessageTool value) {
        return new ToolsCreateResponse(new SlackMessageSendValue(value));
    }

    public static ToolsCreateResponse sms(SmsTool value) {
        return new ToolsCreateResponse(new SmsValue(value));
    }

    public static ToolsCreateResponse mcp(McpTool value) {
        return new ToolsCreateResponse(new McpValue(value));
    }

    public static ToolsCreateResponse gohighlevelCalendarAvailabilityCheck(GoHighLevelCalendarAvailabilityTool value) {
        return new ToolsCreateResponse(new GohighlevelCalendarAvailabilityCheckValue(value));
    }

    public static ToolsCreateResponse gohighlevelCalendarEventCreate(GoHighLevelCalendarEventCreateTool value) {
        return new ToolsCreateResponse(new GohighlevelCalendarEventCreateValue(value));
    }

    public static ToolsCreateResponse gohighlevelContactCreate(GoHighLevelContactCreateTool value) {
        return new ToolsCreateResponse(new GohighlevelContactCreateValue(value));
    }

    public static ToolsCreateResponse gohighlevelContactGet(GoHighLevelContactGetTool value) {
        return new ToolsCreateResponse(new GohighlevelContactGetValue(value));
    }

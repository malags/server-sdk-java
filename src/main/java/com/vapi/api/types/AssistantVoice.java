...
public final class AssistantVoice {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private AssistantVoice(Value value) {
        this.value = value;
    }
    ...
    public static AssistantVoice azure(AzureVoice value) {
        return new AssistantVoice(new AzureValue(value));
    }

    public static AssistantVoice cartesia(CartesiaVoice value) {
        return new AssistantVoice(new CartesiaValue(value));
    }

    public static AssistantVoice customVoice(CustomVoice value) {
        return new AssistantVoice(new CustomVoiceValue(value));
    }

    public static AssistantVoice deepgram(DeepgramVoice value) {
        return new AssistantVoice(new DeepgramValue(value));
    }

    public static AssistantVoice _11Labs(ElevenLabsVoice value) {
        return new AssistantVoice(new _11LabsValue(value));
    }

    public static AssistantVoice hume(HumeVoice value) {
        return new AssistantVoice(new HumeValue(value));
    }

    public static AssistantVoice lmnt(LmntVoice value) {
        return new AssistantVoice(new LmntValue(value));
    }

    public static AssistantVoice neuphonic(NeuphonicVoice value) {
        return new AssistantVoice(new NeuphonicValue(value));
    }

    public static AssistantVoice openai(OpenAiVoice value) {
        return new AssistantVoice(new OpenaiValue(value));
    }

    public static AssistantVoice playht(PlayHtVoice value) {
        return new AssistantVoice(new PlayhtValue(value));
    }

    public static AssistantVoice rimeAi(RimeAiVoice value) {
        return new AssistantVoice(new RimeAiValue(value));
    }

    public static AssistantVoice smallestAi(SmallestAiVoice value) {
        return new AssistantVoice(new SmallestAiValue(value));
    }

    public static AssistantVoice tavus(TavusVoice value) {
        return new AssistantVoice(new TavusValue(value));
    }

    public static AssistantVoice vapi(VapiVoice value) {
        return new AssistantVoice(new VapiValue(value));
    }

    public static AssistantVoice sesame(SesameVoice value) {
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "AssistantVoice{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

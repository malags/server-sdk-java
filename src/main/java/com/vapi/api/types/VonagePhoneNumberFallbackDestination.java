...
public final class VonagePhoneNumberFallbackDestination {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private VonagePhoneNumberFallbackDestination(Value value) {
        this.value = value;
    }
    ...
    public static VonagePhoneNumberFallbackDestination number(TransferDestinationNumber value) {
        return new VonagePhoneNumberFallbackDestination(new NumberValue(value));
    }

    public static VonagePhoneNumberFallbackDestination sip(TransferDestinationSip value) {
        return new VonagePhoneNumberFallbackDestination(new SipValue(value));
    }
    ...
    private static final class NumberValue implements Value {
        ...
        public String toString() {
            return "VonagePhoneNumberFallbackDestination{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "VonagePhoneNumberFallbackDestination{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

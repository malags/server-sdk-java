...
public final class McpToolMessagesItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private McpToolMessagesItem(Value value) {
        this.value = value;
    }
    ...
    public static McpToolMessagesItem requestStart(ToolMessageStart value) {
        return new McpToolMessagesItem(new RequestStartValue(value));
    }

    public static McpToolMessagesItem requestComplete(ToolMessageComplete value) {
        return new McpToolMessagesItem(new RequestCompleteValue(value));
    }

    public static McpToolMessagesItem requestFailed(ToolMessageFailed value) {
        return new McpToolMessagesItem(new RequestFailedValue(value));
    }

    public static McpToolMessagesItem requestResponseDelayed(ToolMessageDelayed value) {
        return new McpToolMessagesItem(new RequestResponseDelayedValue(value));
    }
    ...
    private static final class RequestStartValue implements Value {
        ...
        public String toString() {
            return "McpToolMessagesItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "McpToolMessagesItem{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

...
@JsonDeserialize(builder = PerplexityAiModel.Builder.class)
public final class PerplexityAiModel {
    private final Optional<List<OpenAiMessage>> messages;

    private final Optional<List<PerplexityAiModelToolsItem>> tools;
     ...
     */
    @JsonProperty("tools")
    public Optional<List<PerplexityAiModelToolsItem>> getTools() {
        return tools;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof PerplexityAiModel && equalTo((PerplexityAiModel) other);
    }
    ...
    private boolean equalTo(PerplexityAiModel other) {
    ...
    public interface ModelStage {
        ...
        Builder from(PerplexityAiModel other);
    }

    public interface _FinalStage {
        PerplexityAiModel build();

        _FinalStage messages(Optional<List<OpenAiMessage>> messages);

        _FinalStage messages(List<OpenAiMessage> messages);

        _FinalStage tools(Optional<List<PerplexityAiModelToolsItem>> tools);

        _FinalStage tools(List<PerplexityAiModelToolsItem> tools);
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        private Optional<List<PerplexityAiModelToolsItem>> tools = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(PerplexityAiModel other) {
         ...
         */
        @java.lang.Override
        public _FinalStage tools(List<PerplexityAiModelToolsItem> tools) {
        ...
        public _FinalStage tools(Optional<List<PerplexityAiModelToolsItem>> tools) {
            this.tools = tools;
            return this;
        }
        ...
        @java.lang.Override
        public PerplexityAiModel build() {
            return new PerplexityAiModel(
                    messages,
                    tools,
                    toolIds,
                    model,

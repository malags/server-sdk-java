...
public final class GoogleModelToolsItem {
    ...
    public static GoogleModelToolsItem voicemail(CreateVoicemailToolDto value) {
        return new GoogleModelToolsItem(new VoicemailValue(value));
    }
    ...
    public static GoogleModelToolsItem ghl(CreateGhlToolDto value) {
        return new GoogleModelToolsItem(new GhlValue(value));
    }

    public static GoogleModelToolsItem make(CreateMakeToolDto value) {
        return new GoogleModelToolsItem(new MakeValue(value));
    }

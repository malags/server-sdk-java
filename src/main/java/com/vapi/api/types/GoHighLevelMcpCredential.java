...
@JsonDeserialize(builder = GoHighLevelMcpCredential.Builder.class)
public final class GoHighLevelMcpCredential {
    ...
    private GoHighLevelMcpCredential(
    ...
    public String getProvider() {
        return "ghl.oauth2-authorization";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GoHighLevelMcpCredential && equalTo((GoHighLevelMcpCredential) other);
    }
    ...
    private boolean equalTo(GoHighLevelMcpCredential other) {
        return authenticationSession.equals(other.authenticationSession)
                && id.equals(other.id)
    ...
    @java.lang.Override
    public int hashCode() {
        return Objects.hash(this.authenticationSession, this.id, this.orgId, this.createdAt, this.updatedAt, this.name);
    }
    ...
    public static final class Builder
            implements AuthenticationSessionStage, IdStage, OrgIdStage, CreatedAtStage, UpdatedAtStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(GoHighLevelMcpCredential other) {
        ...
        public IdStage authenticationSession(@NotNull Oauth2AuthenticationSession authenticationSession) {
        ...
        @java.lang.Override
        public GoHighLevelMcpCredential build() {
            return new GoHighLevelMcpCredential(
                    authenticationSession, id, orgId, createdAt, updatedAt, name, additionalProperties);
        }
    }
}

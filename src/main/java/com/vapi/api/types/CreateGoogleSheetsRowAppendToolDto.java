...
@JsonDeserialize(builder = CreateGoogleSheetsRowAppendToolDto.Builder.class)
public final class CreateGoogleSheetsRowAppendToolDto {
    private final Optional<List<CreateGoogleSheetsRowAppendToolDtoMessagesItem>> messages;

    private final Optional<OpenAiFunction> function;

    private final Map<String, Object> additionalProperties;

    private CreateGoogleSheetsRowAppendToolDto(
            Optional<List<CreateGoogleSheetsRowAppendToolDtoMessagesItem>> messages,
    ...
    public Optional<List<CreateGoogleSheetsRowAppendToolDtoMessagesItem>> getMessages() {
        return messages;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateGoogleSheetsRowAppendToolDto
                && equalTo((CreateGoogleSheetsRowAppendToolDto) other);
    }
    ...
    private boolean equalTo(CreateGoogleSheetsRowAppendToolDto other) {
    ...
    public static final class Builder {
        private Optional<List<CreateGoogleSheetsRowAppendToolDtoMessagesItem>> messages = Optional.empty();
        ...
        public Builder from(CreateGoogleSheetsRowAppendToolDto other) {
        ...
        public Builder messages(Optional<List<CreateGoogleSheetsRowAppendToolDtoMessagesItem>> messages) {
            this.messages = messages;
            return this;
        }

        public Builder messages(List<CreateGoogleSheetsRowAppendToolDtoMessagesItem> messages) {
        ...
        public CreateGoogleSheetsRowAppendToolDto build() {
            return new CreateGoogleSheetsRowAppendToolDto(messages, function, additionalProperties);
        }
    }
}

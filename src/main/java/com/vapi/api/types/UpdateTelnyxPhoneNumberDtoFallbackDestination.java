...
public final class UpdateTelnyxPhoneNumberDtoFallbackDestination {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private UpdateTelnyxPhoneNumberDtoFallbackDestination(Value value) {
        this.value = value;
    }
    ...
    public static UpdateTelnyxPhoneNumberDtoFallbackDestination number(TransferDestinationNumber value) {
        return new UpdateTelnyxPhoneNumberDtoFallbackDestination(new NumberValue(value));
    }

    public static UpdateTelnyxPhoneNumberDtoFallbackDestination sip(TransferDestinationSip value) {
        return new UpdateTelnyxPhoneNumberDtoFallbackDestination(new SipValue(value));
    }
    ...
    private static final class NumberValue implements Value {
        ...
        public String toString() {
            return "UpdateTelnyxPhoneNumberDtoFallbackDestination{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "UpdateTelnyxPhoneNumberDtoFallbackDestination{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

...
@JsonDeserialize(builder = InworldVoice.Builder.class)
public final class InworldVoice {
    private final Optional<Boolean> cachingEnabled;

    private final InworldVoiceVoiceId voiceId;

    private final Optional<String> model;

    private final Optional<InworldVoiceLanguageCode> languageCode;
    ...
    private InworldVoice(
            Optional<Boolean> cachingEnabled,
            InworldVoiceVoiceId voiceId,
            Optional<String> model,
            Optional<InworldVoiceLanguageCode> languageCode,
    ...
    public InworldVoiceVoiceId getVoiceId() {
        return voiceId;
    }
    ...
    public Optional<InworldVoiceLanguageCode> getLanguageCode() {
        return languageCode;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof InworldVoice && equalTo((InworldVoice) other);
    }
    ...
    private boolean equalTo(InworldVoice other) {
    ...
    public int hashCode() {
        return Objects.hash(
                this.cachingEnabled, this.voiceId, this.model, this.languageCode, this.chunkPlan, this.fallbackPlan);
    }
    ...
    public interface VoiceIdStage {
         ...
         */
        _FinalStage voiceId(@NotNull InworldVoiceVoiceId voiceId);

        Builder from(InworldVoice other);
    }
    ...
    public interface _FinalStage {
         ...
         */
        _FinalStage languageCode(Optional<InworldVoiceLanguageCode> languageCode);

        _FinalStage languageCode(InworldVoiceLanguageCode languageCode);
    ...
    public static final class Builder implements VoiceIdStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(InworldVoice other) {
        ...
        @java.lang.Override
        @JsonSetter("voiceId")
        public _FinalStage voiceId(@NotNull InworldVoiceVoiceId voiceId) {
         ...
         */
        @java.lang.Override
        public _FinalStage languageCode(InworldVoiceLanguageCode languageCode) {
        ...
        public _FinalStage languageCode(Optional<InworldVoiceLanguageCode> languageCode) {
            this.languageCode = languageCode;
            return this;
        }
        ...
        @java.lang.Override
        public InworldVoice build() {
            return new InworldVoice(
                    cachingEnabled, voiceId, model, languageCode, chunkPlan, fallbackPlan, additionalProperties);
        }
    }
}

...
public final class UpdateByoPhoneNumberDtoFallbackDestination {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private UpdateByoPhoneNumberDtoFallbackDestination(Value value) {
        this.value = value;
    }
    ...
    public static UpdateByoPhoneNumberDtoFallbackDestination number(TransferDestinationNumber value) {
        return new UpdateByoPhoneNumberDtoFallbackDestination(new NumberValue(value));
    }

    public static UpdateByoPhoneNumberDtoFallbackDestination sip(TransferDestinationSip value) {
        return new UpdateByoPhoneNumberDtoFallbackDestination(new SipValue(value));
    }
    ...
    private static final class NumberValue implements Value {
        ...
        public String toString() {
            return "UpdateByoPhoneNumberDtoFallbackDestination{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "UpdateByoPhoneNumberDtoFallbackDestination{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

...
import com.vapi.api.resources.chats.types.ChatsListRequestSortOrder;
...
@JsonDeserialize(builder = ChatsListRequest.Builder.class)
public final class ChatsListRequest {
    ...
    private final Optional<ChatsListRequestSortOrder> sortOrder;
    ...
    private ChatsListRequest(
            Optional<String> assistantId,
            Optional<String> workflowId,
            Optional<String> sessionId,
            Optional<Double> page,
            Optional<ChatsListRequestSortOrder> sortOrder,
     ...
     */
    @JsonIgnore
    public Optional<ChatsListRequestSortOrder> getSortOrder() {
        if (sortOrder == null) {
            return Optional.empty();
        }
        return sortOrder;
    ...
    private Optional<ChatsListRequestSortOrder> _getSortOrder() {
        return sortOrder;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ChatsListRequest && equalTo((ChatsListRequest) other);
    }
    ...
    private boolean equalTo(ChatsListRequest other) {
    ...
    public static final class Builder {
        ...
        private Optional<ChatsListRequestSortOrder> sortOrder = Optional.empty();
        ...
        public Builder from(ChatsListRequest other) {
        ...
        public Builder sortOrder(Optional<ChatsListRequestSortOrder> sortOrder) {
            this.sortOrder = sortOrder;
            return this;
        }

        public Builder sortOrder(ChatsListRequestSortOrder sortOrder) {
            this.sortOrder = Optional.ofNullable(sortOrder);
            return this;
        }

        public Builder sortOrder(Nullable<ChatsListRequestSortOrder> sortOrder) {
            if (sortOrder.isNull()) {
                this.sortOrder = null;
        ...
        public ChatsListRequest build() {
            return new ChatsListRequest(
                    assistantId,
                    workflowId,
                    sessionId,
                    page,

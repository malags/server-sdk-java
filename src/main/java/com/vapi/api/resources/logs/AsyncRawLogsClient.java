...
public class AsyncRawLogsClient {
    ...
    public CompletableFuture<VapiHttpResponse<SyncPagingIterable<Log>>> get() {
        return get(LogsGetRequest.builder().build());
    }

    public CompletableFuture<VapiHttpResponse<SyncPagingIterable<Log>>> get(LogsGetRequest request) {
        return get(request, null);
    }

    public CompletableFuture<VapiHttpResponse<SyncPagingIterable<Log>>> get(
            LogsGetRequest request, RequestOptions requestOptions) {
        ...
        CompletableFuture<VapiHttpResponse<SyncPagingIterable<Log>>> future = new CompletableFuture<>();
    ...
    public CompletableFuture<VapiHttpResponse<Void>> loggingControllerLogsDeleteQuery() {

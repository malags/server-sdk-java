...
public final class ClientMessageTransferUpdateDestination {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private ClientMessageTransferUpdateDestination(Value value) {
        this.value = value;
    }
    ...
    public static ClientMessageTransferUpdateDestination assistant(TransferDestinationAssistant value) {
    ...
    public static ClientMessageTransferUpdateDestination sip(TransferDestinationSip value) {
        return new ClientMessageTransferUpdateDestination(new SipValue(value));
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "ClientMessageTransferUpdateDestination{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

...
public final class BashToolWithToolCallMessagesItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private BashToolWithToolCallMessagesItem(Value value) {
        this.value = value;
    }
    ...
    public static BashToolWithToolCallMessagesItem requestStart(ToolMessageStart value) {
        return new BashToolWithToolCallMessagesItem(new RequestStartValue(value));
    }

    public static BashToolWithToolCallMessagesItem requestComplete(ToolMessageComplete value) {
        return new BashToolWithToolCallMessagesItem(new RequestCompleteValue(value));
    }

    public static BashToolWithToolCallMessagesItem requestFailed(ToolMessageFailed value) {
        return new BashToolWithToolCallMessagesItem(new RequestFailedValue(value));
    }

    public static BashToolWithToolCallMessagesItem requestResponseDelayed(ToolMessageDelayed value) {
        return new BashToolWithToolCallMessagesItem(new RequestResponseDelayedValue(value));
    }
    ...
    private static final class RequestStartValue implements Value {
        ...
        public String toString() {
            return "BashToolWithToolCallMessagesItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "BashToolWithToolCallMessagesItem{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

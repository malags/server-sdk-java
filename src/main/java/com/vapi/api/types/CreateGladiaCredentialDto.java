...
public final class CreateGladiaCredentialDto {
    ...
    private CreateGladiaCredentialDto(String apiKey, Optional<String> name, Map<String, Object> additionalProperties) {
        this.apiKey = apiKey;
        this.name = name;
    ...
    public static final class Builder implements ApiKeyStage, _FinalStage {
        ...
        public CreateGladiaCredentialDto build() {
            return new CreateGladiaCredentialDto(apiKey, name, additionalProperties);
        }
    }
}

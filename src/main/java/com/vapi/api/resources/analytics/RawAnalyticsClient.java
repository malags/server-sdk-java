...
public class RawAnalyticsClient {
    ...
    public VapiHttpResponse<List<AnalyticsQueryResult>> get(AnalyticsQueryDto request) {
        return get(request, null);
    }

    public VapiHttpResponse<List<AnalyticsQueryResult>> get(AnalyticsQueryDto request, RequestOptions requestOptions) {

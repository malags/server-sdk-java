...
public final class TransferAssistantHookActionDestination {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private TransferAssistantHookActionDestination(Value value) {
        this.value = value;
    }
    ...
    public static TransferAssistantHookActionDestination number(TransferDestinationNumber value) {
        return new TransferAssistantHookActionDestination(new NumberValue(value));
    }

    public static TransferAssistantHookActionDestination sip(TransferDestinationSip value) {
        return new TransferAssistantHookActionDestination(new SipValue(value));
    }
    ...
    private static final class NumberValue implements Value {
        ...
        public String toString() {
            return "TransferAssistantHookActionDestination{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "TransferAssistantHookActionDestination{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

...
@JsonDeserialize(builder = UpdateGoHighLevelContactGetToolDto.Builder.class)
public final class UpdateGoHighLevelContactGetToolDto {
    private final Optional<List<UpdateGoHighLevelContactGetToolDtoMessagesItem>> messages;

    private final Optional<OpenAiFunction> function;

    private final Map<String, Object> additionalProperties;

    private UpdateGoHighLevelContactGetToolDto(
            Optional<List<UpdateGoHighLevelContactGetToolDtoMessagesItem>> messages,
    ...
    public Optional<List<UpdateGoHighLevelContactGetToolDtoMessagesItem>> getMessages() {
        return messages;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateGoHighLevelContactGetToolDto
                && equalTo((UpdateGoHighLevelContactGetToolDto) other);
    }
    ...
    private boolean equalTo(UpdateGoHighLevelContactGetToolDto other) {
    ...
    public static final class Builder {
        private Optional<List<UpdateGoHighLevelContactGetToolDtoMessagesItem>> messages = Optional.empty();
        ...
        public Builder from(UpdateGoHighLevelContactGetToolDto other) {
        ...
        public Builder messages(Optional<List<UpdateGoHighLevelContactGetToolDtoMessagesItem>> messages) {
            this.messages = messages;
            return this;
        }

        public Builder messages(List<UpdateGoHighLevelContactGetToolDtoMessagesItem> messages) {
        ...
        public UpdateGoHighLevelContactGetToolDto build() {
            return new UpdateGoHighLevelContactGetToolDto(messages, function, additionalProperties);
        }
    }
}

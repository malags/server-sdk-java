...
public final class WorkflowTranscriber {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private WorkflowTranscriber(Value value) {
        this.value = value;
    }
    ...
    public static WorkflowTranscriber assemblyAi(AssemblyAiTranscriber value) {
        return new WorkflowTranscriber(new AssemblyAiValue(value));
    }

    public static WorkflowTranscriber azure(AzureSpeechTranscriber value) {
        return new WorkflowTranscriber(new AzureValue(value));
    }

    public static WorkflowTranscriber customTranscriber(CustomTranscriber value) {
        return new WorkflowTranscriber(new CustomTranscriberValue(value));
    }

    public static WorkflowTranscriber deepgram(DeepgramTranscriber value) {
        return new WorkflowTranscriber(new DeepgramValue(value));
    }

    public static WorkflowTranscriber _11Labs(ElevenLabsTranscriber value) {
        return new WorkflowTranscriber(new _11LabsValue(value));
    }

    public static WorkflowTranscriber gladia(GladiaTranscriber value) {
        return new WorkflowTranscriber(new GladiaValue(value));
    }

    public static WorkflowTranscriber google(GoogleTranscriber value) {
        return new WorkflowTranscriber(new GoogleValue(value));
    }

    public static WorkflowTranscriber speechmatics(SpeechmaticsTranscriber value) {
        return new WorkflowTranscriber(new SpeechmaticsValue(value));
    }

    public static WorkflowTranscriber talkscriber(TalkscriberTranscriber value) {
        return new WorkflowTranscriber(new TalkscriberValue(value));
    }

    public static WorkflowTranscriber openai(OpenAiTranscriber value) {
        return new WorkflowTranscriber(new OpenaiValue(value));
    }

    public static WorkflowTranscriber cartesia(CartesiaTranscriber value) {
        return new WorkflowTranscriber(new CartesiaValue(value));
    }
    ...
    private static final class AssemblyAiValue implements Value {
        ...
        public String toString() {
            return "WorkflowTranscriber{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "WorkflowTranscriber{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

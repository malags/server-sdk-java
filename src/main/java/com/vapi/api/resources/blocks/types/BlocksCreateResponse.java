...
public final class BlocksCreateResponse {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private BlocksCreateResponse(Value value) {
        this.value = value;
    }
    ...
    public static BlocksCreateResponse conversation(ConversationBlock value) {
        return new BlocksCreateResponse(new ConversationValue(value));
    }

    public static BlocksCreateResponse toolCall(ToolCallBlock value) {
        return new BlocksCreateResponse(new ToolCallValue(value));
    }

    public static BlocksCreateResponse workflow(WorkflowBlock value) {
        return new BlocksCreateResponse(new WorkflowValue(value));
    }
    ...
    private static final class ConversationValue implements Value {
        ...
        public String toString() {
            return "BlocksCreateResponse{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "BlocksCreateResponse{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

...
public final class UpdateVapiPhoneNumberDtoFallbackDestination {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private UpdateVapiPhoneNumberDtoFallbackDestination(Value value) {
        this.value = value;
    }
    ...
    public static UpdateVapiPhoneNumberDtoFallbackDestination number(TransferDestinationNumber value) {
        return new UpdateVapiPhoneNumberDtoFallbackDestination(new NumberValue(value));
    }

    public static UpdateVapiPhoneNumberDtoFallbackDestination sip(TransferDestinationSip value) {
        return new UpdateVapiPhoneNumberDtoFallbackDestination(new SipValue(value));
    }
    ...
    private static final class NumberValue implements Value {
        ...
        public String toString() {
            return "UpdateVapiPhoneNumberDtoFallbackDestination{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "UpdateVapiPhoneNumberDtoFallbackDestination{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

...
@JsonDeserialize(builder = GoHighLevelContactCreateToolWithToolCall.Builder.class)
public final class GoHighLevelContactCreateToolWithToolCall {
    private final Optional<List<GoHighLevelContactCreateToolWithToolCallMessagesItem>> messages;
    ...
    private GoHighLevelContactCreateToolWithToolCall(
            Optional<List<GoHighLevelContactCreateToolWithToolCallMessagesItem>> messages,
            ToolCall toolCall,
    ...
    public Optional<List<GoHighLevelContactCreateToolWithToolCallMessagesItem>> getMessages() {
        return messages;
    }

    /**
     * @return The type of tool. &quot;gohighlevel.contact.create&quot; for GoHighLevel contact create tool.
     */
    @JsonProperty("type")
    public String getType() {
        return "gohighlevel.contact.create";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GoHighLevelContactCreateToolWithToolCall
                && equalTo((GoHighLevelContactCreateToolWithToolCall) other);
    }
    ...
    private boolean equalTo(GoHighLevelContactCreateToolWithToolCall other) {
    ...
    public interface ToolCallStage {
        ...
        Builder from(GoHighLevelContactCreateToolWithToolCall other);
    }

    public interface _FinalStage {
        GoHighLevelContactCreateToolWithToolCall build();

        /**
         * <p>These are the messages that will be spoken to the user as the tool is running.</p>
         * <p>For some tools, this is auto-filled based on special fields like <code>tool.destinations</code>. For others like the function tool, these can be custom configured.</p>
         */
        _FinalStage messages(Optional<List<GoHighLevelContactCreateToolWithToolCallMessagesItem>> messages);

        _FinalStage messages(List<GoHighLevelContactCreateToolWithToolCallMessagesItem> messages);
    ...
    public static final class Builder implements ToolCallStage, _FinalStage {
        ...
        private Optional<List<GoHighLevelContactCreateToolWithToolCallMessagesItem>> messages = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(GoHighLevelContactCreateToolWithToolCall other) {
         ...
         */
        @java.lang.Override
        public _FinalStage messages(List<GoHighLevelContactCreateToolWithToolCallMessagesItem> messages) {
        ...
        public _FinalStage messages(Optional<List<GoHighLevelContactCreateToolWithToolCallMessagesItem>> messages) {
            this.messages = messages;
            return this;
        }

        @java.lang.Override
        public GoHighLevelContactCreateToolWithToolCall build() {
            return new GoHighLevelContactCreateToolWithToolCall(messages, toolCall, function, additionalProperties);
        }
    }
}

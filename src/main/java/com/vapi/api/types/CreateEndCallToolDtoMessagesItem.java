...
public final class CreateEndCallToolDtoMessagesItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private CreateEndCallToolDtoMessagesItem(Value value) {
        this.value = value;
    }
    ...
    public static CreateEndCallToolDtoMessagesItem requestStart(ToolMessageStart value) {
        return new CreateEndCallToolDtoMessagesItem(new RequestStartValue(value));
    }

    public static CreateEndCallToolDtoMessagesItem requestComplete(ToolMessageComplete value) {
        return new CreateEndCallToolDtoMessagesItem(new RequestCompleteValue(value));
    }

    public static CreateEndCallToolDtoMessagesItem requestFailed(ToolMessageFailed value) {
        return new CreateEndCallToolDtoMessagesItem(new RequestFailedValue(value));
    }

    public static CreateEndCallToolDtoMessagesItem requestResponseDelayed(ToolMessageDelayed value) {
        return new CreateEndCallToolDtoMessagesItem(new RequestResponseDelayedValue(value));
    }
    ...
    private static final class RequestStartValue implements Value {
        ...
        public String toString() {
            return "CreateEndCallToolDtoMessagesItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "CreateEndCallToolDtoMessagesItem{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

...
public final class ByoPhoneNumberFallbackDestination {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private ByoPhoneNumberFallbackDestination(Value value) {
        this.value = value;
    }
    ...
    public static ByoPhoneNumberFallbackDestination number(TransferDestinationNumber value) {
        return new ByoPhoneNumberFallbackDestination(new NumberValue(value));
    }

    public static ByoPhoneNumberFallbackDestination sip(TransferDestinationSip value) {
        return new ByoPhoneNumberFallbackDestination(new SipValue(value));
    }
    ...
    private static final class NumberValue implements Value {
        ...
        public String toString() {
            return "ByoPhoneNumberFallbackDestination{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "ByoPhoneNumberFallbackDestination{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

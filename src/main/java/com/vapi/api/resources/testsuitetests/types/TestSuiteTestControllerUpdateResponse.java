...
public final class TestSuiteTestControllerUpdateResponse {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private TestSuiteTestControllerUpdateResponse(Value value) {
        this.value = value;
    }
    ...
    public static TestSuiteTestControllerUpdateResponse voice(TestSuiteTestVoice value) {
        return new TestSuiteTestControllerUpdateResponse(new VoiceValue(value));
    }

    public static TestSuiteTestControllerUpdateResponse chat(TestSuiteTestChat value) {
        return new TestSuiteTestControllerUpdateResponse(new ChatValue(value));
    }
    ...
    private static final class VoiceValue implements Value {
        ...
        public String toString() {
            return "TestSuiteTestControllerUpdateResponse{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "TestSuiteTestControllerUpdateResponse{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

...
public final class CreateWorkflowDtoTranscriber {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private CreateWorkflowDtoTranscriber(Value value) {
        this.value = value;
    }
    ...
    public static CreateWorkflowDtoTranscriber assemblyAi(AssemblyAiTranscriber value) {
        return new CreateWorkflowDtoTranscriber(new AssemblyAiValue(value));
    }

    public static CreateWorkflowDtoTranscriber azure(AzureSpeechTranscriber value) {
        return new CreateWorkflowDtoTranscriber(new AzureValue(value));
    }

    public static CreateWorkflowDtoTranscriber customTranscriber(CustomTranscriber value) {
        return new CreateWorkflowDtoTranscriber(new CustomTranscriberValue(value));
    }

    public static CreateWorkflowDtoTranscriber deepgram(DeepgramTranscriber value) {
        return new CreateWorkflowDtoTranscriber(new DeepgramValue(value));
    }

    public static CreateWorkflowDtoTranscriber _11Labs(ElevenLabsTranscriber value) {
        return new CreateWorkflowDtoTranscriber(new _11LabsValue(value));
    }

    public static CreateWorkflowDtoTranscriber gladia(GladiaTranscriber value) {
        return new CreateWorkflowDtoTranscriber(new GladiaValue(value));
    }

    public static CreateWorkflowDtoTranscriber google(GoogleTranscriber value) {
        return new CreateWorkflowDtoTranscriber(new GoogleValue(value));
    }

    public static CreateWorkflowDtoTranscriber speechmatics(SpeechmaticsTranscriber value) {
        return new CreateWorkflowDtoTranscriber(new SpeechmaticsValue(value));
    }

    public static CreateWorkflowDtoTranscriber talkscriber(TalkscriberTranscriber value) {
        return new CreateWorkflowDtoTranscriber(new TalkscriberValue(value));
    }

    public static CreateWorkflowDtoTranscriber openai(OpenAiTranscriber value) {
        return new CreateWorkflowDtoTranscriber(new OpenaiValue(value));
    }

    public static CreateWorkflowDtoTranscriber cartesia(CartesiaTranscriber value) {
        return new CreateWorkflowDtoTranscriber(new CartesiaValue(value));
    }
    ...
    private static final class AssemblyAiValue implements Value {
        ...
        public String toString() {
            return "CreateWorkflowDtoTranscriber{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "CreateWorkflowDtoTranscriber{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

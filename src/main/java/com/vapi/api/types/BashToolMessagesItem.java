...
public final class BashToolMessagesItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private BashToolMessagesItem(Value value) {
        this.value = value;
    }
    ...
    public static BashToolMessagesItem requestStart(ToolMessageStart value) {
        return new BashToolMessagesItem(new RequestStartValue(value));
    }

    public static BashToolMessagesItem requestComplete(ToolMessageComplete value) {
        return new BashToolMessagesItem(new RequestCompleteValue(value));
    }

    public static BashToolMessagesItem requestFailed(ToolMessageFailed value) {
        return new BashToolMessagesItem(new RequestFailedValue(value));
    }

    public static BashToolMessagesItem requestResponseDelayed(ToolMessageDelayed value) {
        return new BashToolMessagesItem(new RequestResponseDelayedValue(value));
    }
    ...
    private static final class RequestStartValue implements Value {
        ...
        public String toString() {
            return "BashToolMessagesItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "BashToolMessagesItem{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

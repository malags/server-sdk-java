...
@JsonDeserialize(builder = CreateGoogleCalendarCreateEventToolDto.Builder.class)
public final class CreateGoogleCalendarCreateEventToolDto {
    private final Optional<List<CreateGoogleCalendarCreateEventToolDtoMessagesItem>> messages;

    private final Optional<OpenAiFunction> function;

    private final Map<String, Object> additionalProperties;

    private CreateGoogleCalendarCreateEventToolDto(
            Optional<List<CreateGoogleCalendarCreateEventToolDtoMessagesItem>> messages,
    ...
    public Optional<List<CreateGoogleCalendarCreateEventToolDtoMessagesItem>> getMessages() {
        return messages;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateGoogleCalendarCreateEventToolDto
                && equalTo((CreateGoogleCalendarCreateEventToolDto) other);
    }
    ...
    private boolean equalTo(CreateGoogleCalendarCreateEventToolDto other) {
    ...
    public static final class Builder {
        private Optional<List<CreateGoogleCalendarCreateEventToolDtoMessagesItem>> messages = Optional.empty();
        ...
        public Builder from(CreateGoogleCalendarCreateEventToolDto other) {
        ...
        public Builder messages(Optional<List<CreateGoogleCalendarCreateEventToolDtoMessagesItem>> messages) {
            this.messages = messages;
            return this;
        }

        public Builder messages(List<CreateGoogleCalendarCreateEventToolDtoMessagesItem> messages) {
        ...
        public CreateGoogleCalendarCreateEventToolDto build() {
            return new CreateGoogleCalendarCreateEventToolDto(messages, function, additionalProperties);
        }
    }
}

...
public final class OutputToolMessagesItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private OutputToolMessagesItem(Value value) {
        this.value = value;
    }
    ...
    public static OutputToolMessagesItem requestStart(ToolMessageStart value) {
        return new OutputToolMessagesItem(new RequestStartValue(value));
    }

    public static OutputToolMessagesItem requestComplete(ToolMessageComplete value) {
        return new OutputToolMessagesItem(new RequestCompleteValue(value));
    }

    public static OutputToolMessagesItem requestFailed(ToolMessageFailed value) {
        return new OutputToolMessagesItem(new RequestFailedValue(value));
    }

    public static OutputToolMessagesItem requestResponseDelayed(ToolMessageDelayed value) {
        return new OutputToolMessagesItem(new RequestResponseDelayedValue(value));
    }
    ...
    private static final class RequestStartValue implements Value {
        ...
        public String toString() {
            return "OutputToolMessagesItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "OutputToolMessagesItem{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

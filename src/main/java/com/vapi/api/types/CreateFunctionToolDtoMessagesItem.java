...
public final class CreateFunctionToolDtoMessagesItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private CreateFunctionToolDtoMessagesItem(Value value) {
        this.value = value;
    }
    ...
    public static CreateFunctionToolDtoMessagesItem requestStart(ToolMessageStart value) {
        return new CreateFunctionToolDtoMessagesItem(new RequestStartValue(value));
    }

    public static CreateFunctionToolDtoMessagesItem requestComplete(ToolMessageComplete value) {
        return new CreateFunctionToolDtoMessagesItem(new RequestCompleteValue(value));
    }

    public static CreateFunctionToolDtoMessagesItem requestFailed(ToolMessageFailed value) {
        return new CreateFunctionToolDtoMessagesItem(new RequestFailedValue(value));
    }

    public static CreateFunctionToolDtoMessagesItem requestResponseDelayed(ToolMessageDelayed value) {
        return new CreateFunctionToolDtoMessagesItem(new RequestResponseDelayedValue(value));
    }
    ...
    private static final class RequestStartValue implements Value {
        ...
        public String toString() {
            return "CreateFunctionToolDtoMessagesItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "CreateFunctionToolDtoMessagesItem{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

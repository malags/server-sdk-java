...
public final class CreateByoPhoneNumberDtoFallbackDestination {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private CreateByoPhoneNumberDtoFallbackDestination(Value value) {
        this.value = value;
    }
    ...
    public static CreateByoPhoneNumberDtoFallbackDestination number(TransferDestinationNumber value) {
        return new CreateByoPhoneNumberDtoFallbackDestination(new NumberValue(value));
    }

    public static CreateByoPhoneNumberDtoFallbackDestination sip(TransferDestinationSip value) {
        return new CreateByoPhoneNumberDtoFallbackDestination(new SipValue(value));
    }
    ...
    private static final class NumberValue implements Value {
        ...
        public String toString() {
            return "CreateByoPhoneNumberDtoFallbackDestination{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "CreateByoPhoneNumberDtoFallbackDestination{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

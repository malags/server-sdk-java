...
public final class BuyPhoneNumberDto {
    ...
    public int hashCode() {
        return Objects.hash(
                this.fallbackDestination, this.areaCode, this.name, this.assistantId, this.squadId, this.server);
    }
    ...
    public static final class Builder implements AreaCodeStage, _FinalStage {
        ...
        public BuyPhoneNumberDto build() {
            return new BuyPhoneNumberDto(
                    fallbackDestination, areaCode, name, assistantId, squadId, server, additionalProperties);
        }
    }
}

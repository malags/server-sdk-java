...
@JsonDeserialize(builder = DeepInfraModel.Builder.class)
public final class DeepInfraModel {
    ...
    private DeepInfraModel(
            ...
            Optional<List<DeepInfraModelToolsItem>> tools,
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof DeepInfraModel && equalTo((DeepInfraModel) other);
    }
    ...
    private boolean equalTo(DeepInfraModel other) {
    ...
    public interface ModelStage {
        ...
        Builder from(DeepInfraModel other);
    }
    ...
    public interface _FinalStage {
         ...
         * <p>Both <code>tools</code> and <code>toolIds</code> can be used together.</p>
         */
        _FinalStage tools(Optional<List<DeepInfraModelToolsItem>> tools);

        _FinalStage tools(List<DeepInfraModelToolsItem> tools);
    ...
    public static final class Builder implements ModelStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(DeepInfraModel other) {
         ...
         */
        @java.lang.Override
        public _FinalStage tools(List<DeepInfraModelToolsItem> tools) {
        ...
        public _FinalStage tools(Optional<List<DeepInfraModelToolsItem>> tools) {
            this.tools = tools;
            return this;
        }

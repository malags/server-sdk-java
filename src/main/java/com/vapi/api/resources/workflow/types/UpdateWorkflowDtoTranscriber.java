...
import com.vapi.api.types.GoogleTranscriber;
import com.vapi.api.types.OpenAiTranscriber;
import com.vapi.api.types.SpeechmaticsTranscriber;
import com.vapi.api.types.TalkscriberTranscriber;
import java.util.Objects;
import java.util.Optional;

public final class UpdateWorkflowDtoTranscriber {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private UpdateWorkflowDtoTranscriber(Value value) {
        this.value = value;
    }
    ...
    public static UpdateWorkflowDtoTranscriber assemblyAi(AssemblyAiTranscriber value) {
        return new UpdateWorkflowDtoTranscriber(new AssemblyAiValue(value));
    }

    public static UpdateWorkflowDtoTranscriber azure(AzureSpeechTranscriber value) {
        return new UpdateWorkflowDtoTranscriber(new AzureValue(value));
    }

    public static UpdateWorkflowDtoTranscriber customTranscriber(CustomTranscriber value) {
        return new UpdateWorkflowDtoTranscriber(new CustomTranscriberValue(value));
    }

    public static UpdateWorkflowDtoTranscriber deepgram(DeepgramTranscriber value) {
        return new UpdateWorkflowDtoTranscriber(new DeepgramValue(value));
    }

    public static UpdateWorkflowDtoTranscriber _11Labs(ElevenLabsTranscriber value) {
        return new UpdateWorkflowDtoTranscriber(new _11LabsValue(value));
    }

    public static UpdateWorkflowDtoTranscriber gladia(GladiaTranscriber value) {
        return new UpdateWorkflowDtoTranscriber(new GladiaValue(value));
    }

    public static UpdateWorkflowDtoTranscriber google(GoogleTranscriber value) {
        return new UpdateWorkflowDtoTranscriber(new GoogleValue(value));
    }

    public static UpdateWorkflowDtoTranscriber speechmatics(SpeechmaticsTranscriber value) {
        return new UpdateWorkflowDtoTranscriber(new SpeechmaticsValue(value));
    }

    public static UpdateWorkflowDtoTranscriber talkscriber(TalkscriberTranscriber value) {
        return new UpdateWorkflowDtoTranscriber(new TalkscriberValue(value));
    }

    public static UpdateWorkflowDtoTranscriber openai(OpenAiTranscriber value) {
        return new UpdateWorkflowDtoTranscriber(new OpenaiValue(value));
    }

    public static UpdateWorkflowDtoTranscriber cartesia(CartesiaTranscriber value) {
        return new UpdateWorkflowDtoTranscriber(new CartesiaValue(value));
    }
    ...
    private static final class AssemblyAiValue implements Value {
        ...
        public String toString() {
            return "UpdateWorkflowDtoTranscriber{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "UpdateWorkflowDtoTranscriber{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

 ...
 */
package com.vapi.api.resources.blocks.requests;
...
import com.vapi.api.resources.blocks.types.UpdateBlockDtoMessagesItem;
import com.vapi.api.resources.blocks.types.UpdateBlockDtoStepsItem;
import com.vapi.api.resources.blocks.types.UpdateBlockDtoTool;
import com.vapi.api.types.JsonSchema;
...
@JsonDeserialize(builder = UpdateBlockDto.Builder.class)
public final class UpdateBlockDto {
    private final Optional<List<UpdateBlockDtoMessagesItem>> messages;

    private final Optional<JsonSchema> inputSchema;

    private final Optional<JsonSchema> outputSchema;

    private final Optional<UpdateBlockDtoTool> tool;

    private final Optional<List<UpdateBlockDtoStepsItem>> steps;
    ...
    private UpdateBlockDto(
            Optional<List<UpdateBlockDtoMessagesItem>> messages,
            Optional<JsonSchema> inputSchema,
            Optional<JsonSchema> outputSchema,
            Optional<UpdateBlockDtoTool> tool,
            Optional<List<UpdateBlockDtoStepsItem>> steps,
    ...
    public Optional<List<UpdateBlockDtoMessagesItem>> getMessages() {
        return messages;
    }
     ...
     */
    @JsonProperty("tool")
    public Optional<UpdateBlockDtoTool> getTool() {
        return tool;
    }
     ...
     */
    @JsonProperty("steps")
    public Optional<List<UpdateBlockDtoStepsItem>> getSteps() {
        return steps;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateBlockDto && equalTo((UpdateBlockDto) other);
    }
    ...
    private boolean equalTo(UpdateBlockDto other) {
    ...
    public static final class Builder {
        private Optional<List<UpdateBlockDtoMessagesItem>> messages = Optional.empty();

        private Optional<JsonSchema> inputSchema = Optional.empty();

        private Optional<JsonSchema> outputSchema = Optional.empty();

        private Optional<UpdateBlockDtoTool> tool = Optional.empty();

        private Optional<List<UpdateBlockDtoStepsItem>> steps = Optional.empty();
        ...
        public Builder from(UpdateBlockDto other) {
        ...
        public Builder messages(Optional<List<UpdateBlockDtoMessagesItem>> messages) {
            this.messages = messages;
            return this;
        }

        public Builder messages(List<UpdateBlockDtoMessagesItem> messages) {
        ...
        public Builder tool(Optional<UpdateBlockDtoTool> tool) {
            this.tool = tool;
            return this;
        }

        public Builder tool(UpdateBlockDtoTool tool) {
            this.tool = Optional.ofNullable(tool);
            return this;
        }

        @JsonSetter(value = "steps", nulls = Nulls.SKIP)
        public Builder steps(Optional<List<UpdateBlockDtoStepsItem>> steps) {
            this.steps = steps;
            return this;
        }

        public Builder steps(List<UpdateBlockDtoStepsItem> steps) {
        ...
        public UpdateBlockDto build() {
            return new UpdateBlockDto(
                    messages, inputSchema, outputSchema, tool, steps, name, instruction, toolId, additionalProperties);
        }
    }
}

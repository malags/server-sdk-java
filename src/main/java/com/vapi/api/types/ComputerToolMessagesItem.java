...
public final class ComputerToolMessagesItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private ComputerToolMessagesItem(Value value) {
        this.value = value;
    }
    ...
    public static ComputerToolMessagesItem requestStart(ToolMessageStart value) {
        return new ComputerToolMessagesItem(new RequestStartValue(value));
    }

    public static ComputerToolMessagesItem requestComplete(ToolMessageComplete value) {
        return new ComputerToolMessagesItem(new RequestCompleteValue(value));
    }

    public static ComputerToolMessagesItem requestFailed(ToolMessageFailed value) {
        return new ComputerToolMessagesItem(new RequestFailedValue(value));
    }

    public static ComputerToolMessagesItem requestResponseDelayed(ToolMessageDelayed value) {
        return new ComputerToolMessagesItem(new RequestResponseDelayedValue(value));
    }
    ...
    private static final class RequestStartValue implements Value {
        ...
        public String toString() {
            return "ComputerToolMessagesItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "ComputerToolMessagesItem{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

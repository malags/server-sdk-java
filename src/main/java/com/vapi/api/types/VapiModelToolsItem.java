...
public final class VapiModelToolsItem {
    ...
    public static VapiModelToolsItem apiRequest(CreateApiRequestToolDto value) {
        return new VapiModelToolsItem(new ApiRequestValue(value));
    }

    public static VapiModelToolsItem bash(CreateBashToolDto value) {
        return new VapiModelToolsItem(new BashValue(value));
    }

    public static VapiModelToolsItem computer(CreateComputerToolDto value) {
        return new VapiModelToolsItem(new ComputerValue(value));
    }
    ...
    public static VapiModelToolsItem gohighlevelCalendarAvailabilityCheck(
            CreateGoHighLevelCalendarAvailabilityToolDto value) {
        return new VapiModelToolsItem(new GohighlevelCalendarAvailabilityCheckValue(value));
    }

    public static VapiModelToolsItem gohighlevelCalendarEventCreate(CreateGoHighLevelCalendarEventCreateToolDto value) {
        return new VapiModelToolsItem(new GohighlevelCalendarEventCreateValue(value));
    }

    public static VapiModelToolsItem gohighlevelContactCreate(CreateGoHighLevelContactCreateToolDto value) {
        return new VapiModelToolsItem(new GohighlevelContactCreateValue(value));
    }

    public static VapiModelToolsItem gohighlevelContactGet(CreateGoHighLevelContactGetToolDto value) {
        return new VapiModelToolsItem(new GohighlevelContactGetValue(value));
    }

    public static VapiModelToolsItem googleCalendarAvailabilityCheck(
            CreateGoogleCalendarCheckAvailabilityToolDto value) {
        return new VapiModelToolsItem(new GoogleCalendarAvailabilityCheckValue(value));
    }

    public static VapiModelToolsItem googleCalendarEventCreate(CreateGoogleCalendarCreateEventToolDto value) {
        return new VapiModelToolsItem(new GoogleCalendarEventCreateValue(value));
    }

    public static VapiModelToolsItem googleSheetsRowAppend(CreateGoogleSheetsRowAppendToolDto value) {
        return new VapiModelToolsItem(new GoogleSheetsRowAppendValue(value));
    }

    public static VapiModelToolsItem mcp(CreateMcpToolDto value) {
        return new VapiModelToolsItem(new McpValue(value));
    }

    public static VapiModelToolsItem query(CreateQueryToolDto value) {
        return new VapiModelToolsItem(new QueryValue(value));
    }

    public static VapiModelToolsItem slackMessageSend(CreateSlackSendMessageToolDto value) {
        return new VapiModelToolsItem(new SlackMessageSendValue(value));
    }

    public static VapiModelToolsItem sms(CreateSmsToolDto value) {
        return new VapiModelToolsItem(new SmsValue(value));
    }

    public static VapiModelToolsItem textEditor(CreateTextEditorToolDto value) {
        return new VapiModelToolsItem(new TextEditorValue(value));
    }

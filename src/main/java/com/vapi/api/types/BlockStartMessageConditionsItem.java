...
public final class BlockStartMessageConditionsItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private BlockStartMessageConditionsItem(Value value) {
        this.value = value;
    }
    ...
    public static BlockStartMessageConditionsItem modelBased(ModelBasedCondition value) {
        return new BlockStartMessageConditionsItem(new ModelBasedValue(value));
    }

    public static BlockStartMessageConditionsItem ruleBased(RuleBasedCondition value) {
        return new BlockStartMessageConditionsItem(new RuleBasedValue(value));
    }
    ...
    private static final class ModelBasedValue implements Value {
        ...
        public String toString() {
            return "BlockStartMessageConditionsItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "BlockStartMessageConditionsItem{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

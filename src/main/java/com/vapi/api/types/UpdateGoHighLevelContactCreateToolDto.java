...
@JsonDeserialize(builder = UpdateGoHighLevelContactCreateToolDto.Builder.class)
public final class UpdateGoHighLevelContactCreateToolDto {
    private final Optional<List<UpdateGoHighLevelContactCreateToolDtoMessagesItem>> messages;

    private final Optional<OpenAiFunction> function;

    private final Map<String, Object> additionalProperties;

    private UpdateGoHighLevelContactCreateToolDto(
            Optional<List<UpdateGoHighLevelContactCreateToolDtoMessagesItem>> messages,
    ...
    public Optional<List<UpdateGoHighLevelContactCreateToolDtoMessagesItem>> getMessages() {
        return messages;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateGoHighLevelContactCreateToolDto
                && equalTo((UpdateGoHighLevelContactCreateToolDto) other);
    }
    ...
    private boolean equalTo(UpdateGoHighLevelContactCreateToolDto other) {
    ...
    public static final class Builder {
        private Optional<List<UpdateGoHighLevelContactCreateToolDtoMessagesItem>> messages = Optional.empty();
        ...
        public Builder from(UpdateGoHighLevelContactCreateToolDto other) {
        ...
        public Builder messages(Optional<List<UpdateGoHighLevelContactCreateToolDtoMessagesItem>> messages) {
            this.messages = messages;
            return this;
        }

        public Builder messages(List<UpdateGoHighLevelContactCreateToolDtoMessagesItem> messages) {
        ...
        public UpdateGoHighLevelContactCreateToolDto build() {
            return new UpdateGoHighLevelContactCreateToolDto(messages, function, additionalProperties);
        }
    }
}

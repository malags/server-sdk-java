...
public final class AnyscaleModelToolsItem {
    ...
    public static AnyscaleModelToolsItem voicemail(CreateVoicemailToolDto value) {
        return new AnyscaleModelToolsItem(new VoicemailValue(value));
    }
    ...
    public static AnyscaleModelToolsItem ghl(CreateGhlToolDto value) {
        return new AnyscaleModelToolsItem(new GhlValue(value));
    }

    public static AnyscaleModelToolsItem make(CreateMakeToolDto value) {
        return new AnyscaleModelToolsItem(new MakeValue(value));
    }

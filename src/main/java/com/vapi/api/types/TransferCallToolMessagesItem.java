...
public final class TransferCallToolMessagesItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private TransferCallToolMessagesItem(Value value) {
        this.value = value;
    }
    ...
    public static TransferCallToolMessagesItem requestStart(ToolMessageStart value) {
        return new TransferCallToolMessagesItem(new RequestStartValue(value));
    }

    public static TransferCallToolMessagesItem requestComplete(ToolMessageComplete value) {
        return new TransferCallToolMessagesItem(new RequestCompleteValue(value));
    }

    public static TransferCallToolMessagesItem requestFailed(ToolMessageFailed value) {
        return new TransferCallToolMessagesItem(new RequestFailedValue(value));
    }

    public static TransferCallToolMessagesItem requestResponseDelayed(ToolMessageDelayed value) {
        return new TransferCallToolMessagesItem(new RequestResponseDelayedValue(value));
    }
    ...
    private static final class RequestStartValue implements Value {
        ...
        public String toString() {
            return "TransferCallToolMessagesItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "TransferCallToolMessagesItem{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

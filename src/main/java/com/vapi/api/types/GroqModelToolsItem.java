...
public final class GroqModelToolsItem {
    ...
    public static GroqModelToolsItem voicemail(CreateVoicemailToolDto value) {
        return new GroqModelToolsItem(new VoicemailValue(value));
    }
    ...
    public static GroqModelToolsItem ghl(CreateGhlToolDto value) {
        return new GroqModelToolsItem(new GhlValue(value));
    }

    public static GroqModelToolsItem make(CreateMakeToolDto value) {
        return new GroqModelToolsItem(new MakeValue(value));
    }

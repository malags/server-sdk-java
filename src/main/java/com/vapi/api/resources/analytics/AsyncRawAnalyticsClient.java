...
public class AsyncRawAnalyticsClient {
    ...
    public CompletableFuture<VapiHttpResponse<List<AnalyticsQueryResult>>> get(AnalyticsQueryDto request) {
        return get(request, null);
    }

    public CompletableFuture<VapiHttpResponse<List<AnalyticsQueryResult>>> get(
            AnalyticsQueryDto request, RequestOptions requestOptions) {
        ...
        CompletableFuture<VapiHttpResponse<List<AnalyticsQueryResult>>> future = new CompletableFuture<>();

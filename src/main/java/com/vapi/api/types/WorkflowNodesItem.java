...
public final class WorkflowNodesItem {
    ...
    public static WorkflowNodesItem conversation(ConversationNode value) {
        return new WorkflowNodesItem(new ConversationValue(value));
    }

    public static WorkflowNodesItem tool(ToolNode value) {
        return new WorkflowNodesItem(new ToolValue(value));
    }

...
public final class AzureVoice {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof AzureVoice && equalTo((AzureVoice) other);
    }
    ...
    @java.lang.Override
    public int hashCode() {
        return Objects.hash(this.cachingEnabled, this.voiceId, this.chunkPlan, this.speed, this.fallbackPlan);
    }
    ...
    public interface VoiceIdStage {
        _FinalStage voiceId(@NotNull AzureVoiceId voiceId);

        Builder from(AzureVoice other);
    }
    ...
    public static final class Builder implements VoiceIdStage, _FinalStage {
        ...
        @java.lang.Override
        @JsonSetter("voiceId")
        public _FinalStage voiceId(@NotNull AzureVoiceId voiceId) {
        ...
        public AzureVoice build() {
            return new AzureVoice(cachingEnabled, voiceId, chunkPlan, speed, fallbackPlan, additionalProperties);
        }
    }
}

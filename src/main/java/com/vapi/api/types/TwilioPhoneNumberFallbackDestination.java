...
public final class TwilioPhoneNumberFallbackDestination {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private TwilioPhoneNumberFallbackDestination(Value value) {
        this.value = value;
    }
    ...
    public static TwilioPhoneNumberFallbackDestination number(TransferDestinationNumber value) {
        return new TwilioPhoneNumberFallbackDestination(new NumberValue(value));
    }

    public static TwilioPhoneNumberFallbackDestination sip(TransferDestinationSip value) {
        return new TwilioPhoneNumberFallbackDestination(new SipValue(value));
    }
    ...
    private static final class NumberValue implements Value {
        ...
        public String toString() {
            return "TwilioPhoneNumberFallbackDestination{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "TwilioPhoneNumberFallbackDestination{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

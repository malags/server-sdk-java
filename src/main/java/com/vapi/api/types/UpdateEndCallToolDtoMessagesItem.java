...
public final class UpdateEndCallToolDtoMessagesItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private UpdateEndCallToolDtoMessagesItem(Value value) {
        this.value = value;
    }
    ...
    public static UpdateEndCallToolDtoMessagesItem requestStart(ToolMessageStart value) {
        return new UpdateEndCallToolDtoMessagesItem(new RequestStartValue(value));
    }

    public static UpdateEndCallToolDtoMessagesItem requestComplete(ToolMessageComplete value) {
        return new UpdateEndCallToolDtoMessagesItem(new RequestCompleteValue(value));
    }

    public static UpdateEndCallToolDtoMessagesItem requestFailed(ToolMessageFailed value) {
        return new UpdateEndCallToolDtoMessagesItem(new RequestFailedValue(value));
    }

    public static UpdateEndCallToolDtoMessagesItem requestResponseDelayed(ToolMessageDelayed value) {
        return new UpdateEndCallToolDtoMessagesItem(new RequestResponseDelayedValue(value));
    }
    ...
    private static final class RequestStartValue implements Value {
        ...
        public String toString() {
            return "UpdateEndCallToolDtoMessagesItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "UpdateEndCallToolDtoMessagesItem{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

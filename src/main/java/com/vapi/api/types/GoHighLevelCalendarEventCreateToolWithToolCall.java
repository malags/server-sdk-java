...
@JsonDeserialize(builder = GoHighLevelCalendarEventCreateToolWithToolCall.Builder.class)
public final class GoHighLevelCalendarEventCreateToolWithToolCall {
    private final Optional<List<GoHighLevelCalendarEventCreateToolWithToolCallMessagesItem>> messages;
    ...
    private GoHighLevelCalendarEventCreateToolWithToolCall(
            Optional<List<GoHighLevelCalendarEventCreateToolWithToolCallMessagesItem>> messages,
            ToolCall toolCall,
    ...
    public Optional<List<GoHighLevelCalendarEventCreateToolWithToolCallMessagesItem>> getMessages() {
        return messages;
    }

    /**
     * @return The type of tool. &quot;gohighlevel.calendar.event.create&quot; for GoHighLevel Calendar event create tool.
     */
    @JsonProperty("type")
    public String getType() {
        return "gohighlevel.calendar.event.create";
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GoHighLevelCalendarEventCreateToolWithToolCall
                && equalTo((GoHighLevelCalendarEventCreateToolWithToolCall) other);
    }
    ...
    private boolean equalTo(GoHighLevelCalendarEventCreateToolWithToolCall other) {
    ...
    public interface ToolCallStage {
        ...
        Builder from(GoHighLevelCalendarEventCreateToolWithToolCall other);
    }

    public interface _FinalStage {
        GoHighLevelCalendarEventCreateToolWithToolCall build();

        /**
         * <p>These are the messages that will be spoken to the user as the tool is running.</p>
         * <p>For some tools, this is auto-filled based on special fields like <code>tool.destinations</code>. For others like the function tool, these can be custom configured.</p>
         */
        _FinalStage messages(Optional<List<GoHighLevelCalendarEventCreateToolWithToolCallMessagesItem>> messages);

        _FinalStage messages(List<GoHighLevelCalendarEventCreateToolWithToolCallMessagesItem> messages);
    ...
    public static final class Builder implements ToolCallStage, _FinalStage {
        ...
        private Optional<List<GoHighLevelCalendarEventCreateToolWithToolCallMessagesItem>> messages = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(GoHighLevelCalendarEventCreateToolWithToolCall other) {
         ...
         */
        @java.lang.Override
        public _FinalStage messages(List<GoHighLevelCalendarEventCreateToolWithToolCallMessagesItem> messages) {
        ...
        @java.lang.Override
        public GoHighLevelCalendarEventCreateToolWithToolCall build() {
            return new GoHighLevelCalendarEventCreateToolWithToolCall(
                    messages, toolCall, function, additionalProperties);
        }
    }
}

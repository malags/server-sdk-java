...
@JsonDeserialize(builder = UpdateWorkflowBlockDto.Builder.class)
public final class UpdateWorkflowBlockDto {
    private final Optional<List<UpdateWorkflowBlockDtoMessagesItem>> messages;

    private final Optional<JsonSchema> inputSchema;

    private final Optional<JsonSchema> outputSchema;

    private final Optional<List<UpdateWorkflowBlockDtoStepsItem>> steps;

    private final Optional<String> name;

    private final Map<String, Object> additionalProperties;

    private UpdateWorkflowBlockDto(
            Optional<List<UpdateWorkflowBlockDtoMessagesItem>> messages,
            Optional<JsonSchema> inputSchema,
            Optional<JsonSchema> outputSchema,
            Optional<List<UpdateWorkflowBlockDtoStepsItem>> steps,
    ...
    public Optional<List<UpdateWorkflowBlockDtoMessagesItem>> getMessages() {
        return messages;
    }
     ...
     */
    @JsonProperty("steps")
    public Optional<List<UpdateWorkflowBlockDtoStepsItem>> getSteps() {
        return steps;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof UpdateWorkflowBlockDto && equalTo((UpdateWorkflowBlockDto) other);
    }
    ...
    private boolean equalTo(UpdateWorkflowBlockDto other) {
    ...
    public static final class Builder {
        private Optional<List<UpdateWorkflowBlockDtoMessagesItem>> messages = Optional.empty();

        private Optional<JsonSchema> inputSchema = Optional.empty();

        private Optional<JsonSchema> outputSchema = Optional.empty();

        private Optional<List<UpdateWorkflowBlockDtoStepsItem>> steps = Optional.empty();
        ...
        public Builder from(UpdateWorkflowBlockDto other) {
        ...
        public Builder messages(Optional<List<UpdateWorkflowBlockDtoMessagesItem>> messages) {
            this.messages = messages;
            return this;
        }

        public Builder messages(List<UpdateWorkflowBlockDtoMessagesItem> messages) {
        ...
        public Builder steps(Optional<List<UpdateWorkflowBlockDtoStepsItem>> steps) {
            this.steps = steps;
            return this;
        }

        public Builder steps(List<UpdateWorkflowBlockDtoStepsItem> steps) {
        ...
        public UpdateWorkflowBlockDto build() {
            return new UpdateWorkflowBlockDto(messages, inputSchema, outputSchema, steps, name, additionalProperties);
        }
    }
}

...
public final class QueryToolMessagesItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private QueryToolMessagesItem(Value value) {
        this.value = value;
    }
    ...
    public static QueryToolMessagesItem requestStart(ToolMessageStart value) {
        return new QueryToolMessagesItem(new RequestStartValue(value));
    }

    public static QueryToolMessagesItem requestComplete(ToolMessageComplete value) {
        return new QueryToolMessagesItem(new RequestCompleteValue(value));
    }

    public static QueryToolMessagesItem requestFailed(ToolMessageFailed value) {
        return new QueryToolMessagesItem(new RequestFailedValue(value));
    }

    public static QueryToolMessagesItem requestResponseDelayed(ToolMessageDelayed value) {
        return new QueryToolMessagesItem(new RequestResponseDelayedValue(value));
    }
    ...
    private static final class RequestStartValue implements Value {
        ...
        public String toString() {
            return "QueryToolMessagesItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "QueryToolMessagesItem{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

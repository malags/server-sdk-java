...
public class RawCampaignsClient {
    ...
    public VapiHttpResponse<CampaignPaginatedResponse> campaignControllerFindAll() {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new VapiHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), CampaignPaginatedResponse.class),
                        response);
            }
    ...
    public VapiHttpResponse<Campaign> campaignControllerCreate(CreateCampaignDto request) {
        return campaignControllerCreate(request, null);
    }

    public VapiHttpResponse<Campaign> campaignControllerCreate(
    ...
    public VapiHttpResponse<Campaign> campaignControllerFindOne(String id) {
        return campaignControllerFindOne(id, null);
    }

    public VapiHttpResponse<Campaign> campaignControllerFindOne(String id, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("campaign")
                .addPathSegment(id)
    ...
    public VapiHttpResponse<Campaign> campaignControllerRemove(String id) {
        return campaignControllerRemove(id, null);
    }

    public VapiHttpResponse<Campaign> campaignControllerRemove(String id, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("campaign")
                .addPathSegment(id)
    ...
    public VapiHttpResponse<Campaign> campaignControllerUpdate(String id) {
        return campaignControllerUpdate(id, UpdateCampaignDto.builder().build());
    }

    public VapiHttpResponse<Campaign> campaignControllerUpdate(String id, UpdateCampaignDto request) {
        return campaignControllerUpdate(id, request, null);
    }

    public VapiHttpResponse<Campaign> campaignControllerUpdate(

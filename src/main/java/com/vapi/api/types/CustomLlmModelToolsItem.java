...
public final class CustomLlmModelToolsItem {
    ...
    public static CustomLlmModelToolsItem voicemail(CreateVoicemailToolDto value) {
        return new CustomLlmModelToolsItem(new VoicemailValue(value));
    }
    ...
    public static CustomLlmModelToolsItem ghl(CreateGhlToolDto value) {
        return new CustomLlmModelToolsItem(new GhlValue(value));
    }

    public static CustomLlmModelToolsItem make(CreateMakeToolDto value) {
        return new CustomLlmModelToolsItem(new MakeValue(value));
    }

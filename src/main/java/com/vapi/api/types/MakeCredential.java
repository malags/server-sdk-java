...
public final class MakeCredential {
    ...
    @java.lang.Override
    public int hashCode() {
        return Objects.hash(this.teamId, this.region, this.apiKey, this.id, this.orgId, this.createdAt, this.updatedAt);
    }
    ...
    public static final class Builder
        ...
        public MakeCredential build() {
            return new MakeCredential(teamId, region, apiKey, id, orgId, createdAt, updatedAt, additionalProperties);
        }
    }
}

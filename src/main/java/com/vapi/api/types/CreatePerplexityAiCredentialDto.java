...
public final class CreatePerplexityAiCredentialDto {
    ...
    private CreatePerplexityAiCredentialDto(String apiKey, Map<String, Object> additionalProperties) {
        this.apiKey = apiKey;
    ...
    public static final class Builder implements ApiKeyStage, _FinalStage {
        ...
        public CreatePerplexityAiCredentialDto build() {
            return new CreatePerplexityAiCredentialDto(apiKey, additionalProperties);
        }
    }
}

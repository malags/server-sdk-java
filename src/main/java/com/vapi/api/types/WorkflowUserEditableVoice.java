...
public final class WorkflowUserEditableVoice {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private WorkflowUserEditableVoice(Value value) {
        this.value = value;
    }
    ...
    public static WorkflowUserEditableVoice azure(AzureVoice value) {
        return new WorkflowUserEditableVoice(new AzureValue(value));
    }

    public static WorkflowUserEditableVoice cartesia(CartesiaVoice value) {
        return new WorkflowUserEditableVoice(new CartesiaValue(value));
    }

    public static WorkflowUserEditableVoice customVoice(CustomVoice value) {
        return new WorkflowUserEditableVoice(new CustomVoiceValue(value));
    }

    public static WorkflowUserEditableVoice deepgram(DeepgramVoice value) {
        return new WorkflowUserEditableVoice(new DeepgramValue(value));
    }

    public static WorkflowUserEditableVoice _11Labs(ElevenLabsVoice value) {
        return new WorkflowUserEditableVoice(new _11LabsValue(value));
    }

    public static WorkflowUserEditableVoice hume(HumeVoice value) {
        return new WorkflowUserEditableVoice(new HumeValue(value));
    }

    public static WorkflowUserEditableVoice lmnt(LmntVoice value) {
        return new WorkflowUserEditableVoice(new LmntValue(value));
    }

    public static WorkflowUserEditableVoice neuphonic(NeuphonicVoice value) {
        return new WorkflowUserEditableVoice(new NeuphonicValue(value));
    }

    public static WorkflowUserEditableVoice openai(OpenAiVoice value) {
        return new WorkflowUserEditableVoice(new OpenaiValue(value));
    }

    public static WorkflowUserEditableVoice playht(PlayHtVoice value) {
        return new WorkflowUserEditableVoice(new PlayhtValue(value));
    }

    public static WorkflowUserEditableVoice rimeAi(RimeAiVoice value) {
        return new WorkflowUserEditableVoice(new RimeAiValue(value));
    }

    public static WorkflowUserEditableVoice smallestAi(SmallestAiVoice value) {
        return new WorkflowUserEditableVoice(new SmallestAiValue(value));
    }

    public static WorkflowUserEditableVoice tavus(TavusVoice value) {
        return new WorkflowUserEditableVoice(new TavusValue(value));
    }

    public static WorkflowUserEditableVoice vapi(VapiVoice value) {
        return new WorkflowUserEditableVoice(new VapiValue(value));
    }

    public static WorkflowUserEditableVoice sesame(SesameVoice value) {
        return new WorkflowUserEditableVoice(new SesameValue(value));
    }

    public static WorkflowUserEditableVoice inworld(InworldVoice value) {
        return new WorkflowUserEditableVoice(new InworldValue(value));
    }
    ...
    private static final class AzureValue implements Value {
        ...
        public String toString() {
            return "WorkflowUserEditableVoice{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "WorkflowUserEditableVoice{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

...
import com.vapi.api.types.CreateVoicemailToolDto;
import java.util.Objects;
import java.util.Optional;

public final class UpdateBlockDtoTool {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private UpdateBlockDtoTool(Value value) {
        this.value = value;
    }
    ...
    public static UpdateBlockDtoTool dtmf(CreateDtmfToolDto value) {
        return new UpdateBlockDtoTool(new DtmfValue(value));
    }

    public static UpdateBlockDtoTool endCall(CreateEndCallToolDto value) {
        return new UpdateBlockDtoTool(new EndCallValue(value));
    }

    public static UpdateBlockDtoTool voicemail(CreateVoicemailToolDto value) {
        return new UpdateBlockDtoTool(new VoicemailValue(value));
    }

    public static UpdateBlockDtoTool function(CreateFunctionToolDto value) {
        return new UpdateBlockDtoTool(new FunctionValue(value));
    }

    public static UpdateBlockDtoTool ghl(CreateGhlToolDto value) {
        return new UpdateBlockDtoTool(new GhlValue(value));
    }

    public static UpdateBlockDtoTool make(CreateMakeToolDto value) {
        return new UpdateBlockDtoTool(new MakeValue(value));
    }

    public static UpdateBlockDtoTool transferCall(CreateTransferCallToolDto value) {
        return new UpdateBlockDtoTool(new TransferCallValue(value));
    }
    ...
    private static final class DtmfValue implements Value {
        ...
        public String toString() {
            return "UpdateBlockDtoTool{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "UpdateBlockDtoTool{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

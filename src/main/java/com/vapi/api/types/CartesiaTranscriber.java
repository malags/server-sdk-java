...
@JsonDeserialize(builder = CartesiaTranscriber.Builder.class)
public final class CartesiaTranscriber {
    private final Optional<String> model;

    private final Optional<CartesiaTranscriberLanguage> language;

    private final Optional<FallbackTranscriberPlan> fallbackPlan;

    private final Map<String, Object> additionalProperties;

    private CartesiaTranscriber(
            Optional<String> model,
            Optional<CartesiaTranscriberLanguage> language,
    ...
    public Optional<CartesiaTranscriberLanguage> getLanguage() {
        return language;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CartesiaTranscriber && equalTo((CartesiaTranscriber) other);
    }
    ...
    private boolean equalTo(CartesiaTranscriber other) {
    ...
    public static final class Builder {
        ...
        private Optional<CartesiaTranscriberLanguage> language = Optional.empty();
        ...
        public Builder from(CartesiaTranscriber other) {
        ...
        public Builder language(Optional<CartesiaTranscriberLanguage> language) {
            this.language = language;
            return this;
        }

        public Builder language(CartesiaTranscriberLanguage language) {
        ...
        public CartesiaTranscriber build() {
            return new CartesiaTranscriber(model, language, fallbackPlan, additionalProperties);
        }
    }
}

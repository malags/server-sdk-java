...
public class AsyncRawCampaignsClient {
    ...
    public CompletableFuture<VapiHttpResponse<CampaignPaginatedResponse>> campaignControllerFindAll() {
        return campaignControllerFindAll(
                CampaignControllerFindAllRequest.builder().build());
    }

    public CompletableFuture<VapiHttpResponse<CampaignPaginatedResponse>> campaignControllerFindAll(
            CampaignControllerFindAllRequest request) {
        return campaignControllerFindAll(request, null);
    }
    ...
    public CompletableFuture<VapiHttpResponse<CampaignPaginatedResponse>> campaignControllerFindAll(
        ...
        CompletableFuture<VapiHttpResponse<CampaignPaginatedResponse>> future = new CompletableFuture<>();
                    ...
                    if (response.isSuccessful()) {
                        future.complete(new VapiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(
                                        responseBody.string(), CampaignPaginatedResponse.class),
                                response));
                        return;
                    }
    ...
    public CompletableFuture<VapiHttpResponse<Campaign>> campaignControllerCreate(CreateCampaignDto request) {
        return campaignControllerCreate(request, null);
    }

    public CompletableFuture<VapiHttpResponse<Campaign>> campaignControllerCreate(
        ...
        CompletableFuture<VapiHttpResponse<Campaign>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(new VapiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), Campaign.class), response));
                        return;
                    }
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                    future.completeExceptionally(new VapiApiException(
    ...
    public CompletableFuture<VapiHttpResponse<Campaign>> campaignControllerFindOne(String id) {
        return campaignControllerFindOne(id, null);
    }

    public CompletableFuture<VapiHttpResponse<Campaign>> campaignControllerFindOne(
    ...
    public CompletableFuture<VapiHttpResponse<Campaign>> campaignControllerRemove(String id) {
        return campaignControllerRemove(id, null);
    }

    public CompletableFuture<VapiHttpResponse<Campaign>> campaignControllerRemove(
            String id, RequestOptions requestOptions) {
        HttpUrl httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("campaign")
    ...
    public CompletableFuture<VapiHttpResponse<Campaign>> campaignControllerUpdate(String id) {
        return campaignControllerUpdate(id, UpdateCampaignDto.builder().build());
    }

    public CompletableFuture<VapiHttpResponse<Campaign>> campaignControllerUpdate(
            String id, UpdateCampaignDto request) {
        return campaignControllerUpdate(id, request, null);
    }

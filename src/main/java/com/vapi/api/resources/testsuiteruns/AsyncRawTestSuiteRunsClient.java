...
public class AsyncRawTestSuiteRunsClient {
    protected final ClientOptions clientOptions;

    public AsyncRawTestSuiteRunsClient(ClientOptions clientOptions) {
        this.clientOptions = clientOptions;
    }

    public CompletableFuture<VapiHttpResponse<TestSuiteRunsPaginatedResponse>> testSuiteRunControllerFindAllPaginated(
            String testSuiteId) {
    ...
    public CompletableFuture<VapiHttpResponse<TestSuiteRunsPaginatedResponse>> testSuiteRunControllerFindAllPaginated(
        ...
        CompletableFuture<VapiHttpResponse<TestSuiteRunsPaginatedResponse>> future = new CompletableFuture<>();
    ...
    public CompletableFuture<VapiHttpResponse<TestSuiteRun>> testSuiteRunControllerCreate(String testSuiteId) {
        return testSuiteRunControllerCreate(
                testSuiteId, CreateTestSuiteRunDto.builder().build());
    }

    public CompletableFuture<VapiHttpResponse<TestSuiteRun>> testSuiteRunControllerCreate(
    ...
    public CompletableFuture<VapiHttpResponse<TestSuiteRun>> testSuiteRunControllerCreate(
        ...
        CompletableFuture<VapiHttpResponse<TestSuiteRun>> future = new CompletableFuture<>();
        client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try (ResponseBody responseBody = response.body()) {
                    if (response.isSuccessful()) {
                        future.complete(new VapiHttpResponse<>(
                                ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), TestSuiteRun.class),
                                response));
                        return;
                    }
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
    ...
    public CompletableFuture<VapiHttpResponse<TestSuiteRun>> testSuiteRunControllerFindOne(
    ...
    public CompletableFuture<VapiHttpResponse<TestSuiteRun>> testSuiteRunControllerRemove(
            String testSuiteId, String id) {
    ...
    public CompletableFuture<VapiHttpResponse<TestSuiteRun>> testSuiteRunControllerUpdate(
            String testSuiteId, String id) {

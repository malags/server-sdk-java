...
public final class TelnyxPhoneNumberFallbackDestination {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private TelnyxPhoneNumberFallbackDestination(Value value) {
        this.value = value;
    }
    ...
    public static TelnyxPhoneNumberFallbackDestination number(TransferDestinationNumber value) {
        return new TelnyxPhoneNumberFallbackDestination(new NumberValue(value));
    }

    public static TelnyxPhoneNumberFallbackDestination sip(TransferDestinationSip value) {
        return new TelnyxPhoneNumberFallbackDestination(new SipValue(value));
    }
    ...
    private static final class NumberValue implements Value {
        ...
        public String toString() {
            return "TelnyxPhoneNumberFallbackDestination{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "TelnyxPhoneNumberFallbackDestination{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

...
public final class TestSuiteTestControllerCreateResponse {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private TestSuiteTestControllerCreateResponse(Value value) {
        this.value = value;
    }
    ...
    public static TestSuiteTestControllerCreateResponse voice(TestSuiteTestVoice value) {
        return new TestSuiteTestControllerCreateResponse(new VoiceValue(value));
    }

    public static TestSuiteTestControllerCreateResponse chat(TestSuiteTestChat value) {
        return new TestSuiteTestControllerCreateResponse(new ChatValue(value));
    }
    ...
    private static final class VoiceValue implements Value {
        ...
        public String toString() {
            return "TestSuiteTestControllerCreateResponse{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "TestSuiteTestControllerCreateResponse{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

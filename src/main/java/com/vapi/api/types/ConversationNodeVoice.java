...
public final class ConversationNodeVoice {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private ConversationNodeVoice(Value value) {
        this.value = value;
    }
    ...
    public static ConversationNodeVoice azure(AzureVoice value) {
        return new ConversationNodeVoice(new AzureValue(value));
    }

    public static ConversationNodeVoice cartesia(CartesiaVoice value) {
        return new ConversationNodeVoice(new CartesiaValue(value));
    }

    public static ConversationNodeVoice customVoice(CustomVoice value) {
        return new ConversationNodeVoice(new CustomVoiceValue(value));
    }

    public static ConversationNodeVoice deepgram(DeepgramVoice value) {
        return new ConversationNodeVoice(new DeepgramValue(value));
    }

    public static ConversationNodeVoice _11Labs(ElevenLabsVoice value) {
        return new ConversationNodeVoice(new _11LabsValue(value));
    }

    public static ConversationNodeVoice hume(HumeVoice value) {
        return new ConversationNodeVoice(new HumeValue(value));
    }

    public static ConversationNodeVoice lmnt(LmntVoice value) {
        return new ConversationNodeVoice(new LmntValue(value));
    }

    public static ConversationNodeVoice neuphonic(NeuphonicVoice value) {
        return new ConversationNodeVoice(new NeuphonicValue(value));
    }

    public static ConversationNodeVoice openai(OpenAiVoice value) {
        return new ConversationNodeVoice(new OpenaiValue(value));
    }

    public static ConversationNodeVoice playht(PlayHtVoice value) {
        return new ConversationNodeVoice(new PlayhtValue(value));
    }

    public static ConversationNodeVoice rimeAi(RimeAiVoice value) {
        return new ConversationNodeVoice(new RimeAiValue(value));
    }

    public static ConversationNodeVoice smallestAi(SmallestAiVoice value) {
        return new ConversationNodeVoice(new SmallestAiValue(value));
    }

    public static ConversationNodeVoice tavus(TavusVoice value) {
        return new ConversationNodeVoice(new TavusValue(value));
    }

    public static ConversationNodeVoice vapi(VapiVoice value) {
        return new ConversationNodeVoice(new VapiValue(value));
    }

    public static ConversationNodeVoice sesame(SesameVoice value) {
        return new ConversationNodeVoice(new SesameValue(value));
    }

    public static ConversationNodeVoice inworld(InworldVoice value) {
        return new ConversationNodeVoice(new InworldValue(value));
    }
    ...
    private static final class AzureValue implements Value {
        ...
        public String toString() {
            return "ConversationNodeVoice{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "ConversationNodeVoice{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

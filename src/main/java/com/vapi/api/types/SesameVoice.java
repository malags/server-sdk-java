...
@JsonDeserialize(builder = SesameVoice.Builder.class)
public final class SesameVoice {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof SesameVoice && equalTo((SesameVoice) other);
    }
    ...
    private boolean equalTo(SesameVoice other) {
    ...
    @java.lang.Override
    public int hashCode() {
        return Objects.hash(this.cachingEnabled, this.voiceId, this.chunkPlan, this.fallbackPlan);
    }
    ...
    public interface VoiceIdStage {
        ...
        Builder from(SesameVoice other);
    }
    ...
    public static final class Builder implements VoiceIdStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(SesameVoice other) {
        ...
        @java.lang.Override
        public SesameVoice build() {
            return new SesameVoice(cachingEnabled, voiceId, chunkPlan, fallbackPlan, additionalProperties);
        }
    }
}

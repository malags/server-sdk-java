...
public final class PhoneNumbersCreateResponse {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private PhoneNumbersCreateResponse(Value value) {
        this.value = value;
    }
    ...
    public static PhoneNumbersCreateResponse byoPhoneNumber(ByoPhoneNumber value) {
        return new PhoneNumbersCreateResponse(new ByoPhoneNumberValue(value));
    }

    public static PhoneNumbersCreateResponse twilio(TwilioPhoneNumber value) {
        return new PhoneNumbersCreateResponse(new TwilioValue(value));
    }

    public static PhoneNumbersCreateResponse vonage(VonagePhoneNumber value) {
        return new PhoneNumbersCreateResponse(new VonageValue(value));
    }

    public static PhoneNumbersCreateResponse vapi(VapiPhoneNumber value) {
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "PhoneNumbersCreateResponse{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

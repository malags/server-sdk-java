...
@JsonDeserialize(builder = CreateEndCallToolDto.Builder.class)
public final class CreateEndCallToolDto {
    private final Optional<List<CreateEndCallToolDtoMessagesItem>> messages;

    private final Optional<OpenAiFunction> function;

    private final Map<String, Object> additionalProperties;

    private CreateEndCallToolDto(
            Optional<List<CreateEndCallToolDtoMessagesItem>> messages,
    ...
    public Optional<List<CreateEndCallToolDtoMessagesItem>> getMessages() {
        return messages;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateEndCallToolDto && equalTo((CreateEndCallToolDto) other);
    }
    ...
    private boolean equalTo(CreateEndCallToolDto other) {
    ...
    public static final class Builder {
        private Optional<List<CreateEndCallToolDtoMessagesItem>> messages = Optional.empty();
        ...
        public Builder from(CreateEndCallToolDto other) {
        ...
        public Builder messages(Optional<List<CreateEndCallToolDtoMessagesItem>> messages) {
            this.messages = messages;
            return this;
        }

        public Builder messages(List<CreateEndCallToolDtoMessagesItem> messages) {
        ...
        public CreateEndCallToolDto build() {
            return new CreateEndCallToolDto(messages, function, additionalProperties);
        }
    }
}

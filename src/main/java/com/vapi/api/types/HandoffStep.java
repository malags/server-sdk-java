...
@JsonDeserialize(builder = HandoffStep.Builder.class)
public final class HandoffStep {
    private final Optional<HandoffStepBlock> block;

    private final Optional<List<StepDestination>> destinations;
    ...
    private HandoffStep(
            Optional<HandoffStepBlock> block,
            Optional<List<StepDestination>> destinations,
            String name,
     ...
     */
    @JsonProperty("block")
    public Optional<HandoffStepBlock> getBlock() {
        return block;
    }

    /**
     * @return These are the destinations that the step can go to after it's done.
     */
    @JsonProperty("destinations")
    public Optional<List<StepDestination>> getDestinations() {
        return destinations;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof HandoffStep && equalTo((HandoffStep) other);
    }
    ...
    private boolean equalTo(HandoffStep other) {
    ...
    @java.lang.Override
    public int hashCode() {
        return Objects.hash(this.block, this.destinations, this.name, this.blockId, this.input);
    }
    ...
    public interface NameStage {
        ...
        Builder from(HandoffStep other);
    }

    public interface _FinalStage {
        HandoffStep build();

        _FinalStage block(Optional<HandoffStepBlock> block);

        _FinalStage block(HandoffStepBlock block);

        _FinalStage destinations(Optional<List<StepDestination>> destinations);

        _FinalStage destinations(List<StepDestination> destinations);
    ...
    public static final class Builder implements NameStage, _FinalStage {
        ...
        private Optional<List<StepDestination>> destinations = Optional.empty();

        private Optional<HandoffStepBlock> block = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(HandoffStep other) {
        ...
        /**
         * <p>These are the destinations that the step can go to after it's done.</p>
         * @return Reference to {@code this} so that method calls can be chained together.
         */
        @java.lang.Override
        public _FinalStage destinations(List<StepDestination> destinations) {
        ...
        public _FinalStage destinations(Optional<List<StepDestination>> destinations) {
            this.destinations = destinations;
            return this;
        }
         ...
         */
        @java.lang.Override
        public _FinalStage block(HandoffStepBlock block) {
        ...
        public _FinalStage block(Optional<HandoffStepBlock> block) {
            this.block = block;
            return this;
        }

        @java.lang.Override
        public HandoffStep build() {
            return new HandoffStep(block, destinations, name, blockId, input, additionalProperties);
        }
    }
}

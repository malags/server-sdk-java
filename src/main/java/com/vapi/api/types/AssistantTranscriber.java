...
public final class AssistantTranscriber {
    ...
    public static AssistantTranscriber _11Labs(ElevenLabsTranscriber value) {
        return new AssistantTranscriber(new _11LabsValue(value));
    }
    ...
    public static AssistantTranscriber google(GoogleTranscriber value) {
        return new AssistantTranscriber(new GoogleValue(value));
    }

    public static AssistantTranscriber speechmatics(SpeechmaticsTranscriber value) {
        return new AssistantTranscriber(new SpeechmaticsValue(value));
    }
    ...
    public static AssistantTranscriber openai(OpenAiTranscriber value) {
        return new AssistantTranscriber(new OpenaiValue(value));
    }

    public static AssistantTranscriber cartesia(CartesiaTranscriber value) {
        return new AssistantTranscriber(new CartesiaValue(value));
    }

...
@JsonDeserialize(builder = GoHighLevelCalendarEventCreateToolProviderDetails.Builder.class)
public final class GoHighLevelCalendarEventCreateToolProviderDetails {
    ...
    private GoHighLevelCalendarEventCreateToolProviderDetails(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof GoHighLevelCalendarEventCreateToolProviderDetails
                && equalTo((GoHighLevelCalendarEventCreateToolProviderDetails) other);
    }
    ...
    private boolean equalTo(GoHighLevelCalendarEventCreateToolProviderDetails other) {
    ...
    public static final class Builder {
        ...
        public Builder from(GoHighLevelCalendarEventCreateToolProviderDetails other) {
        ...
        public GoHighLevelCalendarEventCreateToolProviderDetails build() {
            return new GoHighLevelCalendarEventCreateToolProviderDetails(

...
public final class CreateWorkflowDtoCredentialsItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private CreateWorkflowDtoCredentialsItem(Value value) {
        this.value = value;
    }
    ...
    public static CreateWorkflowDtoCredentialsItem _11Labs(CreateElevenLabsCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new _11LabsValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem anthropic(CreateAnthropicCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new AnthropicValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem anyscale(CreateAnyscaleCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new AnyscaleValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem assemblyAi(CreateAssemblyAiCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new AssemblyAiValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem azureOpenai(CreateAzureOpenAiCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new AzureOpenaiValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem azure(CreateAzureCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new AzureValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem byoSipTrunk(CreateByoSipTrunkCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new ByoSipTrunkValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem cartesia(CreateCartesiaCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new CartesiaValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem cerebras(CreateCerebrasCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new CerebrasValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem cloudflare(CreateCloudflareCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new CloudflareValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem customLlm(CreateCustomLlmCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new CustomLlmValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem deepgram(CreateDeepgramCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new DeepgramValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem deepinfra(CreateDeepInfraCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new DeepinfraValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem deepSeek(CreateDeepSeekCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new DeepSeekValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem gcp(CreateGcpCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new GcpValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem gladia(CreateGladiaCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new GladiaValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem gohighlevel(CreateGoHighLevelCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new GohighlevelValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem google(CreateGoogleCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new GoogleValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem groq(CreateGroqCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new GroqValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem inflectionAi(CreateInflectionAiCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new InflectionAiValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem langfuse(CreateLangfuseCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new LangfuseValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem lmnt(CreateLmntCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new LmntValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem make(CreateMakeCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new MakeValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem openai(CreateOpenAiCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new OpenaiValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem openrouter(CreateOpenRouterCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new OpenrouterValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem perplexityAi(CreatePerplexityAiCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new PerplexityAiValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem playht(CreatePlayHtCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new PlayhtValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem rimeAi(CreateRimeAiCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new RimeAiValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem runpod(CreateRunpodCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new RunpodValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem s3(CreateS3CredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new S3Value(value));
    }

    public static CreateWorkflowDtoCredentialsItem supabase(CreateSupabaseCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new SupabaseValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem smallestAi(CreateSmallestAiCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new SmallestAiValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem tavus(CreateTavusCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new TavusValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem togetherAi(CreateTogetherAiCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new TogetherAiValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem twilio(CreateTwilioCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new TwilioValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem vonage(CreateVonageCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new VonageValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem webhook(CreateWebhookCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new WebhookValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem xai(CreateXAiCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new XaiValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem neuphonic(CreateNeuphonicCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new NeuphonicValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem hume(CreateHumeCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new HumeValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem mistral(CreateMistralCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new MistralValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem speechmatics(CreateSpeechmaticsCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new SpeechmaticsValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem trieve(CreateTrieveCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new TrieveValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem googleCalendarOauth2Client(
            CreateGoogleCalendarOAuth2ClientCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new GoogleCalendarOauth2ClientValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem googleCalendarOauth2Authorization(
            CreateGoogleCalendarOAuth2AuthorizationCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new GoogleCalendarOauth2AuthorizationValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem googleSheetsOauth2Authorization(
            CreateGoogleSheetsOAuth2AuthorizationCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new GoogleSheetsOauth2AuthorizationValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem slackOauth2Authorization(
            CreateSlackOAuth2AuthorizationCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new SlackOauth2AuthorizationValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem ghlOauth2Authorization(CreateGoHighLevelMcpCredentialDto value) {
        return new CreateWorkflowDtoCredentialsItem(new GhlOauth2AuthorizationValue(value));
    }

    public static CreateWorkflowDtoCredentialsItem inworld(Object value) {
        return new CreateWorkflowDtoCredentialsItem(new InworldValue(value));
    }
    ...
    private static final class _11LabsValue implements Value {
        ...
        public String toString() {
            return "CreateWorkflowDtoCredentialsItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "CreateWorkflowDtoCredentialsItem{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

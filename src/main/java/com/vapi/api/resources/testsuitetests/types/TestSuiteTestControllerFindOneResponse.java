...
public final class TestSuiteTestControllerFindOneResponse {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private TestSuiteTestControllerFindOneResponse(Value value) {
        this.value = value;
    }
    ...
    public static TestSuiteTestControllerFindOneResponse voice(TestSuiteTestVoice value) {
        return new TestSuiteTestControllerFindOneResponse(new VoiceValue(value));
    }

    public static TestSuiteTestControllerFindOneResponse chat(TestSuiteTestChat value) {
        return new TestSuiteTestControllerFindOneResponse(new ChatValue(value));
    }
    ...
    private static final class VoiceValue implements Value {
        ...
        public String toString() {
            return "TestSuiteTestControllerFindOneResponse{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "TestSuiteTestControllerFindOneResponse{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

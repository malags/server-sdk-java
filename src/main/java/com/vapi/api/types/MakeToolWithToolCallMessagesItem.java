...
public final class MakeToolWithToolCallMessagesItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private MakeToolWithToolCallMessagesItem(Value value) {
        this.value = value;
    }
    ...
    public static MakeToolWithToolCallMessagesItem requestStart(ToolMessageStart value) {
        return new MakeToolWithToolCallMessagesItem(new RequestStartValue(value));
    }

    public static MakeToolWithToolCallMessagesItem requestComplete(ToolMessageComplete value) {
        return new MakeToolWithToolCallMessagesItem(new RequestCompleteValue(value));
    }

    public static MakeToolWithToolCallMessagesItem requestFailed(ToolMessageFailed value) {
        return new MakeToolWithToolCallMessagesItem(new RequestFailedValue(value));
    }

    public static MakeToolWithToolCallMessagesItem requestResponseDelayed(ToolMessageDelayed value) {
        return new MakeToolWithToolCallMessagesItem(new RequestResponseDelayedValue(value));
    }
    ...
    private static final class RequestStartValue implements Value {
        ...
        public String toString() {
            return "MakeToolWithToolCallMessagesItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "MakeToolWithToolCallMessagesItem{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

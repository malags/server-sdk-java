...
public final class MakeToolMessagesItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private MakeToolMessagesItem(Value value) {
        this.value = value;
    }
    ...
    public static MakeToolMessagesItem requestStart(ToolMessageStart value) {
        return new MakeToolMessagesItem(new RequestStartValue(value));
    }

    public static MakeToolMessagesItem requestComplete(ToolMessageComplete value) {
        return new MakeToolMessagesItem(new RequestCompleteValue(value));
    }

    public static MakeToolMessagesItem requestFailed(ToolMessageFailed value) {
        return new MakeToolMessagesItem(new RequestFailedValue(value));
    }

    public static MakeToolMessagesItem requestResponseDelayed(ToolMessageDelayed value) {
        return new MakeToolMessagesItem(new RequestResponseDelayedValue(value));
    }
    ...
    private static final class RequestStartValue implements Value {
        ...
        public String toString() {
            return "MakeToolMessagesItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "MakeToolMessagesItem{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

...
public final class WebhookCredential {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof WebhookCredential && equalTo((WebhookCredential) other);
    }
    ...
    private boolean equalTo(WebhookCredential other) {
        return authenticationPlan.equals(other.authenticationPlan)
                && id.equals(other.id)
    ...
    public static final class Builder
            implements AuthenticationPlanStage,
                    IdStage,
                    OrgIdStage,
                    CreatedAtStage,
                    UpdatedAtStage,
        ...
        @java.lang.Override
        public Builder from(WebhookCredential other) {
        ...
        public AuthenticationSessionStage updatedAt(@NotNull OffsetDateTime updatedAt) {

...
public final class SmsSendToolMessagesItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private SmsSendToolMessagesItem(Value value) {
        this.value = value;
    }
    ...
    public static SmsSendToolMessagesItem requestStart(ToolMessageStart value) {
        return new SmsSendToolMessagesItem(new RequestStartValue(value));
    }

    public static SmsSendToolMessagesItem requestComplete(ToolMessageComplete value) {
        return new SmsSendToolMessagesItem(new RequestCompleteValue(value));
    }

    public static SmsSendToolMessagesItem requestFailed(ToolMessageFailed value) {
        return new SmsSendToolMessagesItem(new RequestFailedValue(value));
    }

    public static SmsSendToolMessagesItem requestResponseDelayed(ToolMessageDelayed value) {
        return new SmsSendToolMessagesItem(new RequestResponseDelayedValue(value));
    }
    ...
    private static final class RequestStartValue implements Value {
        ...
        public String toString() {
            return "SmsSendToolMessagesItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "SmsSendToolMessagesItem{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

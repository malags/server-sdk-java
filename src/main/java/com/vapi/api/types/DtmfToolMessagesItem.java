...
public final class DtmfToolMessagesItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private DtmfToolMessagesItem(Value value) {
        this.value = value;
    }
    ...
    public static DtmfToolMessagesItem requestStart(ToolMessageStart value) {
        return new DtmfToolMessagesItem(new RequestStartValue(value));
    }

    public static DtmfToolMessagesItem requestComplete(ToolMessageComplete value) {
        return new DtmfToolMessagesItem(new RequestCompleteValue(value));
    }

    public static DtmfToolMessagesItem requestFailed(ToolMessageFailed value) {
        return new DtmfToolMessagesItem(new RequestFailedValue(value));
    }

    public static DtmfToolMessagesItem requestResponseDelayed(ToolMessageDelayed value) {
        return new DtmfToolMessagesItem(new RequestResponseDelayedValue(value));
    }
    ...
    private static final class RequestStartValue implements Value {
        ...
        public String toString() {
            return "DtmfToolMessagesItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "DtmfToolMessagesItem{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

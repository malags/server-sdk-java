...
@JsonDeserialize(builder = CreateTelnyxPhoneNumberDto.Builder.class)
public final class CreateTelnyxPhoneNumberDto {
    private final Optional<CreateTelnyxPhoneNumberDtoFallbackDestination> fallbackDestination;
    ...
    private CreateTelnyxPhoneNumberDto(
            Optional<CreateTelnyxPhoneNumberDtoFallbackDestination> fallbackDestination,
    ...
    public Optional<CreateTelnyxPhoneNumberDtoFallbackDestination> getFallbackDestination() {
    ...
    /**
     * @return These are the digits of the phone number you own on your Telnyx.
     */
    @JsonProperty("number")
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof CreateTelnyxPhoneNumberDto && equalTo((CreateTelnyxPhoneNumberDto) other);
    }
    ...
    private boolean equalTo(CreateTelnyxPhoneNumberDto other) {
    ...
    public interface NumberStage {
        ...
        Builder from(CreateTelnyxPhoneNumberDto other);
    }
    ...
    public interface _FinalStage {
        CreateTelnyxPhoneNumberDto build();
         ...
         * <p>If this is not set and above conditions are met, the inbound call is hung up with an error message.</p>
         */
        _FinalStage fallbackDestination(Optional<CreateTelnyxPhoneNumberDtoFallbackDestination> fallbackDestination);

        _FinalStage fallbackDestination(CreateTelnyxPhoneNumberDtoFallbackDestination fallbackDestination);
    ...
    public static final class Builder implements NumberStage, CredentialIdStage, _FinalStage {
        ...
        private Optional<CreateTelnyxPhoneNumberDtoFallbackDestination> fallbackDestination = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(CreateTelnyxPhoneNumberDto other) {
         ...
         */
        @java.lang.Override
        public _FinalStage fallbackDestination(CreateTelnyxPhoneNumberDtoFallbackDestination fallbackDestination) {
        ...
        @java.lang.Override
        public CreateTelnyxPhoneNumberDto build() {
            return new CreateTelnyxPhoneNumberDto(
                    fallbackDestination,
                    hooks,
                    number,
                    credentialId,

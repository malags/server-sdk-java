...
public final class CreateGoogleCalendarCreateEventToolDtoMessagesItem {
    private final Value value;

    @JsonCreator(mode = JsonCreator.Mode.DELEGATING)
    private CreateGoogleCalendarCreateEventToolDtoMessagesItem(Value value) {
        this.value = value;
    }
    ...
    public static CreateGoogleCalendarCreateEventToolDtoMessagesItem requestStart(ToolMessageStart value) {
        return new CreateGoogleCalendarCreateEventToolDtoMessagesItem(new RequestStartValue(value));
    }

    public static CreateGoogleCalendarCreateEventToolDtoMessagesItem requestComplete(ToolMessageComplete value) {
        return new CreateGoogleCalendarCreateEventToolDtoMessagesItem(new RequestCompleteValue(value));
    }

    public static CreateGoogleCalendarCreateEventToolDtoMessagesItem requestFailed(ToolMessageFailed value) {
        return new CreateGoogleCalendarCreateEventToolDtoMessagesItem(new RequestFailedValue(value));
    }

    public static CreateGoogleCalendarCreateEventToolDtoMessagesItem requestResponseDelayed(ToolMessageDelayed value) {
        return new CreateGoogleCalendarCreateEventToolDtoMessagesItem(new RequestResponseDelayedValue(value));
    }
    ...
    private static final class RequestStartValue implements Value {
        ...
        public String toString() {
            return "CreateGoogleCalendarCreateEventToolDtoMessagesItem{" + "value: " + value + "}";
        }
    }
    ...
    private static final class _UnknownValue implements Value {
        ...
        @java.lang.Override
        public String toString() {
            return "CreateGoogleCalendarCreateEventToolDtoMessagesItem{" + "type: " + type + ", value: " + value + "}";
        }
    }
}

...
@JsonDeserialize(builder = OutputTool.Builder.class)
public final class OutputTool {
    private final Optional<List<OutputToolMessagesItem>> messages;
    ...
    private OutputTool(
            Optional<List<OutputToolMessagesItem>> messages,
            String id,
            String orgId,
    ...
    public Optional<List<OutputToolMessagesItem>> getMessages() {
        return messages;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof OutputTool && equalTo((OutputTool) other);
    }
    ...
    private boolean equalTo(OutputTool other) {
    ...
    public interface _FinalStage {
         ...
         * <p>For some tools, this is auto-filled based on special fields like <code>tool.destinations</code>. For others like the function tool, these can be custom configured.</p>
         */
        _FinalStage messages(Optional<List<OutputToolMessagesItem>> messages);

        _FinalStage messages(List<OutputToolMessagesItem> messages);
    ...
    public static final class Builder implements IdStage, OrgIdStage, CreatedAtStage, UpdatedAtStage, _FinalStage {
        ...
        private Optional<List<OutputToolMessagesItem>> messages = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(OutputTool other) {
         ...
         */
        @java.lang.Override
        public _FinalStage messages(List<OutputToolMessagesItem> messages) {
        ...
        public _FinalStage messages(Optional<List<OutputToolMessagesItem>> messages) {
            this.messages = messages;
            return this;
        }

        @java.lang.Override
        public OutputTool build() {
            return new OutputTool(messages, id, orgId, createdAt, updatedAt, function, additionalProperties);
        }
    }
}
